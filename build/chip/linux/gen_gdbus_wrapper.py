...
def main():
    ...
    if options.output_c:
        subprocess.check_call([sys.executable, codegen_exe, "--body", "--output", options.output_c] + extra_args)
    ...
    if options.output_h:
        subprocess.check_call([sys.executable, codegen_exe, "--header", "--output", options.output_h] + extra_args)
