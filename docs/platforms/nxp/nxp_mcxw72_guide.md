...
build command line for the MCXW72 platform. Also, the `core_id` should be set to `cm33_core0`.
...
and UART1 serial ports. For applications where CLI is _not_ available, connecting
to the default UART1 is enough.
