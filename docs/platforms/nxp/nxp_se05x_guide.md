...
The example uses the SE05x KVS (Key-Value Store) implementation located at:
`src/platform/nxp/crypto/se05x/linux_kvs/KeyValueStoreManagerImpl.h`

#### KVS Initialization

During KVS initialization, required content is read from the SE05x and stored in
...
| Node Operational Key Pair          | 0x7FFF31014                             | f/1/o      |
...
| WiFi SSID                          | 0x7FFF34015                             | wifi-ssid  |
| WiFi Password                      | 0x7FFF34015                             | wifi-pass  |
