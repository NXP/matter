...
void AirPurifierApp::DeviceCallbacks::PostAttributeChangeCallback(EndpointId endpointId, ClusterId clusterId,
                                                                 ...
                                                                 uint8_t * value)
{
    ...
    {
        AirPurifierManager::GetInstance()->PostAttributeChangeCallback(endpointId, clusterId,
                                                                       attributeId, type, size, value);
    }
}

// This returns an instance of this class.
AirPurifierApp::DeviceCallbacks & AirPurifierApp::DeviceCallbacks::GetDefaultInstance()
{
...
{
    return AirPurifierApp::DeviceCallbacks::GetDefaultInstance();
}
