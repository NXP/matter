...
def BuildNxpTarget():
    ...
    target.AppendModifier(name="cmake", build_system=NxpBuildSystem.CMAKE).ExceptIfRe('laundry-washer|lock-app').OnlyIfRe('rt1060|rt1170|rw61x|mcxw71')
    ...
    target.AppendModifier(name="no_ble", disable_ble=True)
