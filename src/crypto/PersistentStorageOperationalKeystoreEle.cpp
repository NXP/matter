...
void PersistentStorageOperationalKeystore::ResetPendingKey(bool delete_key)
{
...
hsm_err_t PersistentStorageOperationalKeystore::EleDeleteKey(uint32_t keyId)
{
    hsm_err_t err;
...
hsm_err_t PersistentStorageOperationalKeystore::EleSignMessage(uint32_t keyId,
 ...
 *
 */
CHIP_ERROR PersistentStorageOperationalKeystore::EleGenerateCSR(uint32_t keyId, uint8_t * csr, size_t &csrLength)
{
