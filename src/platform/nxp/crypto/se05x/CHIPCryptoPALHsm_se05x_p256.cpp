...
static Mutex se05x_p256_crypto_mutex;
#define LOCK_P256_CRYPTO_MUTEX()                                                                                                   \
    do                                                                                                                             \
    {                                                                                                                              \
        se05x_p256_crypto_mutex.Lock();                                                                                            \
    } while (0);
#define UNLOCK_P256_CRYPTO_MUTEX()                                                                                                 \
    do                                                                                                                             \
    {                                                                                                                              \
        se05x_p256_crypto_mutex.Unlock();                                                                                          \
    } while (0);
