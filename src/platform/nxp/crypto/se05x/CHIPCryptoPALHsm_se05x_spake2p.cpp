                                                           ...
                                                           size_t Lin_len)
{
    ...
    smstatus = Se05x_API_PAKEConfigDevice(&((sss_se05x_session_t *) &gex_sss_chip_ctx.session)->s_ctx, static_cast<SE05x_CryptoObjectID_t>(hsm_pake_context.spake_objId),
    ...
    smstatus = Se05x_API_PAKEInitDevice(&((sss_se05x_session_t *) &gex_sss_chip_ctx.session)->s_ctx, static_cast<SE05x_CryptoObjectID_t>(hsm_pake_context.spake_objId),
