...
CHIP_ERROR se05x_read_meta_data(uint8_t * meta_data, size_t * meta_data_len)
{
    ...
    reader.Next(kTLVType_UnsignedInteger, ContextTag(0x00)); // DataModelRevision
    reader.Next(kTLVType_UTF8String, ContextTag(0x01));      // VendorName
    reader.Next(kTLVType_SignedInteger, ContextTag(0x1F));   // Unknown field
