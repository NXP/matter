...
class TCPEndPointImplNcp : public TCPEndPoint, public EndPointStateNcp
{
public:
    TCPEndPointImplNcp(EndPointManager<TCPEndPoint> & endPointManager) :
...
using TCPEndPointImpl = TCPEndPointImplNcp;
