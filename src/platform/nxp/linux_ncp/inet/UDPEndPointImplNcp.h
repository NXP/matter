...
#include "EndPointStateNcp.h"
#include <inet/UDPEndPoint.h>

namespace chip {
namespace Inet {

class UDPEndPointImplNcp : public UDPEndPoint, public EndPointStateNcp
{
public:
    UDPEndPointImplNcp(EndPointManager<UDPEndPoint> & endPointManager) :
...
using UDPEndPointImpl = UDPEndPointImplNcp;
