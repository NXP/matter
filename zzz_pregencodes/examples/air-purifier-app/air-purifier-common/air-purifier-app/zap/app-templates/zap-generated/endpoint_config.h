...
#define GENERATED_ATTRIBUTES                                                                                                       \
    {                                                                                                                              \
        ...
        { ZAP_SIMPLE_DEFAULT(0), 0x00000029, 2, ZAP_TYPE(BITMAP16), ZAP_ATTRIBUTE_MASK(READABLE) }, /* ThermostatRunningState */   \
...
#define GENERATED_ENDPOINT_TYPES                                                                                                   \
    {                                                                                                                              \
        { ZAP_CLUSTER_INDEX(0), 12, 13 }, { ZAP_CLUSTER_INDEX(12), 6, 36 }, { ZAP_CLUSTER_INDEX(18), 13, 29 },                     \
        { ZAP_CLUSTER_INDEX(31), 3, 21 }, { ZAP_CLUSTER_INDEX(34), 3, 21 }, { ZAP_CLUSTER_INDEX(37), 3, 23 },                      \
    }
