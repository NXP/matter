...
#define GENERATED_ENDPOINT_TYPES                                                                                                   \
    {                                                                                                                              \
        { ZAP_CLUSTER_INDEX(0), 12, 13 }, { ZAP_CLUSTER_INDEX(12), 6, 29 }, { ZAP_CLUSTER_INDEX(18), 13, 22 },                     \
        { ZAP_CLUSTER_INDEX(31), 3, 14 }, { ZAP_CLUSTER_INDEX(34), 3, 14 }, { ZAP_CLUSTER_INDEX(37), 3, 16 },                      \
    }
