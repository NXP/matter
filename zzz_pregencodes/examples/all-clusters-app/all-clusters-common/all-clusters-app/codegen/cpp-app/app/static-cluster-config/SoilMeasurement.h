...
//
// Application configuration for SoilMeasurement based on EMBER configuration
...
inline constexpr AttributeId kEndpoint1EnabledAttributes[] = {
    ...
    Attributes::SoilMoistureMeasuredValue::Id,
    Attributes::SoilMoistureMeasurementLimits::Id,
};
} // namespace detail
