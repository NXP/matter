...
inline constexpr CommandId kEndpoint1EnabledCommands[] = {
    Commands::AddThermostatSuggestion::Id,    Commands::AtomicRequest::Id,
    Commands::RemoveThermostatSuggestion::Id, Commands::SetActivePresetRequest::Id,
    Commands::SetActiveScheduleRequest::Id,   Commands::SetpointRaiseLower::Id,
};
