...
inline constexpr AttributeId kEndpoint1EnabledAttributes[] = {
    ...
    Attributes::FeatureMap::Id,           Attributes::GeneratedCommandList::Id, Attributes::MaxProvisioned::Id,
    Attributes::ProvisionedEndpoints::Id,
};

inline constexpr CommandId kEndpoint1EnabledCommands[] = {
    Commands::FindEndpoint::Id,      Commands::FindEndpointResponse::Id,
    Commands::ProvisionEndpoint::Id, Commands::ProvisionEndpointResponse::Id,
