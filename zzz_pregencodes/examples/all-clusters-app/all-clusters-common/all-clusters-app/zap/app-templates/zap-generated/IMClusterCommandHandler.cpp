                                                          ...
                                                          TLV::TLVReader & aDataTlv)
{
    ...
    bool wasHandled     = false;
    {
        ...
        case Commands::TestCheckCommandFlags::Id: {
            Commands::TestCheckCommandFlags::DecodableType commandData;
            TLVError = commandData.Decode(aDataTlv, apCommandObj->GetAccessingFabricIndex());
            if (TLVError == CHIP_NO_ERROR)
            {
                wasHandled = emberAfUnitTestingClusterTestCheckCommandFlagsCallback(apCommandObj, aCommandPath, commandData);
            }
            break;
        }
