...
#define MATTER_DM_IDENTIFY_CLUSTER_SERVER_ENDPOINT_COUNT (4)
...
#define MATTER_DM_SWITCH_CLUSTER_SERVER_ENDPOINT_COUNT (3)
...
#define MATTER_DM_SOIL_MEASUREMENT_CLUSTER_SERVER_ENDPOINT_COUNT (1)
...
// Use this macro to check if the server side of the Soil Measurement cluster is included
#define ZCL_USING_SOIL_MEASUREMENT_CLUSTER_SERVER
#define MATTER_DM_PLUGIN_SOIL_MEASUREMENT_SERVER
#define MATTER_DM_PLUGIN_SOIL_MEASUREMENT
...
//  Actions Cluster Commands
#define ACTIONS_ENABLE_INSTANT_ACTION_CMD 1
#define ACTIONS_ENABLE_INSTANT_ACTION_WITH_TRANSITION_CMD 1
#define ACTIONS_ENABLE_START_ACTION_CMD 1
#define ACTIONS_ENABLE_START_ACTION_WITH_DURATION_CMD 1
#define ACTIONS_ENABLE_STOP_ACTION_CMD 1
#define ACTIONS_ENABLE_PAUSE_ACTION_CMD 1
#define ACTIONS_ENABLE_PAUSE_ACTION_WITH_DURATION_CMD 1
#define ACTIONS_ENABLE_RESUME_ACTION_CMD 1
#define ACTIONS_ENABLE_ENABLE_ACTION_CMD 1
#define ACTIONS_ENABLE_ENABLE_ACTION_WITH_DURATION_CMD 1
#define ACTIONS_ENABLE_DISABLE_ACTION_CMD 1
#define ACTIONS_ENABLE_DISABLE_ACTION_WITH_DURATION_CMD 1
...
#define UNIT_TESTING_ENABLE_STRING_ECHO_REQUEST_CMD 1
#define UNIT_TESTING_ENABLE_GLOBAL_ECHO_REQUEST_CMD 1
#define UNIT_TESTING_ENABLE_TEST_CHECK_COMMAND_FLAGS_CMD 1
