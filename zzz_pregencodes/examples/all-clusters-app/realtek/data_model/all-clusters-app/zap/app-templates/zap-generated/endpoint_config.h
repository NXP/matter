...
#define GENERATED_MIN_MAX_DEFAULT_COUNT 59
...
#define GENERATED_ATTRIBUTE_COUNT 1060
#define GENERATED_ATTRIBUTES                                                                                                       \
    {                                                                                                                              \
        ...
        { ZAP_EMPTY_DEFAULT(), 0x00000006, 4, ZAP_TYPE(BITMAP32), 0 },      /* UserActiveModeTriggerHint */                        \
        ...
        { ZAP_LONG_DEFAULTS_INDEX(27), 0x00000002, 8, ZAP_TYPE(EPOCH_US), ZAP_ATTRIBUTE_MASK(NULLABLE) }, /* AutoCloseTime */      \
        ...
        { ZAP_MIN_MAX_DEFAULTS_INDEX(45), 0x00000003, 2, ZAP_TYPE(INT16U),                                                         \
        ...
        { ZAP_MIN_MAX_DEFAULTS_INDEX(46), 0x00000010, 2, ZAP_TYPE(INT16U),                                                         \
          ZAP_ATTRIBUTE_MASK(MIN_MAX) | ZAP_ATTRIBUTE_MASK(EXTERNAL_STORAGE) |                                                     \
        ...
        { ZAP_MIN_MAX_DEFAULTS_INDEX(51), 0x00003000, 1, ZAP_TYPE(INT8U),                                                          \
        ...
        { ZAP_MIN_MAX_DEFAULTS_INDEX(52), 0x00004026, 1, ZAP_TYPE(INT8U),                                                          \
          ZAP_ATTRIBUTE_MASK(MIN_MAX) | ZAP_ATTRIBUTE_MASK(WRITABLE) |                                                             \
              ZAP_ATTRIBUTE_MASK(NULLABLE) }, /* nullable_range_restricted_int8u */                                                \
        { ZAP_MIN_MAX_DEFAULTS_INDEX(53), 0x00004027, 1, ZAP_TYPE(INT8S),                                                          \
          ZAP_ATTRIBUTE_MASK(MIN_MAX) | ZAP_ATTRIBUTE_MASK(WRITABLE) |                                                             \
              ZAP_ATTRIBUTE_MASK(NULLABLE) }, /* nullable_range_restricted_int8s */                                                \
        { ZAP_MIN_MAX_DEFAULTS_INDEX(54), 0x00004028, 2, ZAP_TYPE(INT16U),                                                         \
          ZAP_ATTRIBUTE_MASK(MIN_MAX) | ZAP_ATTRIBUTE_MASK(WRITABLE) |                                                             \
              ZAP_ATTRIBUTE_MASK(NULLABLE) }, /* nullable_range_restricted_int16u */                                               \
        { ZAP_MIN_MAX_DEFAULTS_INDEX(55), 0x00004029, 2, ZAP_TYPE(INT16S),                                                         \
          ZAP_ATTRIBUTE_MASK(MIN_MAX) | ZAP_ATTRIBUTE_MASK(WRITABLE) |                                                             \
        ...
        { ZAP_MIN_MAX_DEFAULTS_INDEX(56), 0x00004003, 1, ZAP_TYPE(ENUM8),                                                          \
        ...
        { ZAP_EMPTY_DEFAULT(), 0x00000001, 1, ZAP_TYPE(ENUM8), 0 },     /* OccupancySensorType */                                  \
        { ZAP_SIMPLE_DEFAULT(1), 0x00000002, 1, ZAP_TYPE(BITMAP8), 0 }, /* OccupancySensorTypeBitmap */                            \
        { ZAP_MIN_MAX_DEFAULTS_INDEX(57), 0x00000003, 2, ZAP_TYPE(INT16U),                                                         \
          ZAP_ATTRIBUTE_MASK(MIN_MAX) | ZAP_ATTRIBUTE_MASK(EXTERNAL_STORAGE) | ZAP_ATTRIBUTE_MASK(WRITABLE) }, /* HoldTime */      \
        { ZAP_EMPTY_DEFAULT(), 0x00000004, 0, ZAP_TYPE(STRUCT), ZAP_ATTRIBUTE_MASK(EXTERNAL_STORAGE) }, /* HoldTimeLimits */       \
        { ZAP_MIN_MAX_DEFAULTS_INDEX(58), 0x00000010, 2, ZAP_TYPE(INT16U),                                                         \
          ZAP_ATTRIBUTE_MASK(MIN_MAX) | ZAP_ATTRIBUTE_MASK(EXTERNAL_STORAGE) |                                                     \
              ZAP_ATTRIBUTE_MASK(WRITABLE) }, /* PIROccupiedToUnoccupiedDelay */                                                   \
        { ZAP_EMPTY_DEFAULT(), 0x0000FFFC, 4, ZAP_TYPE(BITMAP32), ZAP_ATTRIBUTE_MASK(EXTERNAL_STORAGE) }, /* FeatureMap */         \
        { ZAP_SIMPLE_DEFAULT(5), 0x0000FFFD, 2, ZAP_TYPE(INT16U), 0 },                                    /* ClusterRevision */    \
...
// clang-format off
#define GENERATED_EVENT_COUNT 66
...
#define GENERATED_COMMANDS { \
  ...
  0x00000003 /* Resume */, \
  chip::kInvalidCommandId /* end of list */, \
  /*   GeneratedCommandList (index=166)*/ \
  0x00000004 /* OperationalCommandResponse */, \
  chip::kInvalidCommandId /* end of list */, \
  /* Endpoint: 1, Cluster: RVC Operational State (server) */\
  ...
  0x00000080 /* GoHome */, \
  chip::kInvalidCommandId /* end of list */, \
  /*   GeneratedCommandList (index=172)*/ \
  0x00000004 /* OperationalCommandResponse */, \
  chip::kInvalidCommandId /* end of list */, \
  /* Endpoint: 1, Cluster: Scenes Management (server) */\
  ...
  chip::kInvalidCommandId /* end of list */, \
  /* Endpoint: 1, Cluster: Fan Control (server) */\
  /*   AcceptedCommandList (index=250) */ \
  0x00000000 /* Step */, \
  chip::kInvalidCommandId /* end of list */, \
  /* Endpoint: 1, Cluster: Color Control (server) */\
  /*   AcceptedCommandList (index=252) */ \
  ...
  chip::kInvalidCommandId /* end of list */, \
  /*   GeneratedCommandList (index=298)*/ \
  ...
  chip::kInvalidCommandId /* end of list */, \
  /* Endpoint: 2, Cluster: Identify (server) */\
  /*   AcceptedCommandList (index=312) */ \
  0x00000000 /* Identify */, \
  0x00000040 /* TriggerEffect */, \
  chip::kInvalidCommandId /* end of list */, \
  /* Endpoint: 2, Cluster: Groups (server) */\
  /*   AcceptedCommandList (index=315) */ \
  0x00000000 /* AddGroup */, \
  0x00000001 /* ViewGroup */, \
  0x00000002 /* GetGroupMembership */, \
  0x00000003 /* RemoveGroup */, \
  ...
  0x00000040 /* CopyScene */, \
  chip::kInvalidCommandId /* end of list */, \
  /*   GeneratedCommandList (index=343)*/ \
  0x00000000 /* AddSceneResponse */, \
  0x00000001 /* ViewSceneResponse */, \
  0x00000002 /* RemoveSceneResponse */, \
  0x00000003 /* RemoveAllScenesResponse */, \
...
#define GENERATED_CLUSTER_COUNT 114
// clang-format off
#define GENERATED_CLUSTERS { \
  ...
  { \
      ...
      .generatedCommandList = ZAP_GENERATED_COMMANDS_INDEX( 166 ), \
  ...
  { \
      ...
      .generatedCommandList = ZAP_GENERATED_COMMANDS_INDEX( 172 ), \
  ...
  { \
      ...
      .mask = ZAP_CLUSTER_MASK(SERVER), \
      .functions = NULL, \
      .acceptedCommandList = ZAP_GENERATED_COMMANDS_INDEX( 213 ), \
  ...
  { \
      ...
      .attributes = ZAP_ATTRIBUTE_INDEX(607), \
      .attributeCount = 27, \
      .clusterSize = 73, \
  ...
  { \
      ...
      .acceptedCommandList = ZAP_GENERATED_COMMANDS_INDEX( 252 ), \
      .generatedCommandList = nullptr, \
      .eventList = nullptr, \
      .eventCount = 0, \
    },\
  ...
  { \
      ...
      .attributes = ZAP_ATTRIBUTE_INDEX(774), \
      .attributeCount = 13, \
      .clusterSize = 2, \
      .mask = ZAP_CLUSTER_MASK(SERVER), \
      .functions = NULL, \
  ...
  { \
      ...
      .attributes = ZAP_ATTRIBUTE_INDEX(787), \
      .attributeCount = 13, \
      .clusterSize = 2, \
      .mask = ZAP_CLUSTER_MASK(SERVER), \
      .functions = NULL, \
  ...
  { \
      ...
      .attributes = ZAP_ATTRIBUTE_INDEX(839), \
      .attributeCount = 13, \
      .clusterSize = 2, \
      .mask = ZAP_CLUSTER_MASK(SERVER), \
      .functions = NULL, \
  ...
  { \
      ...
      .attributes = ZAP_ATTRIBUTE_INDEX(894), \
      .attributeCount = 2, \
      .clusterSize = 6, \
      .mask = ZAP_CLUSTER_MASK(SERVER), \
      .functions = NULL, \
  ...
  { \
      ...
      .mask = ZAP_CLUSTER_MASK(SERVER), \
      .functions = NULL, \
      .acceptedCommandList = ZAP_GENERATED_COMMANDS_INDEX( 274 ), \
      .generatedCommandList = ZAP_GENERATED_COMMANDS_INDEX( 298 ), \
  ...
  { \
      ...
      .mask = ZAP_CLUSTER_MASK(SERVER) | ZAP_CLUSTER_MASK(INIT_FUNCTION) | ZAP_CLUSTER_MASK(ATTRIBUTE_CHANGED_FUNCTION), \
      .functions = chipFuncArrayIdentifyServer, \
      .acceptedCommandList = ZAP_GENERATED_COMMANDS_INDEX( 312 ), \
      .generatedCommandList = nullptr, \
      .eventList = nullptr, \
      .eventCount = 0, \
    },\
  { \
      ...
      .mask = ZAP_CLUSTER_MASK(SERVER) | ZAP_CLUSTER_MASK(INIT_FUNCTION), \
      .functions = chipFuncArrayGroupsServer, \
      .acceptedCommandList = ZAP_GENERATED_COMMANDS_INDEX( 315 ), \
  ...
  { \
      ...
      .mask = ZAP_CLUSTER_MASK(SERVER) | ZAP_CLUSTER_MASK(INIT_FUNCTION) | ZAP_CLUSTER_MASK(SHUTDOWN_FUNCTION), \
      .functions = chipFuncArrayScenesManagementServer, \
      .acceptedCommandList = ZAP_GENERATED_COMMANDS_INDEX( 334 ), \
      .generatedCommandList = ZAP_GENERATED_COMMANDS_INDEX( 343 ), \
      .eventList = nullptr, \
      .eventCount = 0, \
    },\
  { \
  ...
  { \
      ...
      .mask = ZAP_CLUSTER_MASK(SERVER) | ZAP_CLUSTER_MASK(INIT_FUNCTION) | ZAP_CLUSTER_MASK(ATTRIBUTE_CHANGED_FUNCTION), \
      .functions = chipFuncArrayIdentifyServer, \
      .acceptedCommandList = ZAP_GENERATED_COMMANDS_INDEX( 351 ), \
      .generatedCommandList = nullptr, \
      .eventList = nullptr, \
      .eventCount = 0, \
    },\
  ...
  { \
      ...
      .acceptedCommandList = nullptr, \
      .generatedCommandList = nullptr, \
      .eventList = ZAP_GENERATED_EVENTS_INDEX( 62 ), \
      .eventCount = 4, \
    },\
  { \
      /* Endpoint: 4, Cluster: Identify (server) */ \
  ...
  { \
      /* Endpoint: 4, Cluster: Switch (server) */ \
      .clusterId = 0x0000003B, \
      .attributes = ZAP_ATTRIBUTE_INDEX(1055), \
      .attributeCount = 5, \
      .clusterSize = 9, \
      .mask = ZAP_CLUSTER_MASK(SERVER), \
      .functions = NULL, \
...
#define ZAP_FIXED_ENDPOINT_DATA_VERSION_COUNT 112

// This is an array of EmberAfEndpointType structures.
#define GENERATED_ENDPOINT_TYPES                                                                                                   \
    {                                                                                                                              \
        { ZAP_CLUSTER_INDEX(0), 29, 420 }, { ZAP_CLUSTER_INDEX(29), 72, 3455 }, { ZAP_CLUSTER_INDEX(101), 7, 114 },                \
        { ZAP_CLUSTER_INDEX(108), 3, 18 }, { ZAP_CLUSTER_INDEX(111), 3, 18 },                                                      \
    }
...
#define ATTRIBUTE_MAX_SIZE (4025)
...
#define FIXED_DEVICE_TYPES                                                                                                         \
    { { 0x00000011, 1 }, { 0x00000016, 3 }, { 0x00000100, 1 }, { 0x00000011, 1 },                                                  \
      { 0x00000100, 1 }, { 0x00000011, 1 }, { 0x0000000F, 3 }, { 0x0000000F, 3 } }

// Array of device type offsets
#define FIXED_DEVICE_TYPE_OFFSETS { 0, 2, 4, 6, 7 }

// Array of device type lengths
#define FIXED_DEVICE_TYPE_LENGTHS { 2, 2, 2, 1, 1 }
