...
#define GENERATED_ATTRIBUTE_COUNT 1063
#define GENERATED_ATTRIBUTES                                                                                                       \
    {                                                                                                                              \
        ...
        { ZAP_EMPTY_DEFAULT(), 0x00000006, 4, ZAP_TYPE(BITMAP32), ZAP_ATTRIBUTE_MASK(READABLE) }, /* UserActiveModeTriggerHint */  \
        { ZAP_EMPTY_DEFAULT(), 0x00000007, 129, ZAP_TYPE(CHAR_STRING),                                                             \
        ...
        { ZAP_EMPTY_DEFAULT(), 0x00000000, 1, ZAP_TYPE(BITMAP8),                                                                   \
          ZAP_ATTRIBUTE_MASK(EXTERNAL_STORAGE) | ZAP_ATTRIBUTE_MASK(READABLE) }, /* HeaterTypes */                                 \
        { ZAP_EMPTY_DEFAULT(), 0x00000001, 1, ZAP_TYPE(BITMAP8),                                                                   \
          ZAP_ATTRIBUTE_MASK(EXTERNAL_STORAGE) | ZAP_ATTRIBUTE_MASK(READABLE) }, /* HeatDemand */                                  \
        { ZAP_EMPTY_DEFAULT(), 0x00000002, 2, ZAP_TYPE(INT16U),                                                                    \
          ZAP_ATTRIBUTE_MASK(EXTERNAL_STORAGE) | ZAP_ATTRIBUTE_MASK(READABLE) }, /* TankVolume */                                  \
        { ZAP_EMPTY_DEFAULT(), 0x00000003, 8, ZAP_TYPE(ENERGY_MWH),                                                                \
          ZAP_ATTRIBUTE_MASK(EXTERNAL_STORAGE) | ZAP_ATTRIBUTE_MASK(READABLE) }, /* EstimatedHeatRequired */                       \
        { ZAP_EMPTY_DEFAULT(), 0x00000004, 1, ZAP_TYPE(PERCENT),                                                                   \
          ZAP_ATTRIBUTE_MASK(EXTERNAL_STORAGE) | ZAP_ATTRIBUTE_MASK(READABLE) }, /* TankPercentage */                              \
        { ZAP_EMPTY_DEFAULT(), 0x00000005, 1, ZAP_TYPE(ENUM8),                                                                     \
          ZAP_ATTRIBUTE_MASK(EXTERNAL_STORAGE) | ZAP_ATTRIBUTE_MASK(READABLE) }, /* BoostState */                                  \
        { ZAP_EMPTY_DEFAULT(), 0x0000FFFC, 4, ZAP_TYPE(BITMAP32),                                                                  \
          ZAP_ATTRIBUTE_MASK(EXTERNAL_STORAGE) | ZAP_ATTRIBUTE_MASK(READABLE) }, /* FeatureMap */                                  \
        { ZAP_EMPTY_DEFAULT(), 0x0000FFFD, 2, ZAP_TYPE(INT16U),                                                                    \
          ZAP_ATTRIBUTE_MASK(EXTERNAL_STORAGE) | ZAP_ATTRIBUTE_MASK(READABLE) }, /* ClusterRevision */                             \
        ...
        { ZAP_MIN_MAX_DEFAULTS_INDEX(25), 0x00000002, 1, ZAP_TYPE(PERCENT),                                                        \
          ZAP_ATTRIBUTE_MASK(MIN_MAX) | ZAP_ATTRIBUTE_MASK(WRITABLE) | ZAP_ATTRIBUTE_MASK(READABLE) |                              \
        ...
        { ZAP_MIN_MAX_DEFAULTS_INDEX(26), 0x00000005, 1, ZAP_TYPE(INT8U),                                                          \
          ZAP_ATTRIBUTE_MASK(MIN_MAX) | ZAP_ATTRIBUTE_MASK(WRITABLE) | ZAP_ATTRIBUTE_MASK(READABLE) |                              \
        ...
        { ZAP_MIN_MAX_DEFAULTS_INDEX(27), 0x00000008, 1, ZAP_TYPE(BITMAP8),                                                        \
        ...
        { ZAP_MIN_MAX_DEFAULTS_INDEX(28), 0x0000000A, 1, ZAP_TYPE(BITMAP8),                                                        \
          ZAP_ATTRIBUTE_MASK(MIN_MAX) | ZAP_ATTRIBUTE_MASK(WRITABLE) | ZAP_ATTRIBUTE_MASK(READABLE) }, /* WindSetting */           \
        { ZAP_MIN_MAX_DEFAULTS_INDEX(29), 0x0000000B, 1, ZAP_TYPE(ENUM8),                                                          \
        ...
        { ZAP_MIN_MAX_DEFAULTS_INDEX(33), 0x0000000F, 1, ZAP_TYPE(BITMAP8),                                                        \
          ZAP_ATTRIBUTE_MASK(MIN_MAX) | ZAP_ATTRIBUTE_MASK(WRITABLE) | ZAP_ATTRIBUTE_MASK(READABLE) }, /* Options */               \
        ...
        { ZAP_EMPTY_DEFAULT(), 0x00000003, 2, ZAP_TYPE(INT16U),                                                                    \
          ZAP_ATTRIBUTE_MASK(EXTERNAL_STORAGE) | ZAP_ATTRIBUTE_MASK(WRITABLE) | ZAP_ATTRIBUTE_MASK(READABLE) }, /* HoldTime */     \
        { ZAP_EMPTY_DEFAULT(), 0x00000004, 0, ZAP_TYPE(STRUCT),                                                                    \
...
#define GENERATED_CLUSTERS { \
  ...
  { \
      ...
      .attributes = ZAP_ATTRIBUTE_INDEX(816), \
      .attributeCount = 13, \
      .clusterSize = 2, \
      .mask = ZAP_CLUSTER_MASK(SERVER), \
      .functions = NULL, \
  ...
  { \
      ...
      .attributes = ZAP_ATTRIBUTE_INDEX(842), \
      .attributeCount = 13, \
      .clusterSize = 2, \
      .mask = ZAP_CLUSTER_MASK(SERVER), \
      .functions = NULL, \
  ...
  { \
      ...
      .attributes = ZAP_ATTRIBUTE_INDEX(855), \
      .attributeCount = 13, \
      .clusterSize = 2, \
      .mask = ZAP_CLUSTER_MASK(SERVER), \
      .functions = NULL, \
  ...
  { \
      /* Endpoint: 2, Cluster: Occupancy Sensing (server) */ \
      .clusterId = 0x00000406, \
      .attributes = ZAP_ATTRIBUTE_INDEX(1023), \
      .attributeCount = 8, \
      .clusterSize = 3, \
      .mask = ZAP_CLUSTER_MASK(SERVER), \
      .functions = NULL, \
  ...
  { \
      /* Endpoint: 4, Cluster: Descriptor (server) */ \
      .clusterId = 0x0000001D, \
      .attributes = ZAP_ATTRIBUTE_INDEX(1051), \
      .attributeCount = 7, \
      .clusterSize = 0, \
      .mask = ZAP_CLUSTER_MASK(SERVER), \
      .functions = NULL, \
  ...
  { \
      /* Endpoint: 4, Cluster: Switch (server) */ \
      .clusterId = 0x0000003B, \
      .attributes = ZAP_ATTRIBUTE_INDEX(1058), \
      .attributeCount = 5, \
      .clusterSize = 6, \
      .mask = ZAP_CLUSTER_MASK(SERVER), \
      .functions = NULL, \
...
#define GENERATED_ENDPOINT_TYPES                                                                                                   \
    {                                                                                                                              \
        { ZAP_CLUSTER_INDEX(0), 29, 312 }, { ZAP_CLUSTER_INDEX(29), 72, 3352 }, { ZAP_CLUSTER_INDEX(101), 7, 99 },                 \
        { ZAP_CLUSTER_INDEX(108), 3, 6 },  { ZAP_CLUSTER_INDEX(111), 3, 6 },                                                       \
    }
...
#define FIXED_DEVICE_TYPES                                                                                                         \
    { { 0x00000011, 1 }, { 0x00000016, 5 }, { 0x00000100, 4 }, { 0x00000011, 1 },                                                  \
      { 0x00000100, 4 }, { 0x00000011, 1 }, { 0x0000000F, 3 }, { 0x0000000F, 3 } }
