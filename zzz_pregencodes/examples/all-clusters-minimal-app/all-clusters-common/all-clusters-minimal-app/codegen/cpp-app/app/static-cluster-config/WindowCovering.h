...
inline constexpr AttributeId kEndpoint1EnabledAttributes[] = {
    ...
    Attributes::ClusterRevision::Id,      Attributes::ConfigStatus::Id,
    Attributes::EndProductType::Id,       Attributes::FeatureMap::Id,
    Attributes::GeneratedCommandList::Id, Attributes::Mode::Id,
    Attributes::OperationalStatus::Id,    Attributes::Type::Id,
};
