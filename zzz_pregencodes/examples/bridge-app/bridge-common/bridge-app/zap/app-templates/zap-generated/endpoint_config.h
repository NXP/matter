...
#define GENERATED_ATTRIBUTES                                                                                                       \
    {                                                                                                                              \
        ...
        { ZAP_SIMPLE_DEFAULT(1), 0x00000001, 1, ZAP_TYPE(INT8U), ZAP_ATTRIBUTE_MASK(READABLE) },    /* CurrentPosition */          \
...
#define GENERATED_ENDPOINT_TYPES                                                                                                   \
    {                                                                                                                              \
        { ZAP_CLUSTER_INDEX(0), 18, 64 },                                                                                          \
        { ZAP_CLUSTER_INDEX(18), 3, 520 },                                                                                         \
        { ZAP_CLUSTER_INDEX(21), 5, 43 },                                                                                          \
    }
...
#define FIXED_DEVICE_TYPES { { 0x00000016, 3 }, { 0x0000000E, 2 }, { 0x00000101, 1 } }
