...
inline constexpr CommandId kEndpoint1EnabledCommands[] = {
    Commands::AllocatePushTransport::Id,    Commands::DeallocatePushTransport::Id, Commands::FindTransport::Id,
    Commands::ManuallyTriggerTransport::Id, Commands::ModifyPushTransport::Id,     Commands::SetTransportStatus::Id,
};
...
inline constexpr std::array<Clusters::StaticApplicationConfig::ClusterConfiguration<FeatureBitmapType>, 1> kFixedClusterConfig = { {
    {
        ...
        .featureMap =
            BitFlags<FeatureBitmapType>{
                FeatureBitmapType::kPerZoneSensitivity, // feature bit 0x1
                FeatureBitmapType::kMetadata            // feature bit 0x2
            },
