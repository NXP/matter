...
#define MATTER_DM_ZONE_MANAGEMENT_CLUSTER_SERVER_ENDPOINT_COUNT (1)
#define MATTER_DM_CAMERA_AV_STREAM_MANAGEMENT_CLUSTER_SERVER_ENDPOINT_COUNT (1)
#define MATTER_DM_CAMERA_AV_SETTINGS_USER_LEVEL_MANAGEMENT_CLUSTER_SERVER_ENDPOINT_COUNT (1)
#define MATTER_DM_WEB_RTC_TRANSPORT_PROVIDER_CLUSTER_SERVER_ENDPOINT_COUNT (1)
#define MATTER_DM_WEB_RTC_TRANSPORT_REQUESTOR_CLUSTER_SERVER_ENDPOINT_COUNT (0)
#define MATTER_DM_PUSH_AV_STREAM_TRANSPORT_CLUSTER_SERVER_ENDPOINT_COUNT (1)
...
#define MATTER_DM_WEB_RTC_TRANSPORT_REQUESTOR_CLUSTER_CLIENT_ENDPOINT_COUNT (1)
...
// Use this macro to check if the server side of the Zone Management cluster is included
#define ZCL_USING_ZONE_MANAGEMENT_CLUSTER_SERVER
#define MATTER_DM_PLUGIN_ZONE_MANAGEMENT_SERVER
#define MATTER_DM_PLUGIN_ZONE_MANAGEMENT

// Use this macro to check if the server side of the Camera AV Stream Management cluster is included
#define ZCL_USING_CAMERA_AV_STREAM_MANAGEMENT_CLUSTER_SERVER
#define MATTER_DM_PLUGIN_CAMERA_AV_STREAM_MANAGEMENT_SERVER
#define MATTER_DM_PLUGIN_CAMERA_AV_STREAM_MANAGEMENT

// Use this macro to check if the server side of the Camera AV Settings User Level Management cluster is included
#define ZCL_USING_CAMERA_AV_SETTINGS_USER_LEVEL_MANAGEMENT_CLUSTER_SERVER
#define MATTER_DM_PLUGIN_CAMERA_AV_SETTINGS_USER_LEVEL_MANAGEMENT_SERVER
#define MATTER_DM_PLUGIN_CAMERA_AV_SETTINGS_USER_LEVEL_MANAGEMENT

// Use this macro to check if the server side of the WebRTC Transport Provider cluster is included
#define ZCL_USING_WEB_RTC_TRANSPORT_PROVIDER_CLUSTER_SERVER
#define MATTER_DM_PLUGIN_WEB_RTC_TRANSPORT_PROVIDER_SERVER
#define MATTER_DM_PLUGIN_WEB_RTC_TRANSPORT_PROVIDER

// Use this macro to check if the client side of the WebRTC Transport Requestor cluster is included
#define ZCL_USING_WEB_RTC_TRANSPORT_REQUESTOR_CLUSTER_CLIENT
#define MATTER_DM_PLUGIN_WEB_RTC_TRANSPORT_REQUESTOR_CLIENT

// Use this macro to check if the server side of the Push AV Stream Transport cluster is included
#define ZCL_USING_PUSH_AV_STREAM_TRANSPORT_CLUSTER_SERVER
#define MATTER_DM_PLUGIN_PUSH_AV_STREAM_TRANSPORT_SERVER
#define MATTER_DM_PLUGIN_PUSH_AV_STREAM_TRANSPORT
...
//  CameraAvSettingsUserLevelManagement Cluster Commands
#define CAMERA_AV_SETTINGS_USER_LEVEL_MANAGEMENT_ENABLE_MPTZ_SET_POSITION_CMD 1
#define CAMERA_AV_SETTINGS_USER_LEVEL_MANAGEMENT_ENABLE_MPTZ_RELATIVE_MOVE_CMD 1
#define CAMERA_AV_SETTINGS_USER_LEVEL_MANAGEMENT_ENABLE_MPTZ_MOVE_TO_PRESET_CMD 1
#define CAMERA_AV_SETTINGS_USER_LEVEL_MANAGEMENT_ENABLE_MPTZ_SAVE_PRESET_CMD 1
#define CAMERA_AV_SETTINGS_USER_LEVEL_MANAGEMENT_ENABLE_MPTZ_REMOVE_PRESET_CMD 1
#define CAMERA_AV_SETTINGS_USER_LEVEL_MANAGEMENT_ENABLE_DPTZ_SET_VIEWPORT_CMD 1
#define CAMERA_AV_SETTINGS_USER_LEVEL_MANAGEMENT_ENABLE_DPTZ_RELATIVE_MOVE_CMD 1

//  CameraAvStreamManagement Cluster Commands
#define CAMERA_AV_STREAM_MANAGEMENT_ENABLE_AUDIO_STREAM_ALLOCATE_CMD 1
#define CAMERA_AV_STREAM_MANAGEMENT_ENABLE_AUDIO_STREAM_DEALLOCATE_CMD 1
#define CAMERA_AV_STREAM_MANAGEMENT_ENABLE_VIDEO_STREAM_ALLOCATE_CMD 1
#define CAMERA_AV_STREAM_MANAGEMENT_ENABLE_VIDEO_STREAM_MODIFY_CMD 1
#define CAMERA_AV_STREAM_MANAGEMENT_ENABLE_VIDEO_STREAM_DEALLOCATE_CMD 1
#define CAMERA_AV_STREAM_MANAGEMENT_ENABLE_SNAPSHOT_STREAM_ALLOCATE_CMD 1
#define CAMERA_AV_STREAM_MANAGEMENT_ENABLE_SNAPSHOT_STREAM_MODIFY_CMD 1
#define CAMERA_AV_STREAM_MANAGEMENT_ENABLE_SNAPSHOT_STREAM_DEALLOCATE_CMD 1
#define CAMERA_AV_STREAM_MANAGEMENT_ENABLE_SET_STREAM_PRIORITIES_CMD 1
#define CAMERA_AV_STREAM_MANAGEMENT_ENABLE_CAPTURE_SNAPSHOT_CMD 1
...
//  PushAvStreamTransport Cluster Commands
#define PUSH_AV_STREAM_TRANSPORT_ENABLE_ALLOCATE_PUSH_TRANSPORT_CMD 1
#define PUSH_AV_STREAM_TRANSPORT_ENABLE_DEALLOCATE_PUSH_TRANSPORT_CMD 1
#define PUSH_AV_STREAM_TRANSPORT_ENABLE_MODIFY_PUSH_TRANSPORT_CMD 1
#define PUSH_AV_STREAM_TRANSPORT_ENABLE_SET_TRANSPORT_STATUS_CMD 1
#define PUSH_AV_STREAM_TRANSPORT_ENABLE_MANUALLY_TRIGGER_TRANSPORT_CMD 1
#define PUSH_AV_STREAM_TRANSPORT_ENABLE_FIND_TRANSPORT_CMD 1
...
//  WebRTCTransportProvider Cluster Commands
#define WEB_RTC_TRANSPORT_PROVIDER_ENABLE_SOLICIT_OFFER_CMD 1
#define WEB_RTC_TRANSPORT_PROVIDER_ENABLE_PROVIDE_OFFER_CMD 1
#define WEB_RTC_TRANSPORT_PROVIDER_ENABLE_PROVIDE_ANSWER_CMD 1
#define WEB_RTC_TRANSPORT_PROVIDER_ENABLE_PROVIDE_ICE_CANDIDATES_CMD 1
#define WEB_RTC_TRANSPORT_PROVIDER_ENABLE_END_SESSION_CMD 1

//  WiFiNetworkDiagnostics Cluster Commands
#define WI_FI_NETWORK_DIAGNOSTICS_ENABLE_RESET_COUNTS_CMD 1

//  ZoneManagement Cluster Commands
#define ZONE_MANAGEMENT_ENABLE_CREATE_TWO_D_CARTESIAN_ZONE_CMD 1
#define ZONE_MANAGEMENT_ENABLE_UPDATE_TWO_D_CARTESIAN_ZONE_CMD 1
#define ZONE_MANAGEMENT_ENABLE_REMOVE_ZONE_CMD 1
#define ZONE_MANAGEMENT_ENABLE_CREATE_OR_UPDATE_TRIGGER_CMD 1
#define ZONE_MANAGEMENT_ENABLE_REMOVE_TRIGGER_CMD 1
