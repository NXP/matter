...
inline constexpr AttributeId kEndpoint0EnabledAttributes[] = {
    Attributes::AcceptedCommandList::Id, Attributes::AttributeList::Id,        Attributes::CarrierDetect::Id,
    Attributes::ClusterRevision::Id,     Attributes::CollisionCount::Id,       Attributes::FeatureMap::Id,
    Attributes::FullDuplex::Id,          Attributes::GeneratedCommandList::Id, Attributes::OverrunCount::Id,
    Attributes::PacketRxCount::Id,       Attributes::PacketTxCount::Id,        Attributes::PHYRate::Id,
    Attributes::TimeSinceReset::Id,      Attributes::TxErrCount::Id,
};
