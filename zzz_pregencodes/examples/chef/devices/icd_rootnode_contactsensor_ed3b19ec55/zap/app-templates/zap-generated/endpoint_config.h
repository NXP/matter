...
#define GENERATED_DEFAULTS                                                                                                         \
    {                                                                                                                              \
        ...
        23, 'R', 'e', 's', 't', 'a', 'r', 't', ' ', 't', 'h', 'e', ' ', 'a', 'p', 'p', 'l', 'i', 'c', 'a', 't', 'i', 'o', 'n',     \
                                                                                                                                   \
    }
...
#define GENERATED_ATTRIBUTES                                                                                                       \
    {                                                                                                                              \
        ...
        { ZAP_SIMPLE_DEFAULT(0x111D), 0x00000006, 4, ZAP_TYPE(BITMAP32),                                                           \
...
#define GENERATED_ENDPOINT_TYPES                                                                                                   \
    {                                                                                                                              \
        { ZAP_CLUSTER_INDEX(0), 16, 151 },                                                                                         \
        { ZAP_CLUSTER_INDEX(16), 4, 0 },                                                                                           \
    }
