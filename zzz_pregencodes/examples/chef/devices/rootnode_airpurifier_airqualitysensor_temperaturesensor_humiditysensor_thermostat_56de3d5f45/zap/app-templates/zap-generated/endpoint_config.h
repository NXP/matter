...
#define GENERATED_ENDPOINT_TYPES                                                                                                   \
    {                                                                                                                              \
        { ZAP_CLUSTER_INDEX(0), 10, 4 },  { ZAP_CLUSTER_INDEX(10), 6, 29 }, { ZAP_CLUSTER_INDEX(16), 13, 22 },                     \
        { ZAP_CLUSTER_INDEX(29), 3, 14 }, { ZAP_CLUSTER_INDEX(32), 3, 14 }, { ZAP_CLUSTER_INDEX(35), 3, 19 },                      \
    }
