...
#define GENERATED_ATTRIBUTES                                                                                                       \
    {                                                                                                                              \
        ...
        { ZAP_SIMPLE_DEFAULT(0x1), 0x00000002, 1, ZAP_TYPE(INT8U), 0 },     /* MinLevel */                                         \
        ...
        { ZAP_SIMPLE_DEFAULT(0x02), 0x00000008, 1, ZAP_TYPE(ENUM8), ZAP_ATTRIBUTE_MASK(TOKENIZE) },   /* ColorMode */              \
        { ZAP_SIMPLE_DEFAULT(0x00), 0x0000000F, 1, ZAP_TYPE(BITMAP8), ZAP_ATTRIBUTE_MASK(WRITABLE) }, /* Options */                \
        { ZAP_SIMPLE_DEFAULT(0xFF), 0x00000010, 1, ZAP_TYPE(INT8U), ZAP_ATTRIBUTE_MASK(NULLABLE) },   /* NumberOfPrimaries */      \
        { ZAP_SIMPLE_DEFAULT(0x02), 0x00004001, 1, ZAP_TYPE(ENUM8), ZAP_ATTRIBUTE_MASK(TOKENIZE) },   /* EnhancedColorMode */      \
        { ZAP_SIMPLE_DEFAULT(0x0010), 0x0000400A, 2, ZAP_TYPE(BITMAP16), 0 },                         /* ColorCapabilities */      \
        ...
        { ZAP_SIMPLE_DEFAULT(0x0010), 0x0000FFFC, 4, ZAP_TYPE(BITMAP32), 0 }, /* FeatureMap */                                     \
...
#define FIXED_DEVICE_TYPES { { 0x00000016, 3 }, { 0x0000010C, 1 } }
