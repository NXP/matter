...
#define GENERATED_ATTRIBUTES                                                                                                       \
    {                                                                                                                              \
        ...
        { ZAP_SIMPLE_DEFAULT(0x1), 0x00000002, 1, ZAP_TYPE(INT8U), ZAP_ATTRIBUTE_MASK(READABLE) },      /* MinLevel */             \
        ...
        { ZAP_SIMPLE_DEFAULT(0x3), 0x0000FFFC, 4, ZAP_TYPE(BITMAP32), ZAP_ATTRIBUTE_MASK(READABLE) }, /* FeatureMap */             \
        ...
        { ZAP_SIMPLE_DEFAULT(0x02), 0x00000008, 1, ZAP_TYPE(ENUM8),                                                                \
        ...
        { ZAP_SIMPLE_DEFAULT(0xFF), 0x00000010, 1, ZAP_TYPE(INT8U),                                                                \
          ZAP_ATTRIBUTE_MASK(READABLE) | ZAP_ATTRIBUTE_MASK(NULLABLE) }, /* NumberOfPrimaries */                                   \
        { ZAP_SIMPLE_DEFAULT(0x02), 0x00004001, 1, ZAP_TYPE(ENUM8),                                                                \
          ZAP_ATTRIBUTE_MASK(TOKENIZE) | ZAP_ATTRIBUTE_MASK(READABLE) },                                 /* EnhancedColorMode */   \
        { ZAP_SIMPLE_DEFAULT(0x0010), 0x0000400A, 2, ZAP_TYPE(BITMAP16), ZAP_ATTRIBUTE_MASK(READABLE) }, /* ColorCapabilities */   \
        ...
        { ZAP_SIMPLE_DEFAULT(0x0010), 0x0000FFFC, 4, ZAP_TYPE(BITMAP32), ZAP_ATTRIBUTE_MASK(READABLE) }, /* FeatureMap */          \
