...
#define GENERATED_ATTRIBUTES                                                                                                       \
    {                                                                                                                              \
        ...
        { ZAP_SIMPLE_DEFAULT(3800), 0x00000001, 2, ZAP_TYPE(TEMPERATURE),                                                          \
          ZAP_ATTRIBUTE_MASK(READABLE) | ZAP_ATTRIBUTE_MASK(NULLABLE) }, /* MinMeasuredValue */                                    \
        { ZAP_SIMPLE_DEFAULT(26000), 0x00000002, 2, ZAP_TYPE(TEMPERATURE),                                                         \
...
#define GENERATED_ENDPOINT_TYPES                                                                                                   \
    {                                                                                                                              \
        ...
        { ZAP_CLUSTER_INDEX(12), 3, 14 },                                                                                          \
        { ZAP_CLUSTER_INDEX(15), 4, 26 },                                                                                          \
    }
...
#define FIXED_DEVICE_TYPES { { 0x00000016, 3 }, { 0x00000078, 1 }, { 0x00000077, 2 } }
