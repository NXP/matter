...
#define GENERATED_ATTRIBUTES                                                                                                       \
    {                                                                                                                              \
        ...
        { ZAP_SIMPLE_DEFAULT(0), 0x00000000, 2, ZAP_TYPE(TEMPERATURE), 0 },    /* TemperatureSetpoint */                           \
        { ZAP_SIMPLE_DEFAULT(4900), 0x00000001, 2, ZAP_TYPE(TEMPERATURE), 0 }, /* MinTemperature */                                \
        { ZAP_SIMPLE_DEFAULT(8200), 0x00000002, 2, ZAP_TYPE(TEMPERATURE), 0 }, /* MaxTemperature */                                \
        { ZAP_SIMPLE_DEFAULT(100), 0x00000003, 2, ZAP_TYPE(TEMPERATURE), 0 },  /* Step */                                          \
        ...
        { ZAP_SIMPLE_DEFAULT(0x30), 0x00000001, 4, ZAP_TYPE(BITMAP32), 0 }, /* Latch */                                            \
        { ZAP_SIMPLE_DEFAULT(0), 0x00000002, 4, ZAP_TYPE(BITMAP32), 0 },    /* State */                                            \
        { ZAP_SIMPLE_DEFAULT(0x3F), 0x00000003, 4, ZAP_TYPE(BITMAP32), 0 }, /* Supported */                                        \
        { ZAP_SIMPLE_DEFAULT(1), 0x0000FFFC, 4, ZAP_TYPE(BITMAP32), 0 },    /* FeatureMap */                                       \
        { ZAP_SIMPLE_DEFAULT(1), 0x0000FFFD, 2, ZAP_TYPE(INT16U), 0 },      /* ClusterRevision */                                  \
                                                                                                                                   \
...
#define GENERATED_ENDPOINT_TYPES                                                                                                   \
    {                                                                                                                              \
        { ZAP_CLUSTER_INDEX(0), 12, 117 },                                                                                         \
        { ZAP_CLUSTER_INDEX(12), 7, 60 },                                                                                          \
    }
