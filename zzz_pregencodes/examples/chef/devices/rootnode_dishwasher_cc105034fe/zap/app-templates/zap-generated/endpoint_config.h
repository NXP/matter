...
#define GENERATED_ATTRIBUTES                                                                                                       \
    {                                                                                                                              \
        ...
        { ZAP_SIMPLE_DEFAULT(5000), 0x00000000, 2, ZAP_TYPE(TEMPERATURE),                                                          \
...
#define GENERATED_ENDPOINT_TYPES                                                                                                   \
    {                                                                                                                              \
        { ZAP_CLUSTER_INDEX(0), 12, 52 },                                                                                          \
        { ZAP_CLUSTER_INDEX(12), 7, 47 },                                                                                          \
    }
...
#define FIXED_DEVICE_TYPES { { 0x00000016, 4 }, { 0x00000075, 2 } }
