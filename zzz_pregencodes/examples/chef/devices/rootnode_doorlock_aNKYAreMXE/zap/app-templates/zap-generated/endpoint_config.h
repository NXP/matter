...
#define GENERATED_ATTRIBUTE_COUNT 150
#define GENERATED_ATTRIBUTES                                                                                                       \
    {                                                                                                                              \
        ...
        { ZAP_SIMPLE_DEFAULT(1), 0x00000001, 1, ZAP_TYPE(INT8U),                                                                   \
          ZAP_ATTRIBUTE_MASK(TOKENIZE) | ZAP_ATTRIBUTE_MASK(READABLE) },                                     /* Order */           \
        { ZAP_LONG_DEFAULTS_INDEX(0), 0x00000002, 61, ZAP_TYPE(CHAR_STRING), ZAP_ATTRIBUTE_MASK(READABLE) }, /* Description */     \
        { ZAP_SIMPLE_DEFAULT(0xFFFFFFFF), 0x0000000B, 4, ZAP_TYPE(INT32U),                                                         \
          ZAP_ATTRIBUTE_MASK(READABLE) | ZAP_ATTRIBUTE_MASK(NULLABLE) }, /* BatVoltage */                                          \
        { ZAP_SIMPLE_DEFAULT(0xFF), 0x0000000C, 1, ZAP_TYPE(INT8U),                                                                \
          ZAP_ATTRIBUTE_MASK(READABLE) | ZAP_ATTRIBUTE_MASK(NULLABLE) }, /* BatPercentRemaining */                                 \
        { ZAP_SIMPLE_DEFAULT(0xFFFFFFFF), 0x0000000D, 4, ZAP_TYPE(INT32U),                                                         \
        ...
        { ZAP_SIMPLE_DEFAULT(0), 0x00000002, 1, ZAP_TYPE(BOOLEAN), ZAP_ATTRIBUTE_MASK(READABLE) }, /* ActuatorEnabled */           \
        { ZAP_SIMPLE_DEFAULT(1), 0x00000003, 1, ZAP_TYPE(ENUM8),                                                                   \
        ...
        { ZAP_LONG_DEFAULTS_INDEX(8), 0x00000021, 4, ZAP_TYPE(CHAR_STRING),                                                        \
        ...
        { ZAP_SIMPLE_DEFAULT(0x1DB3), 0x0000FFFC, 4, ZAP_TYPE(BITMAP32), ZAP_ATTRIBUTE_MASK(READABLE) }, /* FeatureMap */          \
...
#define FIXED_DEVICE_TYPES { { 0x00000016, 3 }, { 0x0000000A, 1 }, { 0x00000011, 1 } }
