...
#define GENERATED_MIN_MAX_DEFAULTS                                                                                                 \
    {                                                                                                                              \
        ...
        { (uint16_t) 0xFFFF, (uint16_t) 0x1, (uint16_t) 0xFEFF } /* StartUpColorTemperatureMireds */                               \
    }
...
#define GENERATED_ATTRIBUTES                                                                                                       \
    {                                                                                                                              \
        ...
        { ZAP_SIMPLE_DEFAULT(0x00), 0x00004000, 1, ZAP_TYPE(INT8U),                                                                \
        ...
        { ZAP_SIMPLE_DEFAULT(0x03), 0x0000FFFC, 4, ZAP_TYPE(BITMAP32), ZAP_ATTRIBUTE_MASK(READABLE) }, /* FeatureMap */            \
        { ZAP_SIMPLE_DEFAULT(0x0007), 0x0000FFFD, 2, ZAP_TYPE(INT16U), ZAP_ATTRIBUTE_MASK(READABLE) }, /* ClusterRevision */       \
                                                                                                                                   \
        ...
        { ZAP_SIMPLE_DEFAULT(0x0000), 0x0000400D, 2, ZAP_TYPE(INT16U),                                                             \
