...
inline constexpr AttributeId kEndpoint1EnabledAttributes[] = {
    ...
    Attributes::ClusterRevision::Id,      Attributes::FanMode::Id,
    Attributes::FanModeSequence::Id,      Attributes::FeatureMap::Id,
    Attributes::GeneratedCommandList::Id, Attributes::PercentCurrent::Id,
