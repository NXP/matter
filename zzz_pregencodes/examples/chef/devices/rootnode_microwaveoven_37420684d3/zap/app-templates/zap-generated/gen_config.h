...
#define MATTER_DM_MICROWAVE_OVEN_CONTROL_CLUSTER_SERVER_ENDPOINT_COUNT (1)
...
// Use this macro to check if the server side of the Microwave Oven Control cluster is included
#define ZCL_USING_MICROWAVE_OVEN_CONTROL_CLUSTER_SERVER
#define MATTER_DM_PLUGIN_MICROWAVE_OVEN_CONTROL_SERVER
#define MATTER_DM_PLUGIN_MICROWAVE_OVEN_CONTROL
...
//  MicrowaveOvenControl Cluster Commands
#define MICROWAVE_OVEN_CONTROL_ENABLE_SET_COOKING_PARAMETERS_CMD 1
#define MICROWAVE_OVEN_CONTROL_ENABLE_ADD_MORE_TIME_CMD 1
