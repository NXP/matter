...
// from /opt/matter/matter_dev/connectedhomeip/examples/chef/devices/rootnode_mounteddimmableloadcontrol_a9a1a87f2d.matter
#pragma once
...
inline constexpr AttributeId kEndpoint0EnabledAttributes[] = {
    Attributes::AcceptedCommandList::Id,      Attributes::AttributeList::Id,         Attributes::BootReason::Id,
    Attributes::ClusterRevision::Id,          Attributes::DeviceLoadStatus::Id,      Attributes::FeatureMap::Id,
    Attributes::GeneratedCommandList::Id,     Attributes::NetworkInterfaces::Id,     Attributes::RebootCount::Id,
    Attributes::TestEventTriggersEnabled::Id, Attributes::TotalOperationalHours::Id, Attributes::UpTime::Id,
};
