...
inline constexpr CommandId kEndpoint13EnabledCommands[] = {
    Commands::AddGroup::Id,        Commands::AddGroupIfIdentifying::Id, Commands::GetGroupMembership::Id,
    Commands::RemoveAllGroups::Id, Commands::RemoveGroup::Id,           Commands::ViewGroup::Id,
};
