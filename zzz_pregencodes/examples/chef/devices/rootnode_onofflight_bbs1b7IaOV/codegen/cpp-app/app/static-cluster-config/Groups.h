...
// from /opt/matter/matter_dev/connectedhomeip/examples/chef/devices/rootnode_onofflight_bbs1b7IaOV.matter
#pragma once
...
inline constexpr AttributeId kEndpoint13EnabledAttributes[] = {
    ...
    Attributes::FeatureMap::Id,          Attributes::GeneratedCommandList::Id, Attributes::NameSupport::Id,
};

inline constexpr CommandId kEndpoint13EnabledCommands[] = {
    Commands::AddGroup::Id,           Commands::AddGroupIfIdentifying::Id,      Commands::AddGroupResponse::Id,
    Commands::GetGroupMembership::Id, Commands::GetGroupMembershipResponse::Id, Commands::RemoveAllGroups::Id,
    Commands::RemoveGroup::Id,        Commands::RemoveGroupResponse::Id,        Commands::ViewGroup::Id,
