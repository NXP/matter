...
#define GENERATED_MIN_MAX_DEFAULTS                                                                                                 \
    {                                                                                                                              \
                                                                                                                                   \
        /* Endpoint: 13, Cluster: On/Off (server) */                                                                               \
        { (uint16_t) 0x0, (uint16_t) 0x0, (uint16_t) 0x2 }, /* StartUpOnOff */                                                     \
                                                                                                                                   \
        /* Endpoint: 13, Cluster: Level Control (server) */                                                                        \
...
#define GENERATED_ATTRIBUTES                                                                                                       \
    {                                                                                                                              \
        ...
        { ZAP_EMPTY_DEFAULT(), 0x0000FFFD, 2, ZAP_TYPE(INT16U),                                                                    \
          ZAP_ATTRIBUTE_MASK(EXTERNAL_STORAGE) | ZAP_ATTRIBUTE_MASK(READABLE) }, /* ClusterRevision */                             \
                                                                                                                                   \
        /* Endpoint: 13, Cluster: Groups (server) */                                                                               \
...
#define GENERATED_CLUSTERS { \
  ...
  { \
      /* Endpoint: 13, Cluster: Binding (client) */ \
...
#define FIXED_ENDPOINT_ARRAY { 0x0000, 0x000D }
