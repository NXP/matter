...
#define GENERATED_ATTRIBUTES                                                                                                       \
    {                                                                                                                              \
        ...
        { ZAP_SIMPLE_DEFAULT(0x01), 0x00004000, 1, ZAP_TYPE(INT8U),                                                                \
        ...
        { ZAP_EMPTY_DEFAULT(), 0x0000FFFD, 2, ZAP_TYPE(INT16U), ZAP_ATTRIBUTE_MASK(EXTERNAL_STORAGE) },   /* ClusterRevision */    \
                                                                                                                                   \
        /* Endpoint: 1, Cluster: Sample MEI (server) */                                                                            \
        { ZAP_SIMPLE_DEFAULT(false), 0x00000000, 1, ZAP_TYPE(BOOLEAN), ZAP_ATTRIBUTE_MASK(WRITABLE) }, /* FlipFlop */              \
        { ZAP_SIMPLE_DEFAULT(0), 0x0000FFFC, 4, ZAP_TYPE(BITMAP32), 0 },                               /* FeatureMap */            \
        { ZAP_SIMPLE_DEFAULT(1), 0x0000FFFD, 2, ZAP_TYPE(INT16U), 0 },                                 /* ClusterRevision */       \
    }
...
#define GENERATED_FUNCTION_ARRAYS                                                                                                  \
    ...
    const EmberAfGenericClusterFunction chipFuncArraySampleMeiServer[] = {                                                         \
        (EmberAfGenericClusterFunction) emberAfSampleMeiClusterServerInitCallback,                                                 \
        (EmberAfGenericClusterFunction) MatterSampleMeiClusterServerShutdownCallback,                                              \
    };
...
#define GENERATED_COMMANDS { \
  ...
  0x00000000 /* Ping */, \
  0x00000002 /* AddArguments */, \
  chip::kInvalidCommandId /* end of list */, \
  /*   GeneratedCommandList (index=91)*/ \
  0x00000001 /* AddArgumentsResponse */, \
  chip::kInvalidCommandId /* end of list */, \
}
...
#define GENERATED_CLUSTERS { \
  ...
  { \
      ...
      .clusterSize = 7, \
      .mask = ZAP_CLUSTER_MASK(SERVER) | ZAP_CLUSTER_MASK(INIT_FUNCTION) | ZAP_CLUSTER_MASK(SHUTDOWN_FUNCTION), \
      .functions = chipFuncArraySampleMeiServer, \
