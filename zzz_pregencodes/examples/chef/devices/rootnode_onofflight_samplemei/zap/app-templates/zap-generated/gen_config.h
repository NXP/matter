...
#define MATTER_DM_SAMPLE_MEI_CLUSTER_SERVER_ENDPOINT_COUNT (1)
...
// Use this macro to check if the server side of the Sample MEI cluster is included
#define ZCL_USING_SAMPLE_MEI_CLUSTER_SERVER
#define MATTER_DM_PLUGIN_SAMPLE_MEI_SERVER
#define MATTER_DM_PLUGIN_SAMPLE_MEI
...
//  SampleMei Cluster Commands
#define SAMPLE_MEI_ENABLE_PING_CMD 1
#define SAMPLE_MEI_ENABLE_ADD_ARGUMENTS_CMD 1
