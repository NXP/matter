...
#define GENERATED_ATTRIBUTES                                                                                                       \
    {                                                                                                                              \
        ...
        { ZAP_SIMPLE_DEFAULT(7600), 0x00000000, 2, ZAP_TYPE(TEMPERATURE), 0 },  /* TemperatureSetpoint */                          \
        { ZAP_SIMPLE_DEFAULT(7600), 0x00000001, 2, ZAP_TYPE(TEMPERATURE), 0 },  /* MinTemperature */                               \
        { ZAP_SIMPLE_DEFAULT(28800), 0x00000002, 2, ZAP_TYPE(TEMPERATURE), 0 }, /* MaxTemperature */                               \
        { ZAP_SIMPLE_DEFAULT(1), 0x0000FFFC, 4, ZAP_TYPE(BITMAP32), 0 },        /* FeatureMap */                                   \
        { ZAP_SIMPLE_DEFAULT(1), 0x0000FFFD, 2, ZAP_TYPE(INT16U), 0 },          /* ClusterRevision */                              \
                                                                                                                                   \
        /* Endpoint: 2, Cluster: Temperature Measurement (server) */                                                               \
        { ZAP_SIMPLE_DEFAULT(6555), 0x00000000, 2, ZAP_TYPE(TEMPERATURE), ZAP_ATTRIBUTE_MASK(NULLABLE) },  /* MeasuredValue */     \
        { ZAP_SIMPLE_DEFAULT(3000), 0x00000001, 2, ZAP_TYPE(TEMPERATURE), ZAP_ATTRIBUTE_MASK(NULLABLE) },  /* MinMeasuredValue */  \
        { ZAP_SIMPLE_DEFAULT(30000), 0x00000002, 2, ZAP_TYPE(TEMPERATURE), ZAP_ATTRIBUTE_MASK(NULLABLE) }, /* MaxMeasuredValue */  \
        { ZAP_SIMPLE_DEFAULT(0), 0x0000FFFC, 4, ZAP_TYPE(BITMAP32), 0 },                                   /* FeatureMap */        \
        ...
        { ZAP_EMPTY_DEFAULT(), 0x00000004, 1, ZAP_TYPE(INT8U), 0 }, /* SelectedTemperatureLevel */                                 \
...
#define GENERATED_ENDPOINT_TYPES                                                                                                   \
    {                                                                                                                              \
        { ZAP_CLUSTER_INDEX(0), 12, 117 }, { ZAP_CLUSTER_INDEX(12), 2, 9 },  { ZAP_CLUSTER_INDEX(14), 5, 37 },                     \
        { ZAP_CLUSTER_INDEX(19), 3, 16 },  { ZAP_CLUSTER_INDEX(22), 4, 26 },                                                       \
    }
