...
#define GENERATED_ATTRIBUTE_COUNT 172
#define GENERATED_ATTRIBUTES                                                                                                       \
    {                                                                                                                              \
        ...
        { ZAP_SIMPLE_DEFAULT(7600), 0x00000000, 2, ZAP_TYPE(TEMPERATURE),                                                          \
          ZAP_ATTRIBUTE_MASK(READABLE) }, /* TemperatureSetpoint */                                                                \
        { ZAP_SIMPLE_DEFAULT(7600), 0x00000001, 2, ZAP_TYPE(TEMPERATURE), ZAP_ATTRIBUTE_MASK(READABLE) },  /* MinTemperature */    \
        { ZAP_SIMPLE_DEFAULT(28800), 0x00000002, 2, ZAP_TYPE(TEMPERATURE), ZAP_ATTRIBUTE_MASK(READABLE) }, /* MaxTemperature */    \
        { ZAP_SIMPLE_DEFAULT(1), 0x0000FFFC, 4, ZAP_TYPE(BITMAP32), ZAP_ATTRIBUTE_MASK(READABLE) },        /* FeatureMap */        \
        { ZAP_SIMPLE_DEFAULT(1), 0x0000FFFD, 2, ZAP_TYPE(INT16U), ZAP_ATTRIBUTE_MASK(READABLE) },          /* ClusterRevision */   \
                                                                                                                                   \
        /* Endpoint: 2, Cluster: Temperature Measurement (server) */                                                               \
        { ZAP_SIMPLE_DEFAULT(6555), 0x00000000, 2, ZAP_TYPE(TEMPERATURE),                                                          \
          ZAP_ATTRIBUTE_MASK(READABLE) | ZAP_ATTRIBUTE_MASK(NULLABLE) }, /* MeasuredValue */                                       \
        { ZAP_SIMPLE_DEFAULT(3000), 0x00000001, 2, ZAP_TYPE(TEMPERATURE),                                                          \
          ZAP_ATTRIBUTE_MASK(READABLE) | ZAP_ATTRIBUTE_MASK(NULLABLE) }, /* MinMeasuredValue */                                    \
        { ZAP_SIMPLE_DEFAULT(30000), 0x00000002, 2, ZAP_TYPE(TEMPERATURE),                                                         \
        ...
        { ZAP_SIMPLE_DEFAULT(4), 0x0000FFFC, 4, ZAP_TYPE(BITMAP32), ZAP_ATTRIBUTE_MASK(READABLE) }, /* FeatureMap */               \
        ...
        { ZAP_EMPTY_DEFAULT(), 0x0000FFFD, 2, ZAP_TYPE(INT16U),                                                                    \
          ZAP_ATTRIBUTE_MASK(EXTERNAL_STORAGE) | ZAP_ATTRIBUTE_MASK(READABLE) }, /* ClusterRevision */                             \
                                                                                                                                   \
        /* Endpoint: 4, Cluster: Temperature Control (server) */                                                                   \
        { ZAP_EMPTY_DEFAULT(), 0x00000004, 1, ZAP_TYPE(INT8U), ZAP_ATTRIBUTE_MASK(READABLE) }, /* SelectedTemperatureLevel */      \
...
#define GENERATED_ENDPOINT_TYPES                                                                                                   \
    {                                                                                                                              \
        { ZAP_CLUSTER_INDEX(0), 12, 54 }, { ZAP_CLUSTER_INDEX(12), 2, 0 },  { ZAP_CLUSTER_INDEX(14), 5, 35 },                      \
        { ZAP_CLUSTER_INDEX(19), 3, 7 },  { ZAP_CLUSTER_INDEX(22), 4, 26 },                                                        \
    }
...
#define FIXED_DEVICE_TYPES { { 0x00000016, 3 }, { 0x0000007B, 2 }, { 0x00000071, 3 }, { 0x00000078, 1 }, { 0x00000077, 1 } }
...
#define FIXED_PARENT_ENDPOINTS { kInvalidEndpointId, 0, 1, 1, 3 }
