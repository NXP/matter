    ...
    {                                                                                                                              \
        ...
        { ZAP_EMPTY_DEFAULT(), 0x0000FFFD, 2, ZAP_TYPE(INT16U),                                                                    \
          ZAP_ATTRIBUTE_MASK(EXTERNAL_STORAGE) | ZAP_ATTRIBUTE_MASK(READABLE) }, /* ClusterRevision */                             \
                                                                                                                                   \
        /* Endpoint: 1, Cluster: Pump Configuration and Control (server) */                                                        \
        { ZAP_SIMPLE_DEFAULT(32767), 0x00000000, 2, ZAP_TYPE(INT16S),                                                              \
          ZAP_ATTRIBUTE_MASK(READABLE) | ZAP_ATTRIBUTE_MASK(NULLABLE) }, /* MaxPressure */                                         \
        { ZAP_SIMPLE_DEFAULT(65534), 0x00000001, 2, ZAP_TYPE(INT16U),                                                              \
          ZAP_ATTRIBUTE_MASK(READABLE) | ZAP_ATTRIBUTE_MASK(NULLABLE) }, /* MaxSpeed */                                            \
        { ZAP_SIMPLE_DEFAULT(65534), 0x00000002, 2, ZAP_TYPE(INT16U),                                                              \
          ZAP_ATTRIBUTE_MASK(READABLE) | ZAP_ATTRIBUTE_MASK(NULLABLE) },                             /* MaxFlow */                 \
        { ZAP_SIMPLE_DEFAULT(32), 0x00000010, 2, ZAP_TYPE(BITMAP16), ZAP_ATTRIBUTE_MASK(READABLE) }, /* PumpStatus */              \
        { ZAP_SIMPLE_DEFAULT(0), 0x00000011, 1, ZAP_TYPE(ENUM8),                                                                   \
          ZAP_ATTRIBUTE_MASK(TOKENIZE) | ZAP_ATTRIBUTE_MASK(READABLE) }, /* EffectiveOperationMode */                              \
        { ZAP_SIMPLE_DEFAULT(0), 0x00000012, 1, ZAP_TYPE(ENUM8),                                                                   \
          ZAP_ATTRIBUTE_MASK(TOKENIZE) | ZAP_ATTRIBUTE_MASK(READABLE) }, /* EffectiveControlMode */                                \
        ...
        { ZAP_SIMPLE_DEFAULT(6000), 0x00000000, 2, ZAP_TYPE(TEMPERATURE),                                                          \
          ZAP_ATTRIBUTE_MASK(READABLE) | ZAP_ATTRIBUTE_MASK(NULLABLE) }, /* MeasuredValue */                                       \
        { ZAP_SIMPLE_DEFAULT(100), 0x00000001, 2, ZAP_TYPE(TEMPERATURE),                                                           \
          ZAP_ATTRIBUTE_MASK(READABLE) | ZAP_ATTRIBUTE_MASK(NULLABLE) }, /* MinMeasuredValue */                                    \
        { ZAP_SIMPLE_DEFAULT(9000), 0x00000002, 2, ZAP_TYPE(TEMPERATURE),                                                          \
...
#define GENERATED_ENDPOINT_TYPES                                                                                                   \
    {                                                                                                                              \
        { ZAP_CLUSTER_INDEX(0), 10, 10 },                                                                                          \
        { ZAP_CLUSTER_INDEX(10), 8, 72 },                                                                                          \
    }
