...
#define FIXED_DEVICE_TYPES { { 0x00000016, 5 }, { 0x00000070, 1 }, { 0x00000071, 1 }, { 0x00000071, 1 }, { 0x0000002B, 1 } }
...
#define FIXED_PARENT_ENDPOINTS { kInvalidEndpointId, kInvalidEndpointId, 1, 1, 2 }
