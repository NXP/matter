...
#define GENERATED_ATTRIBUTES                                                                                                       \
    {                                                                                                                              \
        ...
        { ZAP_SIMPLE_DEFAULT(0x1), 0x00000000, 4, ZAP_TYPE(BITMAP32), 0 }, /* Mask */                                              \
        { ZAP_SIMPLE_DEFAULT(0), 0x00000002, 4, ZAP_TYPE(BITMAP32), 0 },   /* State */                                             \
        { ZAP_SIMPLE_DEFAULT(0x1), 0x00000003, 4, ZAP_TYPE(BITMAP32), 0 }, /* Supported */                                         \
        { ZAP_SIMPLE_DEFAULT(0), 0x0000FFFC, 4, ZAP_TYPE(BITMAP32), 0 },   /* FeatureMap */                                        \
        { ZAP_SIMPLE_DEFAULT(1), 0x0000FFFD, 2, ZAP_TYPE(INT16U), 0 },     /* ClusterRevision */                                   \
                                                                                                                                   \
        ...
        { ZAP_SIMPLE_DEFAULT(200), 0x00000000, 2, ZAP_TYPE(TEMPERATURE), 0 }, /* TemperatureSetpoint */                            \
        { ZAP_SIMPLE_DEFAULT(200), 0x00000001, 2, ZAP_TYPE(TEMPERATURE), 0 }, /* MinTemperature */                                 \
        { ZAP_SIMPLE_DEFAULT(400), 0x00000002, 2, ZAP_TYPE(TEMPERATURE), 0 }, /* MaxTemperature */                                 \
        { ZAP_SIMPLE_DEFAULT(10), 0x00000003, 2, ZAP_TYPE(TEMPERATURE), 0 },  /* Step */                                           \
        { ZAP_SIMPLE_DEFAULT(5), 0x0000FFFC, 4, ZAP_TYPE(BITMAP32), 0 },      /* FeatureMap */                                     \
        { ZAP_SIMPLE_DEFAULT(1), 0x0000FFFD, 2, ZAP_TYPE(INT16U), 0 },        /* ClusterRevision */                                \
                                                                                                                                   \
        /* Endpoint: 2, Cluster: Temperature Measurement (server) */                                                               \
        { ZAP_SIMPLE_DEFAULT(200), 0x00000000, 2, ZAP_TYPE(TEMPERATURE), ZAP_ATTRIBUTE_MASK(NULLABLE) },   /* MeasuredValue */     \
        { ZAP_SIMPLE_DEFAULT(-4000), 0x00000001, 2, ZAP_TYPE(TEMPERATURE), ZAP_ATTRIBUTE_MASK(NULLABLE) }, /* MinMeasuredValue */  \
        { ZAP_SIMPLE_DEFAULT(2000), 0x00000002, 2, ZAP_TYPE(TEMPERATURE), ZAP_ATTRIBUTE_MASK(NULLABLE) },  /* MaxMeasuredValue */  \
        { ZAP_SIMPLE_DEFAULT(0), 0x0000FFFC, 4, ZAP_TYPE(BITMAP32), 0 },                                   /* FeatureMap */        \
        ...
        { ZAP_SIMPLE_DEFAULT(-1800), 0x00000000, 2, ZAP_TYPE(TEMPERATURE), 0 }, /* TemperatureSetpoint */                          \
        { ZAP_SIMPLE_DEFAULT(-1800), 0x00000001, 2, ZAP_TYPE(TEMPERATURE), 0 }, /* MinTemperature */                               \
        { ZAP_SIMPLE_DEFAULT(-1500), 0x00000002, 2, ZAP_TYPE(TEMPERATURE), 0 }, /* MaxTemperature */                               \
        { ZAP_SIMPLE_DEFAULT(10), 0x00000003, 2, ZAP_TYPE(TEMPERATURE), 0 },    /* Step */                                         \
        { ZAP_SIMPLE_DEFAULT(5), 0x0000FFFC, 4, ZAP_TYPE(BITMAP32), 0 },        /* FeatureMap */                                   \
        { ZAP_SIMPLE_DEFAULT(1), 0x0000FFFD, 2, ZAP_TYPE(INT16U), 0 },          /* ClusterRevision */                              \
                                                                                                                                   \
        /* Endpoint: 3, Cluster: Temperature Measurement (server) */                                                               \
        { ZAP_SIMPLE_DEFAULT(-1800), 0x00000000, 2, ZAP_TYPE(TEMPERATURE), ZAP_ATTRIBUTE_MASK(NULLABLE) }, /* MeasuredValue */     \
        { ZAP_SIMPLE_DEFAULT(-4000), 0x00000001, 2, ZAP_TYPE(TEMPERATURE), ZAP_ATTRIBUTE_MASK(NULLABLE) }, /* MinMeasuredValue */  \
        { ZAP_SIMPLE_DEFAULT(2000), 0x00000002, 2, ZAP_TYPE(TEMPERATURE), ZAP_ATTRIBUTE_MASK(NULLABLE) },  /* MaxMeasuredValue */  \
        { ZAP_SIMPLE_DEFAULT(0), 0x0000FFFC, 4, ZAP_TYPE(BITMAP32), 0 },                                   /* FeatureMap */        \
        { ZAP_SIMPLE_DEFAULT(4), 0x0000FFFD, 2, ZAP_TYPE(INT16U), 0 },                                     /* ClusterRevision */   \
...
#define GENERATED_ENDPOINT_TYPES                                                                                                   \
    {                                                                                                                              \
        { ZAP_CLUSTER_INDEX(0), 11, 75 },                                                                                          \
        { ZAP_CLUSTER_INDEX(11), 3, 20 },                                                                                          \
        { ZAP_CLUSTER_INDEX(14), 3, 26 },                                                                                          \
        { ZAP_CLUSTER_INDEX(17), 3, 26 },                                                                                          \
    }
...
#define FIXED_DEVICE_TYPES { { 0x00000016, 3 }, { 0x00000070, 1 }, { 0x00000071, 1 }, { 0x00000071, 1 } }
