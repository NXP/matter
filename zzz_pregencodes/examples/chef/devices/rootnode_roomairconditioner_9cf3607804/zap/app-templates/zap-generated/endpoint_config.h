...
#define GENERATED_ATTRIBUTE_COUNT 157
#define GENERATED_ATTRIBUTES                                                                                                       \
    {                                                                                                                              \
        ...
        { ZAP_SIMPLE_DEFAULT(0), 0x00000000, 1, ZAP_TYPE(BOOLEAN), ZAP_ATTRIBUTE_MASK(TOKENIZE) }, /* OnOff */                     \
        ...
        { ZAP_EMPTY_DEFAULT(), 0x0000FFFD, 2, ZAP_TYPE(INT16U), ZAP_ATTRIBUTE_MASK(EXTERNAL_STORAGE) },   /* ClusterRevision */    \
                                                                                                                                   \
        /* Endpoint: 1, Cluster: Thermostat (server) */                                                                            \
        { ZAP_SIMPLE_DEFAULT(2800), 0x00000000, 2, ZAP_TYPE(TEMPERATURE), ZAP_ATTRIBUTE_MASK(NULLABLE) }, /* LocalTemperature */   \
        ...
        { ZAP_MIN_MAX_DEFAULTS_INDEX(8), 0x00000045, 1, ZAP_TYPE(ENUM8),                                                           \
          ZAP_ATTRIBUTE_MASK(MIN_MAX) | ZAP_ATTRIBUTE_MASK(TOKENIZE) | ZAP_ATTRIBUTE_MASK(WRITABLE) }, /* ACLouverPosition */      \
        ...
        { ZAP_MIN_MAX_DEFAULTS_INDEX(11), 0x00000008, 1, ZAP_TYPE(BITMAP8),                                                        \
          ZAP_ATTRIBUTE_MASK(MIN_MAX) | ZAP_ATTRIBUTE_MASK(WRITABLE) }, /* RockSetting */                                          \
        { ZAP_MIN_MAX_DEFAULTS_INDEX(12), 0x0000000B, 1, ZAP_TYPE(ENUM8),                                                          \
          ZAP_ATTRIBUTE_MASK(MIN_MAX) | ZAP_ATTRIBUTE_MASK(WRITABLE) },   /* AirflowDirection */                                   \
        { ZAP_SIMPLE_DEFAULT(37), 0x0000FFFC, 4, ZAP_TYPE(BITMAP32), 0 }, /* FeatureMap */                                         \
        { ZAP_SIMPLE_DEFAULT(1), 0x0000FFFD, 2, ZAP_TYPE(INT16U), 0 },    /* ClusterRevision */                                    \
                                                                                                                                   \
        /* Endpoint: 1, Cluster: Thermostat User Interface Configuration (server) */                                               \
        ...
        { ZAP_SIMPLE_DEFAULT(2800), 0x00000000, 2, ZAP_TYPE(TEMPERATURE), ZAP_ATTRIBUTE_MASK(NULLABLE) }, /* MeasuredValue */      \
        { ZAP_SIMPLE_DEFAULT(1500), 0x00000001, 2, ZAP_TYPE(TEMPERATURE), ZAP_ATTRIBUTE_MASK(NULLABLE) }, /* MinMeasuredValue */   \
        { ZAP_SIMPLE_DEFAULT(4500), 0x00000002, 2, ZAP_TYPE(TEMPERATURE), ZAP_ATTRIBUTE_MASK(NULLABLE) }, /* MaxMeasuredValue */   \
        { ZAP_SIMPLE_DEFAULT(0), 0x0000FFFC, 4, ZAP_TYPE(BITMAP32), 0 },                                  /* FeatureMap */         \
        { ZAP_SIMPLE_DEFAULT(3), 0x0000FFFD, 2, ZAP_TYPE(INT16U), 0 },                                    /* ClusterRevision */    \
                                                                                                                                   \
        ...
        { ZAP_SIMPLE_DEFAULT(6500), 0x00000000, 2, ZAP_TYPE(INT16U), ZAP_ATTRIBUTE_MASK(NULLABLE) },  /* MeasuredValue */          \
        { ZAP_SIMPLE_DEFAULT(3000), 0x00000001, 2, ZAP_TYPE(INT16U), ZAP_ATTRIBUTE_MASK(NULLABLE) },  /* MinMeasuredValue */       \
...
#define GENERATED_ENDPOINT_TYPES                                                                                                   \
    {                                                                                                                              \
        ...
        { ZAP_CLUSTER_INDEX(10), 7, 75 },                                                                                          \
        { ZAP_CLUSTER_INDEX(17), 3, 21 },                                                                                          \
        { ZAP_CLUSTER_INDEX(20), 3, 21 },                                                                                          \
    }
...
#define FIXED_DEVICE_TYPES { { 0x00000016, 3 }, { 0x00000072, 1 }, { 0x00000302, 1 }, { 0x00000307, 1 } }
...
#define FIXED_PARENT_ENDPOINTS { kInvalidEndpointId, kInvalidEndpointId, 1, 1 }
