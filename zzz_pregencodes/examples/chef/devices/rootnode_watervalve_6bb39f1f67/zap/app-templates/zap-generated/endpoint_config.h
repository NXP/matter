...
#define GENERATED_ATTRIBUTES                                                                                                       \
    {                                                                                                                              \
        ...
        { ZAP_SIMPLE_DEFAULT(518400), 0x0000000D, 4, ZAP_TYPE(INT32U),                                                             \
        ...
        { ZAP_EMPTY_DEFAULT(), 0x00000001, 4, ZAP_TYPE(ELAPSED_S),                                                                 \
          ZAP_ATTRIBUTE_MASK(WRITABLE) | ZAP_ATTRIBUTE_MASK(READABLE) | ZAP_ATTRIBUTE_MASK(NULLABLE) }, /* DefaultOpenDuration */  \
        ...
        { ZAP_MIN_MAX_DEFAULTS_INDEX(0), 0x00000008, 1, ZAP_TYPE(PERCENT),                                                         \
          ZAP_ATTRIBUTE_MASK(MIN_MAX) | ZAP_ATTRIBUTE_MASK(WRITABLE) | ZAP_ATTRIBUTE_MASK(READABLE) }, /* DefaultOpenLevel */      \
