...
#define GENERATED_ATTRIBUTES                                                                                                       \
    {                                                                                                                              \
        ...
        { ZAP_EMPTY_DEFAULT(), 0x0000FFFD, 2, ZAP_TYPE(INT16U), ZAP_ATTRIBUTE_MASK(EXTERNAL_STORAGE) },   /* ClusterRevision */    \
                                                                                                                                   \
        /* Endpoint: 1, Cluster: Window Covering (server) */                                                                       \
        { ZAP_SIMPLE_DEFAULT(8), 0x00000000, 1, ZAP_TYPE(ENUM8), 0 }, /* Type */                                                   \
        ...
        { ZAP_SIMPLE_DEFAULT(0x19), 0x00000007, 1, ZAP_TYPE(BITMAP8), ZAP_ATTRIBUTE_MASK(TOKENIZE) }, /* ConfigStatus */           \
        ...
        { ZAP_SIMPLE_DEFAULT(8), 0x0000000D, 1, ZAP_TYPE(ENUM8), 0 }, /* EndProductType */                                         \
