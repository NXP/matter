...
void __attribute__((weak)) emberAfClosureControlClusterShutdownCallback(EndpointId endpoint)
{
    // To prevent warning
    (void) endpoint;
}
...
void __attribute__((weak)) emberAfClosureDimensionClusterShutdownCallback(EndpointId endpoint)
{
    // To prevent warning
    (void) endpoint;
}
