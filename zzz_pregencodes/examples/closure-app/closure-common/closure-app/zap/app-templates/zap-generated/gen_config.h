...
#define MATTER_DM_CLOSURE_CONTROL_CLUSTER_SERVER_ENDPOINT_COUNT (1)
#define MATTER_DM_CLOSURE_DIMENSION_CLUSTER_SERVER_ENDPOINT_COUNT (2)
...
// Use this macro to check if the server side of the Closure Control cluster is included
#define ZCL_USING_CLOSURE_CONTROL_CLUSTER_SERVER
#define MATTER_DM_PLUGIN_CLOSURE_CONTROL_SERVER
#define MATTER_DM_PLUGIN_CLOSURE_CONTROL

// Use this macro to check if the server side of the Closure Dimension cluster is included
#define ZCL_USING_CLOSURE_DIMENSION_CLUSTER_SERVER
#define MATTER_DM_PLUGIN_CLOSURE_DIMENSION_SERVER
#define MATTER_DM_PLUGIN_CLOSURE_DIMENSION
...
//  ClosureControl Cluster Commands
#define CLOSURE_CONTROL_ENABLE_STOP_CMD 1
#define CLOSURE_CONTROL_ENABLE_MOVE_TO_CMD 1
#define CLOSURE_CONTROL_ENABLE_CALIBRATE_CMD 1

//  ClosureDimension Cluster Commands
#define CLOSURE_DIMENSION_ENABLE_SET_TARGET_CMD 1
#define CLOSURE_DIMENSION_ENABLE_STEP_CMD 1
