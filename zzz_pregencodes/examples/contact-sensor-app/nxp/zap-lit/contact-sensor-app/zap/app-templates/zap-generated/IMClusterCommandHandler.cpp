                                                          ...
                                                          TLV::TLVReader & aDataTlv)
{
    ...
    bool wasHandled     = false;
    {
        ...
        case Commands::RegisterClient::Id: {
            ...
            if (TLVError == CHIP_NO_ERROR)
            {
                wasHandled = emberAfIcdManagementClusterRegisterClientCallback(apCommandObj, aCommandPath, commandData);
            }
            break;
        }
        case Commands::UnregisterClient::Id: {
            ...
            if (TLVError == CHIP_NO_ERROR)
            {
                wasHandled = emberAfIcdManagementClusterUnregisterClientCallback(apCommandObj, aCommandPath, commandData);
            }
            break;
        }
        case Commands::StayActiveRequest::Id: {
            ...
            if (TLVError == CHIP_NO_ERROR)
            {
                wasHandled = emberAfIcdManagementClusterStayActiveRequestCallback(apCommandObj, aCommandPath, commandData);
            }
            break;
        }
        default: {
...
void DispatchSingleClusterCommand(const ConcreteCommandPath & aCommandPath, TLV::TLVReader & aReader, CommandHandler * apCommandObj)
{
    ...
    case Clusters::IcdManagement::Id:
        errorStatus = Clusters::IcdManagement::DispatchServerCommand(apCommandObj, aCommandPath, aReader);
        break;
