...
#define GENERATED_ATTRIBUTES                                                                                                       \
    {                                                                                                                              \
        ...
        { ZAP_SIMPLE_DEFAULT(4096), 0x00000006, 4, ZAP_TYPE(BITMAP32), 0 },        /* UserActiveModeTriggerHint */                 \
...
#define GENERATED_ENDPOINT_TYPES                                                                                                   \
    {                                                                                                                              \
        { ZAP_CLUSTER_INDEX(0), 15, 217 },                                                                                         \
        { ZAP_CLUSTER_INDEX(15), 3, 16 },                                                                                          \
    }
...
#define FIXED_DEVICE_TYPES { { 0x00000012, 1 }, { 0x00000016, 3 }, { 0x00000015, 1 } }
