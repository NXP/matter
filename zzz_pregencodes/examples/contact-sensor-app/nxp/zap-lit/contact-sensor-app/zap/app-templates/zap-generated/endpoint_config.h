...
#define GENERATED_DEFAULTS                                                                                                         \
    {                                                                                                                              \
        ...
        33,  'P', 'u', 's', 'h', ' ', 's', 'e', 't', 'u', 'p', ' ', 'b', 'u', 't', 't', 'o',                                       \
        'n', ' ', 'f', 'o', 'r', ' ', 'A', 'c', 't', 'i', 'v', 'e', ' ', 'M', 'o', 'd', 'e',                                       \
                                                                                                                                   \
    }
...
#define GENERATED_ATTRIBUTES                                                                                                       \
    {                                                                                                                              \
        ...
        { ZAP_SIMPLE_DEFAULT(4096), 0x00000006, 4, ZAP_TYPE(BITMAP32),                                                             \
