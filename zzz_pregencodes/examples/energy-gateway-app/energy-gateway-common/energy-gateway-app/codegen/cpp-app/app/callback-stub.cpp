...
void __attribute__((weak)) emberAfElectricalGridConditionsClusterShutdownCallback(EndpointId endpoint)
{
    // To prevent warning
    (void) endpoint;
}
...
void __attribute__((weak)) emberAfMeterIdentificationClusterShutdownCallback(EndpointId endpoint)
{
    // To prevent warning
    (void) endpoint;
}
