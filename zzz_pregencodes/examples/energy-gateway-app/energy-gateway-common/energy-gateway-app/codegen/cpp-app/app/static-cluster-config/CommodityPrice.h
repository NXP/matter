...
inline constexpr AttributeId kEndpoint1EnabledAttributes[] = {
    ...
    Attributes::ClusterRevision::Id,      Attributes::Currency::Id,
    Attributes::CurrentPrice::Id,         Attributes::FeatureMap::Id,
    Attributes::GeneratedCommandList::Id, Attributes::PriceForecast::Id,
