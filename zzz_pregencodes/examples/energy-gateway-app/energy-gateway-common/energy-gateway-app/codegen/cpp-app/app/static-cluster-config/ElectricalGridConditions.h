...
inline constexpr AttributeId kEndpoint1EnabledAttributes[] = {
    ...
    Attributes::ClusterRevision::Id,      Attributes::CurrentConditions::Id,
    Attributes::FeatureMap::Id,           Attributes::ForecastConditions::Id,
    Attributes::GeneratedCommandList::Id, Attributes::LocalGenerationAvailable::Id,
};
} // namespace detail
