...
#define MATTER_DM_COMMODITY_PRICE_CLUSTER_SERVER_ENDPOINT_COUNT (1)
...
#define MATTER_DM_ELECTRICAL_GRID_CONDITIONS_CLUSTER_SERVER_ENDPOINT_COUNT (1)
...
#define MATTER_DM_COMMODITY_TARIFF_CLUSTER_SERVER_ENDPOINT_COUNT (1)
...
#define MATTER_DM_METER_IDENTIFICATION_CLUSTER_SERVER_ENDPOINT_COUNT (1)
#define MATTER_DM_COMMODITY_METERING_CLUSTER_SERVER_ENDPOINT_COUNT (1)
...
// Use this macro to check if the server side of the Commodity Price cluster is included
#define ZCL_USING_COMMODITY_PRICE_CLUSTER_SERVER
#define MATTER_DM_PLUGIN_COMMODITY_PRICE_SERVER
#define MATTER_DM_PLUGIN_COMMODITY_PRICE

// Use this macro to check if the server side of the Electrical Grid Conditions cluster is included
#define ZCL_USING_ELECTRICAL_GRID_CONDITIONS_CLUSTER_SERVER
#define MATTER_DM_PLUGIN_ELECTRICAL_GRID_CONDITIONS_SERVER
#define MATTER_DM_PLUGIN_ELECTRICAL_GRID_CONDITIONS

// Use this macro to check if the server side of the Commodity Tariff cluster is included
#define ZCL_USING_COMMODITY_TARIFF_CLUSTER_SERVER
#define MATTER_DM_PLUGIN_COMMODITY_TARIFF_SERVER
#define MATTER_DM_PLUGIN_COMMODITY_TARIFF

// Use this macro to check if the server side of the Meter Identification cluster is included
#define ZCL_USING_METER_IDENTIFICATION_CLUSTER_SERVER
#define MATTER_DM_PLUGIN_METER_IDENTIFICATION_SERVER
#define MATTER_DM_PLUGIN_METER_IDENTIFICATION

// Use this macro to check if the server side of the Commodity Metering cluster is included
#define ZCL_USING_COMMODITY_METERING_CLUSTER_SERVER
#define MATTER_DM_PLUGIN_COMMODITY_METERING_SERVER
#define MATTER_DM_PLUGIN_COMMODITY_METERING
...
//  CommodityPrice Cluster Commands
#define COMMODITY_PRICE_ENABLE_GET_DETAILED_PRICE_REQUEST_CMD 1
#define COMMODITY_PRICE_ENABLE_GET_DETAILED_FORECAST_REQUEST_CMD 1

//  CommodityTariff Cluster Commands
#define COMMODITY_TARIFF_ENABLE_GET_TARIFF_COMPONENT_CMD 1
#define COMMODITY_TARIFF_ENABLE_GET_DAY_ENTRY_CMD 1
