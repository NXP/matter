...
#define MATTER_DM_ELECTRICAL_POWER_MEASUREMENT_CLUSTER_SERVER_ENDPOINT_COUNT (2)
#define MATTER_DM_ELECTRICAL_ENERGY_MEASUREMENT_CLUSTER_SERVER_ENDPOINT_COUNT (2)
#define MATTER_DM_WATER_HEATER_MANAGEMENT_CLUSTER_SERVER_ENDPOINT_COUNT (1)
...
#define MATTER_DM_DEVICE_ENERGY_MANAGEMENT_CLUSTER_SERVER_ENDPOINT_COUNT (2)
...
#define MATTER_DM_POWER_TOPOLOGY_CLUSTER_SERVER_ENDPOINT_COUNT (2)
#define MATTER_DM_ENERGY_EVSE_MODE_CLUSTER_SERVER_ENDPOINT_COUNT (1)
#define MATTER_DM_WATER_HEATER_MODE_CLUSTER_SERVER_ENDPOINT_COUNT (1)
#define MATTER_DM_DEVICE_ENERGY_MANAGEMENT_MODE_CLUSTER_SERVER_ENDPOINT_COUNT (2)
...
// Use this macro to check if the server side of the Water Heater Management cluster is included
#define ZCL_USING_WATER_HEATER_MANAGEMENT_CLUSTER_SERVER
#define MATTER_DM_PLUGIN_WATER_HEATER_MANAGEMENT_SERVER
#define MATTER_DM_PLUGIN_WATER_HEATER_MANAGEMENT
...
// Use this macro to check if the server side of the Water Heater Mode cluster is included
#define ZCL_USING_WATER_HEATER_MODE_CLUSTER_SERVER
#define MATTER_DM_PLUGIN_WATER_HEATER_MODE_SERVER
#define MATTER_DM_PLUGIN_WATER_HEATER_MODE
...
//  WaterHeaterManagement Cluster Commands
#define WATER_HEATER_MANAGEMENT_ENABLE_BOOST_CMD 1
#define WATER_HEATER_MANAGEMENT_ENABLE_CANCEL_BOOST_CMD 1

//  WaterHeaterMode Cluster Commands
#define WATER_HEATER_MODE_ENABLE_CHANGE_TO_MODE_CMD 1
