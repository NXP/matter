...
void DispatchServerCommand(CommandHandler * apCommandObj, const ConcreteCommandPath & aCommandPath, TLV::TLVReader & aDataTlv)
{
    ...
    bool wasHandled     = false;
    {
        ...
        case Commands::RequestCommissioningApproval::Id: {
            Commands::RequestCommissioningApproval::DecodableType commandData;
            TLVError = DataModel::Decode(aDataTlv, commandData);
            if (TLVError == CHIP_NO_ERROR)
            {
                wasHandled =
                    emberAfCommissionerControlClusterRequestCommissioningApprovalCallback(apCommandObj, aCommandPath, commandData);
            }
            break;
        }
        case Commands::CommissionNode::Id: {
            Commands::CommissionNode::DecodableType commandData;
            TLVError = DataModel::Decode(aDataTlv, commandData);
            if (TLVError == CHIP_NO_ERROR)
            {
                wasHandled = emberAfCommissionerControlClusterCommissionNodeCallback(apCommandObj, aCommandPath, commandData);
            }
            break;
        }
        default: {
...
void DispatchSingleClusterCommand(const ConcreteCommandPath & aCommandPath, TLV::TLVReader & aReader, CommandHandler * apCommandObj)
{
    ...
    case Clusters::CommissionerControl::Id:
        Clusters::CommissionerControl::DispatchServerCommand(apCommandObj, aCommandPath, aReader);
        break;
