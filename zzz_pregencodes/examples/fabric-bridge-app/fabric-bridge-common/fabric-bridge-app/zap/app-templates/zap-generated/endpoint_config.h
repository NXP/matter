...
#define GENERATED_ATTRIBUTES                                                                                                       \
    {                                                                                                                              \
        ...
        { ZAP_SIMPLE_DEFAULT(0), 0x00000000, 4, ZAP_TYPE(BITMAP32), 0 }, /* SupportedDeviceCategories */                           \
        { ZAP_SIMPLE_DEFAULT(0), 0x0000FFFC, 4, ZAP_TYPE(BITMAP32), 0 }, /* FeatureMap */                                          \
        { ZAP_SIMPLE_DEFAULT(1), 0x0000FFFD, 2, ZAP_TYPE(INT16U), 0 },   /* ClusterRevision */                                     \
    }
...
#define GENERATED_EVENTS { \
  ...
  /* Endpoint: 1, Cluster: Commissioner Control (server) */ \
  /* EventList (index=9) */ \
  0x00000000, /* CommissioningRequestResult */ \
}
...
#define GENERATED_COMMANDS { \
  ...
  0x00000000 /* RequestCommissioningApproval */, \
  0x00000001 /* CommissionNode */, \
  chip::kInvalidCommandId /* end of list */, \
  /*   GeneratedCommandList (index=65)*/ \
  0x00000002 /* ReverseOpenCommissioningWindow */, \
  chip::kInvalidCommandId /* end of list */, \
}
...
#define GENERATED_ENDPOINT_TYPES                                                                                                   \
    {                                                                                                                              \
        { ZAP_CLUSTER_INDEX(0), 15, 86 },                                                                                          \
        { ZAP_CLUSTER_INDEX(15), 3, 19 },                                                                                          \
    }
...
#define FIXED_DEVICE_TYPES { { 0x00000016, 3 }, { 0x0000000E, 2 } }
