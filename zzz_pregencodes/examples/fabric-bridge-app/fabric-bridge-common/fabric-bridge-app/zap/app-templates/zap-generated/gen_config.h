...
#define MATTER_DM_COMMISSIONER_CONTROL_CLUSTER_SERVER_ENDPOINT_COUNT (1)
...
// Use this macro to check if the server side of the Commissioner Control cluster is included
#define ZCL_USING_COMMISSIONER_CONTROL_CLUSTER_SERVER
#define MATTER_DM_PLUGIN_COMMISSIONER_CONTROL_SERVER
#define MATTER_DM_PLUGIN_COMMISSIONER_CONTROL
...
//  CommissionerControl Cluster Commands
#define COMMISSIONER_CONTROL_ENABLE_REQUEST_COMMISSIONING_APPROVAL_CMD 1
#define COMMISSIONER_CONTROL_ENABLE_COMMISSION_NODE_CMD 1
