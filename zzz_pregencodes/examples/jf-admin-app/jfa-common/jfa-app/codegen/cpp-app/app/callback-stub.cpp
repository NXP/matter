...
void __attribute__((weak)) emberAfJointFabricAdministratorClusterShutdownCallback(EndpointId endpoint)
{
    // To prevent warning
    (void) endpoint;
}
...
void __attribute__((weak)) emberAfJointFabricDatastoreClusterShutdownCallback(EndpointId endpoint)
{
    // To prevent warning
    (void) endpoint;
}
