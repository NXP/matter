                                                          ...
                                                          TLV::TLVReader & aDataTlv)
{
    ...
    bool wasHandled     = false;
    {
        ...
        case Commands::AddKeySet::Id: {
            Commands::AddKeySet::DecodableType commandData;
            TLVError = DataModel::Decode(aDataTlv, commandData);
            if (TLVError == CHIP_NO_ERROR)
            {
                wasHandled = emberAfJointFabricDatastoreClusterAddKeySetCallback(apCommandObj, aCommandPath, commandData);
            }
            break;
        }
        case Commands::UpdateKeySet::Id: {
            Commands::UpdateKeySet::DecodableType commandData;
            TLVError = DataModel::Decode(aDataTlv, commandData);
            if (TLVError == CHIP_NO_ERROR)
            {
                wasHandled = emberAfJointFabricDatastoreClusterUpdateKeySetCallback(apCommandObj, aCommandPath, commandData);
            }
            break;
        }
        case Commands::RemoveKeySet::Id: {
            Commands::RemoveKeySet::DecodableType commandData;
            TLVError = DataModel::Decode(aDataTlv, commandData);
            if (TLVError == CHIP_NO_ERROR)
            {
                wasHandled = emberAfJointFabricDatastoreClusterRemoveKeySetCallback(apCommandObj, aCommandPath, commandData);
            }
            break;
        }
        case Commands::AddGroup::Id: {
            ...
            if (TLVError == CHIP_NO_ERROR)
            {
                wasHandled = emberAfJointFabricDatastoreClusterAddGroupCallback(apCommandObj, aCommandPath, commandData);
            }
            break;
        }
        case Commands::UpdateGroup::Id: {
            Commands::UpdateGroup::DecodableType commandData;
            TLVError = DataModel::Decode(aDataTlv, commandData);
            if (TLVError == CHIP_NO_ERROR)
            {
                wasHandled = emberAfJointFabricDatastoreClusterUpdateGroupCallback(apCommandObj, aCommandPath, commandData);
            }
            break;
        }
        case Commands::RemoveGroup::Id: {
            ...
            if (TLVError == CHIP_NO_ERROR)
            {
                wasHandled = emberAfJointFabricDatastoreClusterRemoveGroupCallback(apCommandObj, aCommandPath, commandData);
            }
            break;
        }
        case Commands::AddAdmin::Id: {
            Commands::AddAdmin::DecodableType commandData;
            TLVError = DataModel::Decode(aDataTlv, commandData);
            if (TLVError == CHIP_NO_ERROR)
            {
                wasHandled = emberAfJointFabricDatastoreClusterAddAdminCallback(apCommandObj, aCommandPath, commandData);
            }
            break;
        }
        case Commands::UpdateAdmin::Id: {
            Commands::UpdateAdmin::DecodableType commandData;
            TLVError = DataModel::Decode(aDataTlv, commandData);
            if (TLVError == CHIP_NO_ERROR)
            {
                wasHandled = emberAfJointFabricDatastoreClusterUpdateAdminCallback(apCommandObj, aCommandPath, commandData);
            }
            break;
        }
        case Commands::RemoveAdmin::Id: {
            Commands::RemoveAdmin::DecodableType commandData;
            TLVError = DataModel::Decode(aDataTlv, commandData);
            if (TLVError == CHIP_NO_ERROR)
            {
                wasHandled = emberAfJointFabricDatastoreClusterRemoveAdminCallback(apCommandObj, aCommandPath, commandData);
            }
            break;
        }
        case Commands::AddPendingNode::Id: {
            Commands::AddPendingNode::DecodableType commandData;
            TLVError = DataModel::Decode(aDataTlv, commandData);
            if (TLVError == CHIP_NO_ERROR)
            {
                wasHandled = emberAfJointFabricDatastoreClusterAddPendingNodeCallback(apCommandObj, aCommandPath, commandData);
            }
            break;
        }
        case Commands::RefreshNode::Id: {
            Commands::RefreshNode::DecodableType commandData;
            TLVError = DataModel::Decode(aDataTlv, commandData);
            if (TLVError == CHIP_NO_ERROR)
            {
                wasHandled = emberAfJointFabricDatastoreClusterRefreshNodeCallback(apCommandObj, aCommandPath, commandData);
            }
            break;
        }
        case Commands::UpdateNode::Id: {
            Commands::UpdateNode::DecodableType commandData;
            TLVError = DataModel::Decode(aDataTlv, commandData);
            if (TLVError == CHIP_NO_ERROR)
            {
                wasHandled = emberAfJointFabricDatastoreClusterUpdateNodeCallback(apCommandObj, aCommandPath, commandData);
            }
            break;
        }
        case Commands::RemoveNode::Id: {
            Commands::RemoveNode::DecodableType commandData;
            TLVError = DataModel::Decode(aDataTlv, commandData);
            if (TLVError == CHIP_NO_ERROR)
            {
                wasHandled = emberAfJointFabricDatastoreClusterRemoveNodeCallback(apCommandObj, aCommandPath, commandData);
            }
            break;
        }
        case Commands::UpdateEndpointForNode::Id: {
            Commands::UpdateEndpointForNode::DecodableType commandData;
            TLVError = DataModel::Decode(aDataTlv, commandData);
            if (TLVError == CHIP_NO_ERROR)
            {
                wasHandled =
                    emberAfJointFabricDatastoreClusterUpdateEndpointForNodeCallback(apCommandObj, aCommandPath, commandData);
            }
            break;
        }
        case Commands::AddGroupIDToEndpointForNode::Id: {
            Commands::AddGroupIDToEndpointForNode::DecodableType commandData;
            TLVError = DataModel::Decode(aDataTlv, commandData);
            if (TLVError == CHIP_NO_ERROR)
            {
                wasHandled =
                    emberAfJointFabricDatastoreClusterAddGroupIDToEndpointForNodeCallback(apCommandObj, aCommandPath, commandData);
            }
            break;
        }
        case Commands::RemoveGroupIDFromEndpointForNode::Id: {
            Commands::RemoveGroupIDFromEndpointForNode::DecodableType commandData;
            TLVError = DataModel::Decode(aDataTlv, commandData);
            if (TLVError == CHIP_NO_ERROR)
            {
                wasHandled = emberAfJointFabricDatastoreClusterRemoveGroupIDFromEndpointForNodeCallback(apCommandObj, aCommandPath,
                                                                                                        commandData);
            }
            break;
        }
        case Commands::AddBindingToEndpointForNode::Id: {
            Commands::AddBindingToEndpointForNode::DecodableType commandData;
            TLVError = DataModel::Decode(aDataTlv, commandData);
            if (TLVError == CHIP_NO_ERROR)
            {
                wasHandled =
                    emberAfJointFabricDatastoreClusterAddBindingToEndpointForNodeCallback(apCommandObj, aCommandPath, commandData);
            }
            break;
        }
        case Commands::RemoveBindingFromEndpointForNode::Id: {
            Commands::RemoveBindingFromEndpointForNode::DecodableType commandData;
            TLVError = DataModel::Decode(aDataTlv, commandData);
            if (TLVError == CHIP_NO_ERROR)
            {
                wasHandled = emberAfJointFabricDatastoreClusterRemoveBindingFromEndpointForNodeCallback(apCommandObj, aCommandPath,
                                                                                                        commandData);
            }
            break;
        }
        case Commands::AddACLToNode::Id: {
            Commands::AddACLToNode::DecodableType commandData;
            TLVError = DataModel::Decode(aDataTlv, commandData);
            if (TLVError == CHIP_NO_ERROR)
            {
                wasHandled = emberAfJointFabricDatastoreClusterAddACLToNodeCallback(apCommandObj, aCommandPath, commandData);
            }
            break;
        }
        case Commands::RemoveACLFromNode::Id: {
            Commands::RemoveACLFromNode::DecodableType commandData;
            TLVError = DataModel::Decode(aDataTlv, commandData);
            if (TLVError == CHIP_NO_ERROR)
            {
                wasHandled = emberAfJointFabricDatastoreClusterRemoveACLFromNodeCallback(apCommandObj, aCommandPath, commandData);
            }
            break;
        }
        default: {
