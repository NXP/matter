...
#define GENERATED_DEFAULTS                                                                                                         \
    {                                                                                                                              \
        ...
        0x00,                                                                                                                      \
                                                                                                                                   \
        /* Endpoint: 1, Cluster: Joint Fabric Datastore (server), big-endian */                                                    \
                                                                                                                                   \
        /* 8 - AnchorNodeID, */                                                                                                    \
        0x00,                                                                                                                      \
        0x00,                                                                                                                      \
...
#define GENERATED_DEFAULTS                                                                                                         \
    {                                                                                                                              \
        ...
        0x00,                                                                                                                      \
                                                                                                                                   \
        /* Endpoint: 1, Cluster: Joint Fabric Datastore (server), little-endian */                                                 \
                                                                                                                                   \
        /* 8 - AnchorNodeID, */                                                                                                    \
        0x00,                                                                                                                      \
        0x00,                                                                                                                      \
...
#define GENERATED_ATTRIBUTE_COUNT 267
#define GENERATED_ATTRIBUTES                                                                                                       \
    {                                                                                                                              \
        ...
        { ZAP_EMPTY_DEFAULT(), 0x00000000, 255, ZAP_TYPE(OCTET_STRING), 0 },                            /* AnchorRootCA */         \
        { ZAP_LONG_DEFAULTS_INDEX(8), 0x00000001, 8, ZAP_TYPE(NODE_ID), 0 },                            /* AnchorNodeID */         \
        { ZAP_EMPTY_DEFAULT(), 0x00000002, 2, ZAP_TYPE(VENDOR_ID), 0 },                                 /* AnchorVendorID */       \
        { ZAP_EMPTY_DEFAULT(), 0x00000003, 33, ZAP_TYPE(CHAR_STRING), 0 },                              /* FriendlyName */         \
        { ZAP_EMPTY_DEFAULT(), 0x00000004, 0, ZAP_TYPE(ARRAY), ZAP_ATTRIBUTE_MASK(EXTERNAL_STORAGE) },  /* GroupKeySetList */      \
        { ZAP_EMPTY_DEFAULT(), 0x00000005, 0, ZAP_TYPE(ARRAY), ZAP_ATTRIBUTE_MASK(EXTERNAL_STORAGE) },  /* GroupList */            \
        { ZAP_EMPTY_DEFAULT(), 0x00000006, 0, ZAP_TYPE(ARRAY), ZAP_ATTRIBUTE_MASK(EXTERNAL_STORAGE) },  /* NodeList */             \
        { ZAP_EMPTY_DEFAULT(), 0x00000007, 0, ZAP_TYPE(ARRAY), ZAP_ATTRIBUTE_MASK(EXTERNAL_STORAGE) },  /* AdminList */            \
        { ZAP_EMPTY_DEFAULT(), 0x00000008, 0, ZAP_TYPE(STRUCT), ZAP_ATTRIBUTE_MASK(EXTERNAL_STORAGE) }, /* Status */               \
        { ZAP_EMPTY_DEFAULT(), 0x00000009, 0, ZAP_TYPE(ARRAY), ZAP_ATTRIBUTE_MASK(EXTERNAL_STORAGE) },  /* EndpointGroupIDList */  \
        { ZAP_EMPTY_DEFAULT(), 0x0000000A, 0, ZAP_TYPE(ARRAY), ZAP_ATTRIBUTE_MASK(EXTERNAL_STORAGE) },  /* EndpointBindingList */  \
        { ZAP_EMPTY_DEFAULT(), 0x0000000B, 0, ZAP_TYPE(ARRAY), ZAP_ATTRIBUTE_MASK(EXTERNAL_STORAGE) },  /* NodeKeySetList */       \
        { ZAP_EMPTY_DEFAULT(), 0x0000000C, 0, ZAP_TYPE(ARRAY), ZAP_ATTRIBUTE_MASK(EXTERNAL_STORAGE) },  /* NodeACLList */          \
        { ZAP_EMPTY_DEFAULT(), 0x0000000D, 0, ZAP_TYPE(ARRAY), ZAP_ATTRIBUTE_MASK(EXTERNAL_STORAGE) },  /* NodeEndpointList */     \
        { ZAP_SIMPLE_DEFAULT(0), 0x0000FFFC, 4, ZAP_TYPE(BITMAP32), 0 },                                /* FeatureMap */           \
        { ZAP_SIMPLE_DEFAULT(1), 0x0000FFFD, 2, ZAP_TYPE(INT16U), 0 },                                  /* ClusterRevision */      \
                                                                                                                                   \
        /* Endpoint: 1, Cluster: Joint Fabric Administrator (server) */                                                            \
        { ZAP_EMPTY_DEFAULT(), 0x00000000, 1, ZAP_TYPE(FABRIC_IDX), ZAP_ATTRIBUTE_MASK(NULLABLE) }, /* AdministratorFabricIndex */ \
        { ZAP_SIMPLE_DEFAULT(0), 0x0000FFFC, 4, ZAP_TYPE(BITMAP32), 0 },                            /* FeatureMap */               \
        { ZAP_SIMPLE_DEFAULT(1), 0x0000FFFD, 2, ZAP_TYPE(INT16U), 0 },                              /* ClusterRevision */          \
    }
...
#define GENERATED_COMMANDS { \
  ...
  0x00000000 /* AddKeySet */, \
  0x00000001 /* UpdateKeySet */, \
  0x00000002 /* RemoveKeySet */, \
  0x00000003 /* AddGroup */, \
  0x00000004 /* UpdateGroup */, \
  0x00000005 /* RemoveGroup */, \
  0x00000006 /* AddAdmin */, \
  0x00000007 /* UpdateAdmin */, \
  0x00000008 /* RemoveAdmin */, \
  0x00000009 /* AddPendingNode */, \
  0x0000000A /* RefreshNode */, \
  0x0000000B /* UpdateNode */, \
  0x0000000C /* RemoveNode */, \
  0x0000000D /* UpdateEndpointForNode */, \
  0x0000000E /* AddGroupIDToEndpointForNode */, \
  0x0000000F /* RemoveGroupIDFromEndpointForNode */, \
  0x00000010 /* AddBindingToEndpointForNode */, \
  0x00000011 /* RemoveBindingFromEndpointForNode */, \
  0x00000012 /* AddACLToNode */, \
  0x00000013 /* RemoveACLFromNode */, \
  chip::kInvalidCommandId /* end of list */, \
  /* Endpoint: 1, Cluster: Joint Fabric Administrator (server) */\
  /*   AcceptedCommandList (index=138) */ \
  0x00000000 /* ICACCSRRequest */, \
  0x00000002 /* AddICAC */, \
  0x00000004 /* OpenJointCommissioningWindow */, \
  0x00000005 /* TransferAnchorRequest */, \
  0x00000007 /* TransferAnchorComplete */, \
  0x00000008 /* AnnounceJointFabricAdministrator */, \
  chip::kInvalidCommandId /* end of list */, \
  /*   GeneratedCommandList (index=145)*/ \
  0x00000001 /* ICACCSRResponse */, \
  0x00000003 /* ICACResponse */, \
  0x00000006 /* TransferAnchorResponse */, \
  chip::kInvalidCommandId /* end of list */, \
}
...
#define GENERATED_ENDPOINT_TYPES                                                                                                   \
    {                                                                                                                              \
        { ZAP_CLUSTER_INDEX(0), 18, 147 },                                                                                         \
        { ZAP_CLUSTER_INDEX(18), 8, 401 },                                                                                         \
    }
...
#define FIXED_DEVICE_TYPES { { 0x00000012, 1 }, { 0x00000016, 3 }, { 0x0000010C, 4 } }
