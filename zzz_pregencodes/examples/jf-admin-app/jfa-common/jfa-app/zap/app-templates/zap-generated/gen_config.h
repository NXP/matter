...
#define MATTER_DM_JOINT_FABRIC_DATASTORE_CLUSTER_SERVER_ENDPOINT_COUNT (1)
#define MATTER_DM_JOINT_FABRIC_ADMINISTRATOR_CLUSTER_SERVER_ENDPOINT_COUNT (1)
...
// Use this macro to check if the server side of the Joint Fabric Datastore cluster is included
#define ZCL_USING_JOINT_FABRIC_DATASTORE_CLUSTER_SERVER
#define MATTER_DM_PLUGIN_JOINT_FABRIC_DATASTORE_SERVER
#define MATTER_DM_PLUGIN_JOINT_FABRIC_DATASTORE

// Use this macro to check if the server side of the Joint Fabric Administrator cluster is included
#define ZCL_USING_JOINT_FABRIC_ADMINISTRATOR_CLUSTER_SERVER
#define MATTER_DM_PLUGIN_JOINT_FABRIC_ADMINISTRATOR_SERVER
#define MATTER_DM_PLUGIN_JOINT_FABRIC_ADMINISTRATOR
...
//  JointFabricAdministrator Cluster Commands
#define JOINT_FABRIC_ADMINISTRATOR_ENABLE_ICACCSR_REQUEST_CMD 1
#define JOINT_FABRIC_ADMINISTRATOR_ENABLE_ADD_ICAC_CMD 1
#define JOINT_FABRIC_ADMINISTRATOR_ENABLE_OPEN_JOINT_COMMISSIONING_WINDOW_CMD 1
#define JOINT_FABRIC_ADMINISTRATOR_ENABLE_TRANSFER_ANCHOR_REQUEST_CMD 1
#define JOINT_FABRIC_ADMINISTRATOR_ENABLE_TRANSFER_ANCHOR_COMPLETE_CMD 1
#define JOINT_FABRIC_ADMINISTRATOR_ENABLE_ANNOUNCE_JOINT_FABRIC_ADMINISTRATOR_CMD 1

//  JointFabricDatastore Cluster Commands
#define JOINT_FABRIC_DATASTORE_ENABLE_ADD_KEY_SET_CMD 1
#define JOINT_FABRIC_DATASTORE_ENABLE_UPDATE_KEY_SET_CMD 1
#define JOINT_FABRIC_DATASTORE_ENABLE_REMOVE_KEY_SET_CMD 1
#define JOINT_FABRIC_DATASTORE_ENABLE_ADD_GROUP_CMD 1
#define JOINT_FABRIC_DATASTORE_ENABLE_UPDATE_GROUP_CMD 1
#define JOINT_FABRIC_DATASTORE_ENABLE_REMOVE_GROUP_CMD 1
#define JOINT_FABRIC_DATASTORE_ENABLE_ADD_ADMIN_CMD 1
#define JOINT_FABRIC_DATASTORE_ENABLE_UPDATE_ADMIN_CMD 1
#define JOINT_FABRIC_DATASTORE_ENABLE_REMOVE_ADMIN_CMD 1
#define JOINT_FABRIC_DATASTORE_ENABLE_ADD_PENDING_NODE_CMD 1
#define JOINT_FABRIC_DATASTORE_ENABLE_REFRESH_NODE_CMD 1
#define JOINT_FABRIC_DATASTORE_ENABLE_UPDATE_NODE_CMD 1
#define JOINT_FABRIC_DATASTORE_ENABLE_REMOVE_NODE_CMD 1
#define JOINT_FABRIC_DATASTORE_ENABLE_UPDATE_ENDPOINT_FOR_NODE_CMD 1
#define JOINT_FABRIC_DATASTORE_ENABLE_ADD_GROUP_ID_TO_ENDPOINT_FOR_NODE_CMD 1
#define JOINT_FABRIC_DATASTORE_ENABLE_REMOVE_GROUP_ID_FROM_ENDPOINT_FOR_NODE_CMD 1
#define JOINT_FABRIC_DATASTORE_ENABLE_ADD_BINDING_TO_ENDPOINT_FOR_NODE_CMD 1
#define JOINT_FABRIC_DATASTORE_ENABLE_REMOVE_BINDING_FROM_ENDPOINT_FOR_NODE_CMD 1
#define JOINT_FABRIC_DATASTORE_ENABLE_ADD_ACL_TO_NODE_CMD 1
#define JOINT_FABRIC_DATASTORE_ENABLE_REMOVE_ACL_FROM_NODE_CMD 1
