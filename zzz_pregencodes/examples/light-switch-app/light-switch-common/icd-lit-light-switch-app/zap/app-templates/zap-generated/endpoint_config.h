...
#define GENERATED_ATTRIBUTES                                                                                                       \
    {                                                                                                                              \
        ...
        { ZAP_SIMPLE_DEFAULT(0x1115), 0x00000006, 4, ZAP_TYPE(BITMAP32), 0 },      /* UserActiveModeTriggerHint */                 \
        ...
        { ZAP_EMPTY_DEFAULT(), 0x00000009, 4, ZAP_TYPE(INT32U),                                                                    \
          ZAP_ATTRIBUTE_MASK(EXTERNAL_STORAGE) }, /* MaximumCheckInBackOff */                                                      \
        { ZAP_EMPTY_DEFAULT(), 0x0000FFFC, 4, ZAP_TYPE(BITMAP32), ZAP_ATTRIBUTE_MASK(EXTERNAL_STORAGE) }, /* FeatureMap */         \
...
#define GENERATED_ENDPOINT_TYPES                                                                                                   \
    {                                                                                                                              \
        { ZAP_CLUSTER_INDEX(0), 20, 251 },                                                                                         \
        { ZAP_CLUSTER_INDEX(20), 8, 22 },                                                                                          \
        { ZAP_CLUSTER_INDEX(28), 3, 17 },                                                                                          \
    }
...
#define FIXED_DEVICE_TYPES { { 0x00000016, 3 }, { 0x00000103, 1 }, { 0x0000000F, 1 } }
