...
#define GENERATED_ENDPOINT_TYPES                                                                                                   \
    {                                                                                                                              \
        { ZAP_CLUSTER_INDEX(0), 20, 175 },                                                                                         \
        { ZAP_CLUSTER_INDEX(20), 8, 14 },                                                                                          \
        { ZAP_CLUSTER_INDEX(28), 3, 15 },                                                                                          \
    }
...
#define FIXED_DEVICE_TYPES { { 0x00000012, 1 }, { 0x00000016, 3 }, { 0x00000103, 1 }, { 0x0000000F, 1 } }
