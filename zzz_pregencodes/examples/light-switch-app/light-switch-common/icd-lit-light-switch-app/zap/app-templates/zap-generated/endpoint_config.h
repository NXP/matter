...
#define GENERATED_ENDPOINT_TYPES                                                                                                   \
    {                                                                                                                              \
        { ZAP_CLUSTER_INDEX(0), 21, 169 },                                                                                         \
        { ZAP_CLUSTER_INDEX(21), 8, 7 },                                                                                           \
        { ZAP_CLUSTER_INDEX(29), 3, 5 },                                                                                           \
    }
...
#define FIXED_DEVICE_TYPES { { 0x00000012, 1 }, { 0x00000016, 5 }, { 0x00000103, 1 }, { 0x0000000F, 1 } }
