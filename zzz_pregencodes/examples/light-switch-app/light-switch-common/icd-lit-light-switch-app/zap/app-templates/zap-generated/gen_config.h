...
#define MATTER_DM_GROUPCAST_CLUSTER_SERVER_ENDPOINT_COUNT (1)
...
// Use this macro to check if the server side of the Groupcast cluster is included
#define ZCL_USING_GROUPCAST_CLUSTER_SERVER
#define MATTER_DM_PLUGIN_GROUPCAST_SERVER
#define MATTER_DM_PLUGIN_GROUPCAST
...
//  Groupcast Cluster Commands
#define GROUPCAST_ENABLE_JOIN_GROUP_CMD 1
#define GROUPCAST_ENABLE_LEAVE_GROUP_CMD 1
#define GROUPCAST_ENABLE_UPDATE_GROUP_KEY_CMD 1
#define GROUPCAST_ENABLE_CONFIGURE_AUXILIARY_ACL_CMD 1
#define GROUPCAST_ENABLE_GROUPCAST_TESTING_CMD 1
...
//  IcdManagement Cluster Commands
#define ICD_MANAGEMENT_ENABLE_REGISTER_CLIENT_CMD 1
#define ICD_MANAGEMENT_ENABLE_UNREGISTER_CLIENT_CMD 1
#define ICD_MANAGEMENT_ENABLE_STAY_ACTIVE_REQUEST_CMD 1
