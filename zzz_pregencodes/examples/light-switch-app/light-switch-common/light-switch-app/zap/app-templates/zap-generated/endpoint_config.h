...
#define GENERATED_ENDPOINT_TYPES                                                                                                   \
    {                                                                                                                              \
        { ZAP_CLUSTER_INDEX(0), 21, 36 },                                                                                          \
        { ZAP_CLUSTER_INDEX(21), 9, 7 },                                                                                           \
        { ZAP_CLUSTER_INDEX(30), 3, 5 },                                                                                           \
    }
...
#define FIXED_DEVICE_TYPES { { 0x00000012, 1 }, { 0x00000016, 5 }, { 0x00000104, 1 }, { 0x0000000F, 1 } }
