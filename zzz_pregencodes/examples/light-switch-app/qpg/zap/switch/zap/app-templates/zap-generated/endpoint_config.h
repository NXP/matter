...
#define GENERATED_DEFAULTS                                                                                                         \
    {                                                                                                                              \
        ...
        21, 'R', 'e', 's', 'e', 't', ' ', 't', 'h', 'e', ' ', 'a', 'p', 'p', 'l', 'i', 'c', 'a', 't', 'i', 'o', 'n',               \
                                                                                                                                   \
    }
...
#define GENERATED_ATTRIBUTES                                                                                                       \
    {                                                                                                                              \
        ...
        { ZAP_SIMPLE_DEFAULT(0x100), 0x00000006, 4, ZAP_TYPE(BITMAP32),                                                            \
...
#define GENERATED_ENDPOINT_TYPES                                                                                                   \
    {                                                                                                                              \
        { ZAP_CLUSTER_INDEX(0), 17, 297 },                                                                                         \
        { ZAP_CLUSTER_INDEX(17), 8, 14 },                                                                                          \
        { ZAP_CLUSTER_INDEX(25), 3, 16 },                                                                                          \
    }
...
#define FIXED_DEVICE_TYPES { { 0x00000012, 1 }, { 0x00000011, 1 }, { 0x00000016, 3 }, { 0x00000105, 1 }, { 0x0000000F, 1 } }
