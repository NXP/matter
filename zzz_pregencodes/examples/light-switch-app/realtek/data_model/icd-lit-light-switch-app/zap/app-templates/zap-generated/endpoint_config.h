...
#define GENERATED_ATTRIBUTE_COUNT 231
#define GENERATED_ATTRIBUTES                                                                                                       \
    {                                                                                                                              \
        ...
        { ZAP_SIMPLE_DEFAULT(9), 0x0000FFFC, 4, ZAP_TYPE(BITMAP32), ZAP_ATTRIBUTE_MASK(READABLE) }, /* FeatureMap */               \
        { ZAP_EMPTY_DEFAULT(), 0x0000FFFD, 2, ZAP_TYPE(INT16U),                                                                    \
          ZAP_ATTRIBUTE_MASK(EXTERNAL_STORAGE) | ZAP_ATTRIBUTE_MASK(READABLE) }, /* ClusterRevision */                             \
                                                                                                                                   \
        ...
        { ZAP_SIMPLE_DEFAULT(0x1115), 0x00000006, 4, ZAP_TYPE(BITMAP32),                                                           \
...
#define GENERATED_ENDPOINT_TYPES                                                                                                   \
    {                                                                                                                              \
        { ZAP_CLUSTER_INDEX(0), 21, 200 },                                                                                         \
        { ZAP_CLUSTER_INDEX(21), 6, 7 },                                                                                           \
        { ZAP_CLUSTER_INDEX(27), 3, 5 },                                                                                           \
    }
...
#define FIXED_DEVICE_TYPES { { 0x00000016, 4 }, { 0x00000103, 3 }, { 0x0000000F, 1 } }
