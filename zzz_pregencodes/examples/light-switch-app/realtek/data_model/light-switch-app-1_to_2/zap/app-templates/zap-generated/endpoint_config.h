...
#define GENERATED_ENDPOINT_TYPES                                                                                                   \
    {                                                                                                                              \
        ...
        { ZAP_CLUSTER_INDEX(32), 6, 15 },  { ZAP_CLUSTER_INDEX(38), 3, 17 },                                                       \
    }
...
#define FIXED_DEVICE_TYPES                                                                                                         \
    { { 0x00000012, 1 }, { 0x00000016, 3 }, { 0x00000103, 3 }, { 0x00000103, 3 }, { 0x00000103, 3 }, { 0x0000000F, 3 } }

// Array of device type offsets
#define FIXED_DEVICE_TYPE_OFFSETS { 0, 2, 3, 4, 5 }

// Array of device type lengths
#define FIXED_DEVICE_TYPE_LENGTHS { 2, 1, 1, 1, 1 }
