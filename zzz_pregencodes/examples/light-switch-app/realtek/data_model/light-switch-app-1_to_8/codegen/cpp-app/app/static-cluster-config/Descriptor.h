...
inline constexpr AttributeId kEndpoint1EnabledAttributes[] = {
    Attributes::AttributeList::Id, Attributes::ClientList::Id, Attributes::ClusterRevision::Id, Attributes::DeviceTypeList::Id,
    Attributes::FeatureMap::Id,    Attributes::PartsList::Id,  Attributes::ServerList::Id,      Attributes::TagList::Id,
};
inline constexpr AttributeId kEndpoint2EnabledAttributes[] = {
    Attributes::ClientList::Id, Attributes::ClusterRevision::Id, Attributes::DeviceTypeList::Id, Attributes::FeatureMap::Id,
    Attributes::PartsList::Id,  Attributes::ServerList::Id,      Attributes::TagList::Id,
};
...
inline constexpr std::array<Clusters::StaticApplicationConfig::ClusterConfiguration<FeatureBitmapType>, 11> kFixedClusterConfig = {
    {
        {
            .endpointNumber    = 0,
