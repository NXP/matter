...
#define GENERATED_ENDPOINT_TYPES                                                                                                   \
    {                                                                                                                              \
        { ZAP_CLUSTER_INDEX(0), 17, 19 },                                                                                          \
        { ZAP_CLUSTER_INDEX(17), 7, 0 },                                                                                           \
        { ZAP_CLUSTER_INDEX(24), 3, 8 },                                                                                           \
    }
...
#define FIXED_DEVICE_TYPES { { 0x00000012, 1 }, { 0x00000016, 4 }, { 0x00000104, 3 }, { 0x0000000F, 3 } }
