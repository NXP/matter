...
#define GENERATED_ATTRIBUTES                                                                                                       \
    {                                                                                                                              \
        ...
        { ZAP_SIMPLE_DEFAULT(0x02), 0x00000008, 1, ZAP_TYPE(ENUM8), ZAP_ATTRIBUTE_MASK(READABLE) }, /* ColorMode */                \
        ...
        { ZAP_SIMPLE_DEFAULT(0x0000), 0x00004000, 2, ZAP_TYPE(INT16U), ZAP_ATTRIBUTE_MASK(READABLE) }, /* EnhancedCurrentHue */    \
        { ZAP_SIMPLE_DEFAULT(0x02), 0x00004001, 1, ZAP_TYPE(ENUM8), ZAP_ATTRIBUTE_MASK(READABLE) },    /* EnhancedColorMode */     \
...
#define GENERATED_ENDPOINT_TYPES                                                                                                   \
    {                                                                                                                              \
        { ZAP_CLUSTER_INDEX(0), 17, 93 },                                                                                          \
        { ZAP_CLUSTER_INDEX(17), 7, 118 },                                                                                         \
    }
...
#define FIXED_DEVICE_TYPES { { 0x00000012, 1 }, { 0x00000011, 0 }, { 0x00000016, 1 }, { 0x0000010D, 4 } }
...
#define FIXED_PARENT_ENDPOINTS { kInvalidEndpointId, 0 }
