...
#define GENERATED_ATTRIBUTES                                                                                                       \
    {                                                                                                                              \
        ...
        { ZAP_SIMPLE_DEFAULT(0xFFFFFFFF), 0x00000003, 4, ZAP_TYPE(INT32U),                                                         \
          ZAP_ATTRIBUTE_MASK(READABLE) | ZAP_ATTRIBUTE_MASK(NULLABLE) }, /* WiredAssessedInputVoltage */                           \
        { ZAP_SIMPLE_DEFAULT(0xFFFF), 0x00000004, 2, ZAP_TYPE(INT16U),                                                             \
          ZAP_ATTRIBUTE_MASK(READABLE) | ZAP_ATTRIBUTE_MASK(NULLABLE) },                         /* WiredAssessedInputFrequency */ \
        { ZAP_SIMPLE_DEFAULT(1), 0x00000005, 1, ZAP_TYPE(ENUM8), ZAP_ATTRIBUTE_MASK(READABLE) }, /* WiredCurrentType */            \
        { ZAP_SIMPLE_DEFAULT(0xFFFFFFFF), 0x00000006, 4, ZAP_TYPE(INT32U),                                                         \
          ZAP_ATTRIBUTE_MASK(READABLE) | ZAP_ATTRIBUTE_MASK(NULLABLE) },                             /* WiredAssessedCurrent */    \
        { ZAP_SIMPLE_DEFAULT(5000), 0x00000007, 4, ZAP_TYPE(INT32U), ZAP_ATTRIBUTE_MASK(READABLE) }, /* WiredNominalVoltage */     \
        { ZAP_SIMPLE_DEFAULT(1000), 0x00000008, 4, ZAP_TYPE(INT32U), ZAP_ATTRIBUTE_MASK(READABLE) }, /* WiredMaximumCurrent */     \
        { ZAP_SIMPLE_DEFAULT(1), 0x00000009, 1, ZAP_TYPE(BOOLEAN), ZAP_ATTRIBUTE_MASK(READABLE) },   /* WiredPresent */            \
...
#define GENERATED_ENDPOINT_TYPES                                                                                                   \
    {                                                                                                                              \
        { ZAP_CLUSTER_INDEX(0), 16, 21 },                                                                                          \
        { ZAP_CLUSTER_INDEX(16), 8, 174 },                                                                                         \
    }
...
#define FIXED_DEVICE_TYPES { { 0x00000012, 1 }, { 0x00000016, 5 }, { 0x0000010D, 4 }, { 0x00000011, 1 } }
