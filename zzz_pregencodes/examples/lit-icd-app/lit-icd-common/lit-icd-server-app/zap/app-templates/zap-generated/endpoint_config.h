...
#define GENERATED_ATTRIBUTES                                                                                                       \
    {                                                                                                                              \
        ...
        { ZAP_SIMPLE_DEFAULT(0x111D), 0x00000006, 4, ZAP_TYPE(BITMAP32), 0 },      /* UserActiveModeTriggerHint */                 \
        ...
        { ZAP_EMPTY_DEFAULT(), 0x00000000, 1, ZAP_TYPE(BOOLEAN), 0 },    /* StateValue */                                          \
        { ZAP_SIMPLE_DEFAULT(0), 0x0000FFFC, 4, ZAP_TYPE(BITMAP32), 0 }, /* FeatureMap */                                          \
        { ZAP_SIMPLE_DEFAULT(1), 0x0000FFFD, 2, ZAP_TYPE(INT16U), 0 },   /* ClusterRevision */                                     \
    }
...
#define GENERATED_ENDPOINT_TYPES                                                                                                   \
    {                                                                                                                              \
        { ZAP_CLUSTER_INDEX(0), 16, 292 },                                                                                         \
        { ZAP_CLUSTER_INDEX(16), 3, 16 },                                                                                          \
    }
...
#define FIXED_DEVICE_TYPES { { 0x00000011, 1 }, { 0x00000016, 3 }, { 0x00000015, 2 } }
