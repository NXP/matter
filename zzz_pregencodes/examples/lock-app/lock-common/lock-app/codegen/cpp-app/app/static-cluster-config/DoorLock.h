...
// from /opt/matter/matter_dev/connectedhomeip/examples/lock-app/lock-common/lock-app.matter
#pragma once
...
inline constexpr AttributeId kEndpoint1EnabledAttributes[] = {
    ...
    Attributes::AliroBLEAdvertisingVersion::Id,
    Attributes::AliroExpeditedTransactionSupportedProtocolVersions::Id,
    Attributes::AliroGroupResolvingKey::Id,
    Attributes::AliroReaderGroupIdentifier::Id,
    Attributes::AliroReaderGroupSubIdentifier::Id,
    Attributes::AliroReaderVerificationKey::Id,
    ...
    Attributes::NumberOfAliroEndpointKeysSupported::Id,
...
inline constexpr CommandId kEndpoint1EnabledCommands[] = {
    Commands::ClearAliroReaderConfig::Id,
    ...
    Commands::SetAliroReaderConfig::Id,
...
inline constexpr std::array<Clusters::StaticApplicationConfig::ClusterConfiguration<FeatureBitmapType>, 1> kFixedClusterConfig = { {
    {
        ...
        .featureMap = BitFlags<FeatureBitmapType> {
            ...
            FeatureBitmapType::kAliroProvisioning, // feature bit 0x2000
            FeatureBitmapType::kAliroBLEUWB// feature bit 0x4000
        },
