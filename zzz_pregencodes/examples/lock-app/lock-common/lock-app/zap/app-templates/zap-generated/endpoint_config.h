...
#define GENERATED_ATTRIBUTES                                                                                                       \
    {                                                                                                                              \
        ...
        { ZAP_LONG_DEFAULTS_INDEX(0), 0x00000002, 61, ZAP_TYPE(CHAR_STRING), 0 },                      /* Description */           \
        { ZAP_SIMPLE_DEFAULT(0), 0x00000005, 1, ZAP_TYPE(ENUM8), 0 },                                  /* WiredCurrentType */      \
        ...
        { ZAP_LONG_DEFAULTS_INDEX(4), 0x00000000, 8, ZAP_TYPE(INT64U), ZAP_ATTRIBUTE_MASK(WRITABLE) }, /* Breadcrumb */            \
        ...
        { ZAP_LONG_DEFAULTS_INDEX(12), 0x00000002, 61, ZAP_TYPE(CHAR_STRING), 0 }, /* Description */                               \
        ...
        { ZAP_SIMPLE_DEFAULT(1), 0x00000019, 1, ZAP_TYPE(INT8U), 0 },              /* BatQuantity */                               \
        { ZAP_EMPTY_DEFAULT(), 0x0000001F, 0, ZAP_TYPE(ARRAY), ZAP_ATTRIBUTE_MASK(EXTERNAL_STORAGE) }, /* EndpointList */          \
        ...
        { ZAP_LONG_DEFAULTS_INDEX(20), 0x00000021, 4, ZAP_TYPE(CHAR_STRING), ZAP_ATTRIBUTE_MASK(WRITABLE) }, /* Language */        \
        ...
        { ZAP_SIMPLE_DEFAULT(0x00), 0x00000029, 1, ZAP_TYPE(BOOLEAN), ZAP_ATTRIBUTE_MASK(WRITABLE) }, /* EnableOneTouchLocking */  \
        ...
        { ZAP_EMPTY_DEFAULT(), 0x00000080, 66, ZAP_TYPE(OCTET_STRING),                                                             \
          ZAP_ATTRIBUTE_MASK(EXTERNAL_STORAGE) | ZAP_ATTRIBUTE_MASK(NULLABLE) }, /* AliroReaderVerificationKey */                  \
        { ZAP_EMPTY_DEFAULT(), 0x00000081, 17, ZAP_TYPE(OCTET_STRING),                                                             \
          ZAP_ATTRIBUTE_MASK(EXTERNAL_STORAGE) | ZAP_ATTRIBUTE_MASK(NULLABLE) }, /* AliroReaderGroupIdentifier */                  \
        { ZAP_EMPTY_DEFAULT(), 0x00000082, 17, ZAP_TYPE(OCTET_STRING),                                                             \
          ZAP_ATTRIBUTE_MASK(EXTERNAL_STORAGE) }, /* AliroReaderGroupSubIdentifier */                                              \
        { ZAP_EMPTY_DEFAULT(), 0x00000083, 0, ZAP_TYPE(ARRAY),                                                                     \
          ZAP_ATTRIBUTE_MASK(EXTERNAL_STORAGE) }, /* AliroExpeditedTransactionSupportedProtocolVersions */                         \
        { ZAP_EMPTY_DEFAULT(), 0x00000084, 17, ZAP_TYPE(OCTET_STRING),                                                             \
          ZAP_ATTRIBUTE_MASK(EXTERNAL_STORAGE) | ZAP_ATTRIBUTE_MASK(NULLABLE) }, /* AliroGroupResolvingKey */                      \
        { ZAP_EMPTY_DEFAULT(), 0x00000085, 0, ZAP_TYPE(ARRAY),                                                                     \
          ZAP_ATTRIBUTE_MASK(EXTERNAL_STORAGE) }, /* AliroSupportedBLEUWBProtocolVersions */                                       \
        { ZAP_EMPTY_DEFAULT(), 0x00000086, 1, ZAP_TYPE(INT8U),                                                                     \
          ZAP_ATTRIBUTE_MASK(EXTERNAL_STORAGE) }, /* AliroBLEAdvertisingVersion */                                                 \
        ...
        { ZAP_SIMPLE_DEFAULT(0x7DB3), 0x0000FFFC, 4, ZAP_TYPE(BITMAP32), 0 }, /* FeatureMap */                                     \
...
#define GENERATED_ENDPOINT_TYPES                                                                                                   \
    {                                                                                                                              \
        { ZAP_CLUSTER_INDEX(0), 19, 177 },                                                                                         \
        { ZAP_CLUSTER_INDEX(19), 4, 185 },                                                                                         \
    }
...
#define FIXED_DEVICE_TYPES { { 0x00000011, 1 }, { 0x00000016, 3 }, { 0x0000000A, 3 }, { 0x00000011, 1 } }
