...
#define GENERATED_ATTRIBUTES                                                                                                       \
    {                                                                                                                              \
        ...
        { ZAP_LONG_DEFAULTS_INDEX(0), 0x00000002, 61, ZAP_TYPE(CHAR_STRING), ZAP_ATTRIBUTE_MASK(READABLE) }, /* Description */     \
        { ZAP_SIMPLE_DEFAULT(0), 0x00000005, 1, ZAP_TYPE(ENUM8), ZAP_ATTRIBUTE_MASK(READABLE) }, /* WiredCurrentType */            \
        ...
        { ZAP_LONG_DEFAULTS_INDEX(4), 0x00000002, 61, ZAP_TYPE(CHAR_STRING), ZAP_ATTRIBUTE_MASK(READABLE) }, /* Description */     \
        ...
        { ZAP_SIMPLE_DEFAULT(1), 0x00000019, 1, ZAP_TYPE(INT8U), ZAP_ATTRIBUTE_MASK(READABLE) }, /* BatQuantity */                 \
        { ZAP_EMPTY_DEFAULT(), 0x0000001F, 0, ZAP_TYPE(ARRAY),                                                                     \
          ZAP_ATTRIBUTE_MASK(EXTERNAL_STORAGE) | ZAP_ATTRIBUTE_MASK(READABLE) },                       /* EndpointList */          \
        { ZAP_SIMPLE_DEFAULT(0x0A), 0x0000FFFC, 4, ZAP_TYPE(BITMAP32), ZAP_ATTRIBUTE_MASK(READABLE) }, /* FeatureMap */            \
        { ZAP_EMPTY_DEFAULT(), 0x0000FFFD, 2, ZAP_TYPE(INT16U),                                                                    \
          ZAP_ATTRIBUTE_MASK(EXTERNAL_STORAGE) | ZAP_ATTRIBUTE_MASK(READABLE) }, /* ClusterRevision */                             \
                                                                                                                                   \
        /* Endpoint: 1, Cluster: Door Lock (server) */                                                                             \
        { ZAP_SIMPLE_DEFAULT(1), 0x00000000, 1, ZAP_TYPE(ENUM8),                                                                   \
          ZAP_ATTRIBUTE_MASK(TOKENIZE) | ZAP_ATTRIBUTE_MASK(READABLE) | ZAP_ATTRIBUTE_MASK(NULLABLE) }, /* LockState */            \
        ...
        { ZAP_SIMPLE_DEFAULT(10), 0x00000011, 2, ZAP_TYPE(INT16U),                                                                 \
          ZAP_ATTRIBUTE_MASK(READABLE) }, /* NumberOfTotalUsersSupported */                                                        \
        { ZAP_SIMPLE_DEFAULT(10), 0x00000012, 2, ZAP_TYPE(INT16U), ZAP_ATTRIBUTE_MASK(READABLE) }, /* NumberOfPINUsersSupported */ \
        { ZAP_SIMPLE_DEFAULT(10), 0x00000013, 2, ZAP_TYPE(INT16U),                                                                 \
          ZAP_ATTRIBUTE_MASK(READABLE) }, /* NumberOfRFIDUsersSupported */                                                         \
        { ZAP_SIMPLE_DEFAULT(10), 0x00000014, 1, ZAP_TYPE(INT8U),                                                                  \
          ZAP_ATTRIBUTE_MASK(READABLE) }, /* NumberOfWeekDaySchedulesSupportedPerUser */                                           \
        { ZAP_SIMPLE_DEFAULT(10), 0x00000015, 1, ZAP_TYPE(INT8U),                                                                  \
          ZAP_ATTRIBUTE_MASK(READABLE) }, /* NumberOfYearDaySchedulesSupportedPerUser */                                           \
        { ZAP_SIMPLE_DEFAULT(10), 0x00000016, 1, ZAP_TYPE(INT8U),                                                                  \
          ZAP_ATTRIBUTE_MASK(READABLE) }, /* NumberOfHolidaySchedulesSupported */                                                  \
        { ZAP_SIMPLE_DEFAULT(8), 0x00000017, 1, ZAP_TYPE(INT8U), ZAP_ATTRIBUTE_MASK(READABLE) },   /* MaxPINCodeLength */          \
        { ZAP_SIMPLE_DEFAULT(6), 0x00000018, 1, ZAP_TYPE(INT8U), ZAP_ATTRIBUTE_MASK(READABLE) },   /* MinPINCodeLength */          \
        { ZAP_SIMPLE_DEFAULT(20), 0x00000019, 1, ZAP_TYPE(INT8U), ZAP_ATTRIBUTE_MASK(READABLE) },  /* MaxRFIDCodeLength */         \
        { ZAP_SIMPLE_DEFAULT(10), 0x0000001A, 1, ZAP_TYPE(INT8U), ZAP_ATTRIBUTE_MASK(READABLE) },  /* MinRFIDCodeLength */         \
        { ZAP_SIMPLE_DEFAULT(1), 0x0000001B, 1, ZAP_TYPE(BITMAP8), ZAP_ATTRIBUTE_MASK(READABLE) }, /* CredentialRulesSupport */    \
        { ZAP_SIMPLE_DEFAULT(5), 0x0000001C, 1, ZAP_TYPE(INT8U),                                                                   \
          ZAP_ATTRIBUTE_MASK(READABLE) }, /* NumberOfCredentialsSupportedPerUser */                                                \
        { ZAP_LONG_DEFAULTS_INDEX(12), 0x00000021, 4, ZAP_TYPE(CHAR_STRING),                                                       \
        ...
        { ZAP_MIN_MAX_DEFAULTS_INDEX(2), 0x0000002C, 1, ZAP_TYPE(BITMAP8),                                                         \
        ...
        { ZAP_EMPTY_DEFAULT(), 0x00000080, 66, ZAP_TYPE(OCTET_STRING),                                                             \
          ZAP_ATTRIBUTE_MASK(EXTERNAL_STORAGE) | ZAP_ATTRIBUTE_MASK(READABLE) |                                                    \
              ZAP_ATTRIBUTE_MASK(NULLABLE) }, /* AliroReaderVerificationKey */                                                     \
        { ZAP_EMPTY_DEFAULT(), 0x00000081, 17, ZAP_TYPE(OCTET_STRING),                                                             \
          ZAP_ATTRIBUTE_MASK(EXTERNAL_STORAGE) | ZAP_ATTRIBUTE_MASK(READABLE) |                                                    \
              ZAP_ATTRIBUTE_MASK(NULLABLE) }, /* AliroReaderGroupIdentifier */                                                     \
        { ZAP_EMPTY_DEFAULT(), 0x00000082, 17, ZAP_TYPE(OCTET_STRING),                                                             \
          ZAP_ATTRIBUTE_MASK(EXTERNAL_STORAGE) | ZAP_ATTRIBUTE_MASK(READABLE) }, /* AliroReaderGroupSubIdentifier */               \
        { ZAP_EMPTY_DEFAULT(), 0x00000083, 0, ZAP_TYPE(ARRAY),                                                                     \
          ZAP_ATTRIBUTE_MASK(EXTERNAL_STORAGE) |                                                                                   \
              ZAP_ATTRIBUTE_MASK(READABLE) }, /* AliroExpeditedTransactionSupportedProtocolVersions */                             \
        { ZAP_EMPTY_DEFAULT(), 0x00000084, 17, ZAP_TYPE(OCTET_STRING),                                                             \
          ZAP_ATTRIBUTE_MASK(EXTERNAL_STORAGE) | ZAP_ATTRIBUTE_MASK(READABLE) |                                                    \
              ZAP_ATTRIBUTE_MASK(NULLABLE) }, /* AliroGroupResolvingKey */                                                         \
        { ZAP_EMPTY_DEFAULT(), 0x00000085, 0, ZAP_TYPE(ARRAY),                                                                     \
          ZAP_ATTRIBUTE_MASK(EXTERNAL_STORAGE) | ZAP_ATTRIBUTE_MASK(READABLE) }, /* AliroSupportedBLEUWBProtocolVersions */        \
        { ZAP_EMPTY_DEFAULT(), 0x00000086, 1, ZAP_TYPE(INT8U),                                                                     \
          ZAP_ATTRIBUTE_MASK(EXTERNAL_STORAGE) | ZAP_ATTRIBUTE_MASK(READABLE) }, /* AliroBLEAdvertisingVersion */                  \
        { ZAP_EMPTY_DEFAULT(), 0x00000087, 2, ZAP_TYPE(INT16U),                                                                    \
          ZAP_ATTRIBUTE_MASK(EXTERNAL_STORAGE) | ZAP_ATTRIBUTE_MASK(READABLE) }, /* NumberOfAliroCredentialIssuerKeysSupported */  \
...
// clang-format off
#define GENERATED_EVENT_COUNT 21
...
#define GENERATED_COMMANDS { \
  ...
  0x00000027 /* UnboltDoor */, \
  0x00000028 /* SetAliroReaderConfig */, \
  0x00000029 /* ClearAliroReaderConfig */, \
  chip::kInvalidCommandId /* end of list */, \
...
#define GENERATED_ENDPOINT_TYPES                                                                                                   \
    {                                                                                                                              \
        { ZAP_CLUSTER_INDEX(0), 19, 97 },                                                                                          \
        { ZAP_CLUSTER_INDEX(19), 4, 178 },                                                                                         \
    }
...
#define FIXED_DEVICE_TYPES { { 0x00000011, 1 }, { 0x00000016, 5 }, { 0x0000000A, 4 }, { 0x00000011, 1 } }

// Array of device type offsets
#define FIXED_DEVICE_TYPE_OFFSETS { 0, 2 }

// Array of device type lengths
#define FIXED_DEVICE_TYPE_LENGTHS { 2, 2 }
