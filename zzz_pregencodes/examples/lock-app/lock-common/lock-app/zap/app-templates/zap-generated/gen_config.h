...
#define MATTER_DM_POWER_SOURCE_CLUSTER_SERVER_ENDPOINT_COUNT (2)
...
#define DOOR_LOCK_ENABLE_GET_HOLIDAY_SCHEDULE_CMD 1
#define DOOR_LOCK_ENABLE_CLEAR_HOLIDAY_SCHEDULE_CMD 1
#define DOOR_LOCK_ENABLE_SET_USER_CMD 1
#define DOOR_LOCK_ENABLE_GET_USER_CMD 1
#define DOOR_LOCK_ENABLE_CLEAR_USER_CMD 1
#define DOOR_LOCK_ENABLE_SET_CREDENTIAL_CMD 1
#define DOOR_LOCK_ENABLE_GET_CREDENTIAL_STATUS_CMD 1
#define DOOR_LOCK_ENABLE_CLEAR_CREDENTIAL_CMD 1
#define DOOR_LOCK_ENABLE_UNBOLT_DOOR_CMD 1
#define DOOR_LOCK_ENABLE_SET_ALIRO_READER_CONFIG_CMD 1
#define DOOR_LOCK_ENABLE_CLEAR_ALIRO_READER_CONFIG_CMD 1
