...
#define GENERATED_ATTRIBUTES                                                                                                       \
    {                                                                                                                              \
        ...
        { ZAP_SIMPLE_DEFAULT(0x0000), 0x00000000, 2, ZAP_TYPE(INT16U), ZAP_ATTRIBUTE_MASK(WRITABLE) }, /* IdentifyTime */          \
            ...
            { ZAP_SIMPLE_DEFAULT(0x0), 0x0000FFFC, 4, ZAP_TYPE(BITMAP32), 0 }, /* FeatureMap */                                    \
            { ZAP_SIMPLE_DEFAULT(1), 0x0000FFFD, 2, ZAP_TYPE(INT16U), 0 },     /* ClusterRevision */                               \
                                                                                                                                   \
            ...
            { ZAP_LONG_DEFAULTS_INDEX(14), 0x00000002, 61, ZAP_TYPE(CHAR_STRING), 0 }, /* Description */                           \
            ...
            { ZAP_LONG_DEFAULTS_INDEX(22), 0x00000021, 4, ZAP_TYPE(CHAR_STRING), ZAP_ATTRIBUTE_MASK(WRITABLE) }, /* Language */    \
            ...
            { ZAP_SIMPLE_DEFAULT(0x11A3), 0x0000FFFC, 4, ZAP_TYPE(BITMAP32), 0 }, /* FeatureMap */                                 \
...
#define GENERATED_ENDPOINT_TYPES                                                                                                   \
    {                                                                                                                              \
        { ZAP_CLUSTER_INDEX(0), 16, 197 }, { ZAP_CLUSTER_INDEX(16), 6, 194 },                                                      \
    }
...
#define FIXED_DEVICE_TYPES                                                                                                         \
    {                                                                                                                              \
        { 0x00000012, 1 }, { 0x00000016, 1 }, { 0x0000000A, 1 },                                                                   \
        {                                                                                                                          \
            0x00000011, 1                                                                                                          \
        }                                                                                                                          \
    }
