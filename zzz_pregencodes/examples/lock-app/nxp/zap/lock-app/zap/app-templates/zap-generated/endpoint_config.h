...
#define GENERATED_ATTRIBUTES                                                                                                       \
    {                                                                                                                              \
        ...
        { ZAP_LONG_DEFAULTS_INDEX(0), 0x00000021, 4, ZAP_TYPE(CHAR_STRING),                                                        \
...
#define GENERATED_ENDPOINT_TYPES                                                                                                   \
    {                                                                                                                              \
        { ZAP_CLUSTER_INDEX(0), 16, 61 },                                                                                          \
        { ZAP_CLUSTER_INDEX(16), 3, 49 },                                                                                          \
    }

// Largest attribute size is needed for various buffers
#define ATTRIBUTE_LARGEST (67)
...
#define FIXED_DEVICE_TYPES { { 0x00000016, 3 }, { 0x0000000A, 1 } }
