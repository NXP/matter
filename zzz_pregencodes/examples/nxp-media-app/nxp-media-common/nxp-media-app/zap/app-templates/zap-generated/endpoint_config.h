...
#define GENERATED_ENDPOINT_TYPES                                                                                                   \
    {                                                                                                                              \
        { ZAP_CLUSTER_INDEX(0), 26, 180 },                                                                                         \
        { ZAP_CLUSTER_INDEX(26), 14, 164 },                                                                                        \
...
#define FIXED_DEVICE_TYPES { { 0x00000016, 1 }, { 0x00000023, 1 }, { 0x00000022, 1 }, { 0x00000024, 1 } }
