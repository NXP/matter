...
#define MATTER_DM_WIFI_NETWORK_MANAGEMENT_CLUSTER_SERVER_ENDPOINT_COUNT (1)
#define MATTER_DM_THREAD_BORDER_ROUTER_MANAGEMENT_CLUSTER_SERVER_ENDPOINT_COUNT (1)
#define MATTER_DM_THREAD_NETWORK_DIRECTORY_CLUSTER_SERVER_ENDPOINT_COUNT (1)
...
// Use this macro to check if the server side of the Wi-Fi Network Management cluster is included
#define ZCL_USING_WIFI_NETWORK_MANAGEMENT_CLUSTER_SERVER
#define MATTER_DM_PLUGIN_WI_FI_NETWORK_MANAGEMENT_SERVER
#define MATTER_DM_PLUGIN_WI_FI_NETWORK_MANAGEMENT
...
// Use this macro to check if the server side of the Thread Network Directory cluster is included
#define ZCL_USING_THREAD_NETWORK_DIRECTORY_CLUSTER_SERVER
#define MATTER_DM_PLUGIN_THREAD_NETWORK_DIRECTORY_SERVER
#define MATTER_DM_PLUGIN_THREAD_NETWORK_DIRECTORY

/**** Cluster Commands Flag ****/
//  AccessControl Cluster Commands
#define ACCESS_CONTROL_ENABLE_REVIEW_FABRIC_RESTRICTIONS_CMD 1
...
//  ThreadNetworkDirectory Cluster Commands
#define THREAD_NETWORK_DIRECTORY_ENABLE_ADD_NETWORK_CMD 1
#define THREAD_NETWORK_DIRECTORY_ENABLE_REMOVE_NETWORK_CMD 1
#define THREAD_NETWORK_DIRECTORY_ENABLE_GET_OPERATIONAL_DATASET_CMD 1

//  WiFiNetworkDiagnostics Cluster Commands
#define WI_FI_NETWORK_DIAGNOSTICS_ENABLE_RESET_COUNTS_CMD 1

//  WiFiNetworkManagement Cluster Commands
#define WI_FI_NETWORK_MANAGEMENT_ENABLE_NETWORK_PASSPHRASE_REQUEST_CMD 1
