...
#define GENERATED_MIN_MAX_DEFAULTS                                                                                                 \
    {                                                                                                                              \
        ...
        { (uint16_t) 0x0, (uint16_t) -0x6AB3, (uint16_t) 0x7FFF }, /* MinHeatSetpointLimit */                                      \
        { (uint16_t) 0x0, (uint16_t) -0x6AB3, (uint16_t) 0x7FFF }, /* MaxHeatSetpointLimit */                                      \
        { (uint16_t) 0x4, (uint16_t) -0x6AB3, (uint16_t) 0x7FFF }, /* MinCoolSetpointLimit */                                      \
        { (uint16_t) 0x0, (uint16_t) -0x6AB3, (uint16_t) 0x7FFF }, /* MaxCoolSetpointLimit */                                      \
        { (uint16_t) 0x0, (uint16_t) 0x0, (uint16_t) 0x7F },       /* MinSetpointDeadBand */                                       \
        ...
        { (uint16_t) 0x2, (uint16_t) 0x0, (uint16_t) 0x1 }, /* TemperatureDisplayMode */                                           \
        { (uint16_t) 0x1, (uint16_t) 0x0, (uint16_t) 0x5 }  /* KeypadLockout */                                                    \
    }

// This is an array of EmberAfAttributeMetadata structures.
#define GENERATED_ATTRIBUTE_COUNT 239
#define GENERATED_ATTRIBUTES                                                                                                       \
    {                                                                                                                              \
        ...
        { ZAP_EMPTY_DEFAULT(), 0x00000053, 1, ZAP_TYPE(INT8U),                                                                     \
          ZAP_ATTRIBUTE_MASK(EXTERNAL_STORAGE) }, /* MaxThermostatSuggestions */                                                   \
        { ZAP_EMPTY_DEFAULT(), 0x00000054, 0, ZAP_TYPE(ARRAY), ZAP_ATTRIBUTE_MASK(EXTERNAL_STORAGE) }, /* ThermostatSuggestions */ \
        { ZAP_EMPTY_DEFAULT(), 0x00000055, 0, ZAP_TYPE(STRUCT),                                                                    \
          ZAP_ATTRIBUTE_MASK(EXTERNAL_STORAGE) | ZAP_ATTRIBUTE_MASK(NULLABLE) }, /* CurrentThermostatSuggestion */                 \
        { ZAP_EMPTY_DEFAULT(), 0x00000056, 2, ZAP_TYPE(BITMAP16),                                                                  \
          ZAP_ATTRIBUTE_MASK(EXTERNAL_STORAGE) | ZAP_ATTRIBUTE_MASK(NULLABLE) }, /* ThermostatSuggestionNotFollowingReason */      \
        { ZAP_SIMPLE_DEFAULT(700), 0x0000FFFC, 4, ZAP_TYPE(BITMAP32), 0 },       /* FeatureMap */                                  \
        { ZAP_SIMPLE_DEFAULT(3000), 0x0000FFFD, 2, ZAP_TYPE(INT16U), 0 },        /* ClusterRevision */                             \
                                                                                                                                   \
        /* Endpoint: 1, Cluster: Thermostat User Interface Configuration (server) */                                               \
...
#define FIXED_DEVICE_TYPES { { 0x00000012, 1 }, { 0x00000016, 3 }, { 0x00000301, 4 } }
