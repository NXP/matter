...
inline constexpr AttributeId kEndpoint1EnabledAttributes[] = {
    ...
    Attributes::ControlSequenceOfOperation::Id, Attributes::FeatureMap::Id,           Attributes::GeneratedCommandList::Id,
    Attributes::LocalTemperature::Id,           Attributes::MaxCoolSetpointLimit::Id, Attributes::MaxHeatSetpointLimit::Id,
    Attributes::MinCoolSetpointLimit::Id,       Attributes::MinHeatSetpointLimit::Id, Attributes::OccupiedCoolingSetpoint::Id,
    Attributes::OccupiedHeatingSetpoint::Id,    Attributes::SystemMode::Id,
};
