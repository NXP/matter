...
#define GENERATED_ENDPOINT_TYPES                                                                                                   \
    {                                                                                                                              \
        { ZAP_CLUSTER_INDEX(0), 12, 77 },                                                                                          \
        { ZAP_CLUSTER_INDEX(12), 4, 29 },                                                                                          \
...
#define FIXED_ENDPOINT_ARRAY { 0x0000, 0x0001, 0xFFFE }

// Array of profile ids
#define FIXED_PROFILE_IDS { 0x0103, 0x0103, 0x0103 }

// Array of device types
#define FIXED_DEVICE_TYPES { { 0x00000012, 1 }, { 0x00000016, 3 }, { 0x00000103, 1 }, { 0x00000019, 1 } }
