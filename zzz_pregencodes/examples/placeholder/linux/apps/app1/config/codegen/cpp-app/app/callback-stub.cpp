...
void __attribute__((weak)) emberAfBridgedDeviceBasicInformationClusterShutdownCallback(EndpointId endpoint)
{
    // To prevent warning
    (void) endpoint;
}
...
void __attribute__((weak)) emberAfThreadBorderRouterManagementClusterShutdownCallback(EndpointId endpoint)
{
    // To prevent warning
    (void) endpoint;
}
