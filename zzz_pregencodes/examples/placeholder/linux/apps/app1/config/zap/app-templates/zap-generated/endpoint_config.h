...
#define GENERATED_ATTRIBUTE_COUNT 584
#define GENERATED_ATTRIBUTES                                                                                                       \
    {                                                                                                                              \
        ...
        { ZAP_MIN_MAX_DEFAULTS_INDEX(40), 0x00000010, 2, ZAP_TYPE(INT16U),                                                         \
          ZAP_ATTRIBUTE_MASK(MIN_MAX) | ZAP_ATTRIBUTE_MASK(EXTERNAL_STORAGE) | ZAP_ATTRIBUTE_MASK(WRITABLE) |                      \
              ZAP_ATTRIBUTE_MASK(READABLE) }, /* PIROccupiedToUnoccupiedDelay */                                                   \
        { ZAP_MIN_MAX_DEFAULTS_INDEX(41), 0x00000011, 2, ZAP_TYPE(INT16U),                                                         \
          ZAP_ATTRIBUTE_MASK(MIN_MAX) | ZAP_ATTRIBUTE_MASK(WRITABLE) |                                                             \
              ZAP_ATTRIBUTE_MASK(READABLE) }, /* PIRUnoccupiedToOccupiedDelay */                                                   \
        { ZAP_MIN_MAX_DEFAULTS_INDEX(42), 0x00000012, 1, ZAP_TYPE(INT8U),                                                          \
          ZAP_ATTRIBUTE_MASK(MIN_MAX) | ZAP_ATTRIBUTE_MASK(WRITABLE) |                                                             \
              ZAP_ATTRIBUTE_MASK(READABLE) }, /* PIRUnoccupiedToOccupiedThreshold */                                               \
        { ZAP_MIN_MAX_DEFAULTS_INDEX(43), 0x00000020, 2, ZAP_TYPE(INT16U),                                                         \
          ZAP_ATTRIBUTE_MASK(MIN_MAX) | ZAP_ATTRIBUTE_MASK(EXTERNAL_STORAGE) | ZAP_ATTRIBUTE_MASK(WRITABLE) |                      \
              ZAP_ATTRIBUTE_MASK(READABLE) }, /* UltrasonicOccupiedToUnoccupiedDelay */                                            \
        { ZAP_MIN_MAX_DEFAULTS_INDEX(44), 0x00000021, 2, ZAP_TYPE(INT16U),                                                         \
          ZAP_ATTRIBUTE_MASK(MIN_MAX) | ZAP_ATTRIBUTE_MASK(WRITABLE) |                                                             \
              ZAP_ATTRIBUTE_MASK(READABLE) }, /* UltrasonicUnoccupiedToOccupiedDelay */                                            \
        { ZAP_MIN_MAX_DEFAULTS_INDEX(45), 0x00000022, 1, ZAP_TYPE(INT8U),                                                          \
          ZAP_ATTRIBUTE_MASK(MIN_MAX) | ZAP_ATTRIBUTE_MASK(WRITABLE) |                                                             \
              ZAP_ATTRIBUTE_MASK(READABLE) }, /* UltrasonicUnoccupiedToOccupiedThreshold */                                        \
        { ZAP_MIN_MAX_DEFAULTS_INDEX(46), 0x00000030, 2, ZAP_TYPE(INT16U),                                                         \
          ZAP_ATTRIBUTE_MASK(MIN_MAX) | ZAP_ATTRIBUTE_MASK(EXTERNAL_STORAGE) | ZAP_ATTRIBUTE_MASK(WRITABLE) |                      \
              ZAP_ATTRIBUTE_MASK(READABLE) }, /* PhysicalContactOccupiedToUnoccupiedDelay */                                       \
        { ZAP_MIN_MAX_DEFAULTS_INDEX(47), 0x00000031, 2, ZAP_TYPE(INT16U),                                                         \
          ZAP_ATTRIBUTE_MASK(MIN_MAX) | ZAP_ATTRIBUTE_MASK(WRITABLE) |                                                             \
              ZAP_ATTRIBUTE_MASK(READABLE) }, /* PhysicalContactUnoccupiedToOccupiedDelay */                                       \
        { ZAP_MIN_MAX_DEFAULTS_INDEX(48), 0x00000032, 1, ZAP_TYPE(INT8U),                                                          \
          ZAP_ATTRIBUTE_MASK(MIN_MAX) | ZAP_ATTRIBUTE_MASK(WRITABLE) |                                                             \
...
#define GENERATED_CLUSTER_COUNT 74
// clang-format off
#define GENERATED_CLUSTERS { \
  ...
  { \
      ...
      .attributes = ZAP_ATTRIBUTE_INDEX(576), \
      .attributeCount = 8, \
      .clusterSize = 2, \
      .mask = ZAP_CLUSTER_MASK(SERVER), \
      .functions = NULL, \
...
#define GENERATED_ENDPOINT_TYPES                                                                                                   \
    {                                                                                                                              \
        { ZAP_CLUSTER_INDEX(0), 60, 1689 },                                                                                        \
        { ZAP_CLUSTER_INDEX(60), 14, 425 },                                                                                        \
    }
...
#define ATTRIBUTE_MAX_SIZE (2114)
