...
#define MATTER_DM_BASIC_INFORMATION_CLUSTER_SERVER_ENDPOINT_COUNT (2)
...
#define MATTER_DM_THREAD_BORDER_ROUTER_MANAGEMENT_CLUSTER_SERVER_ENDPOINT_COUNT (1)
...
#define MATTER_DM_CHANNEL_CLUSTER_SERVER_ENDPOINT_COUNT (1)
#define MATTER_DM_TARGET_NAVIGATOR_CLUSTER_SERVER_ENDPOINT_COUNT (1)
#define MATTER_DM_MEDIA_PLAYBACK_CLUSTER_SERVER_ENDPOINT_COUNT (1)
#define MATTER_DM_MEDIA_INPUT_CLUSTER_SERVER_ENDPOINT_COUNT (1)
#define MATTER_DM_LOW_POWER_CLUSTER_SERVER_ENDPOINT_COUNT (0)
#define MATTER_DM_KEYPAD_INPUT_CLUSTER_SERVER_ENDPOINT_COUNT (1)
#define MATTER_DM_CONTENT_LAUNCHER_CLUSTER_SERVER_ENDPOINT_COUNT (1)
#define MATTER_DM_AUDIO_OUTPUT_CLUSTER_SERVER_ENDPOINT_COUNT (1)
#define MATTER_DM_APPLICATION_LAUNCHER_CLUSTER_SERVER_ENDPOINT_COUNT (1)
...
// Use this macro to check if the server side of the Thread Border Router Management cluster is included
#define ZCL_USING_THREAD_BORDER_ROUTER_MANAGEMENT_CLUSTER_SERVER
#define MATTER_DM_PLUGIN_THREAD_BORDER_ROUTER_MANAGEMENT_SERVER
#define MATTER_DM_PLUGIN_THREAD_BORDER_ROUTER_MANAGEMENT
...
#define ACCOUNT_LOGIN_ENABLE_GET_SETUP_PIN_CMD 1
#define ACCOUNT_LOGIN_ENABLE_LOGIN_CMD 1
#define ACCOUNT_LOGIN_ENABLE_LOGOUT_CMD 1
...
#define AUDIO_OUTPUT_ENABLE_SELECT_OUTPUT_CMD 1
#define AUDIO_OUTPUT_ENABLE_RENAME_OUTPUT_CMD 1

//  Channel Cluster Commands
#define CHANNEL_ENABLE_CHANGE_CHANNEL_CMD 1
#define CHANNEL_ENABLE_CHANGE_CHANNEL_BY_NUMBER_CMD 1
#define CHANNEL_ENABLE_SKIP_CHANNEL_CMD 1
...
#define CONTENT_LAUNCHER_ENABLE_LAUNCH_CONTENT_CMD 1
#define CONTENT_LAUNCHER_ENABLE_LAUNCH_URL_CMD 1

//  DoorLock Cluster Commands
#define DOOR_LOCK_ENABLE_LOCK_DOOR_CMD 1
#define DOOR_LOCK_ENABLE_UNLOCK_DOOR_CMD 1
#define DOOR_LOCK_ENABLE_UNLOCK_WITH_TIMEOUT_CMD 1
#define DOOR_LOCK_ENABLE_SET_WEEK_DAY_SCHEDULE_CMD 1
#define DOOR_LOCK_ENABLE_CLEAR_WEEK_DAY_SCHEDULE_CMD 1
#define DOOR_LOCK_ENABLE_SET_YEAR_DAY_SCHEDULE_CMD 1
#define DOOR_LOCK_ENABLE_CLEAR_YEAR_DAY_SCHEDULE_CMD 1
#define DOOR_LOCK_ENABLE_SET_HOLIDAY_SCHEDULE_CMD 1
#define DOOR_LOCK_ENABLE_CLEAR_HOLIDAY_SCHEDULE_CMD 1
#define DOOR_LOCK_ENABLE_SET_USER_CMD 1
#define DOOR_LOCK_ENABLE_CLEAR_CREDENTIAL_CMD 1
...
#define MEDIA_INPUT_ENABLE_SELECT_INPUT_CMD 1
#define MEDIA_INPUT_ENABLE_SHOW_INPUT_STATUS_CMD 1
#define MEDIA_INPUT_ENABLE_HIDE_INPUT_STATUS_CMD 1
#define MEDIA_INPUT_ENABLE_RENAME_INPUT_CMD 1

//  MediaPlayback Cluster Commands
#define MEDIA_PLAYBACK_ENABLE_PLAY_CMD 1
#define MEDIA_PLAYBACK_ENABLE_PAUSE_CMD 1
#define MEDIA_PLAYBACK_ENABLE_STOP_CMD 1
#define MEDIA_PLAYBACK_ENABLE_START_OVER_CMD 1
#define MEDIA_PLAYBACK_ENABLE_PREVIOUS_CMD 1
#define MEDIA_PLAYBACK_ENABLE_NEXT_CMD 1
#define MEDIA_PLAYBACK_ENABLE_REWIND_CMD 1
#define MEDIA_PLAYBACK_ENABLE_FAST_FORWARD_CMD 1
#define MEDIA_PLAYBACK_ENABLE_SKIP_FORWARD_CMD 1
#define MEDIA_PLAYBACK_ENABLE_SKIP_BACKWARD_CMD 1
#define MEDIA_PLAYBACK_ENABLE_SEEK_CMD 1
...
//  ThreadBorderRouterManagement Cluster Commands
#define THREAD_BORDER_ROUTER_MANAGEMENT_ENABLE_GET_ACTIVE_DATASET_REQUEST_CMD 1
#define THREAD_BORDER_ROUTER_MANAGEMENT_ENABLE_GET_PENDING_DATASET_REQUEST_CMD 1
#define THREAD_BORDER_ROUTER_MANAGEMENT_ENABLE_SET_ACTIVE_DATASET_REQUEST_CMD 1
#define THREAD_BORDER_ROUTER_MANAGEMENT_ENABLE_SET_PENDING_DATASET_REQUEST_CMD 1
