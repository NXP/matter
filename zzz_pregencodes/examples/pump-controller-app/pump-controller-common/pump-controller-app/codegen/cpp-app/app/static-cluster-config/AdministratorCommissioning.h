...
// from /opt/matter/matter_dev/connectedhomeip/examples/pump-controller-app/pump-controller-common/pump-controller-app.matter
#pragma once
...
inline constexpr AttributeId kEndpoint0EnabledAttributes[] = {
    Attributes::AcceptedCommandList::Id,  Attributes::AdminFabricIndex::Id, Attributes::AdminVendorId::Id,
    Attributes::AttributeList::Id,        Attributes::ClusterRevision::Id,  Attributes::FeatureMap::Id,
    Attributes::GeneratedCommandList::Id, Attributes::WindowStatus::Id,
};

inline constexpr CommandId kEndpoint0EnabledCommands[] = {
    Commands::OpenBasicCommissioningWindow::Id,
...
inline constexpr std::array<Clusters::StaticApplicationConfig::ClusterConfiguration<FeatureBitmapType>, 1> kFixedClusterConfig = { {
    {
        ...
        .featureMap =
            BitFlags<FeatureBitmapType>{
                FeatureBitmapType::kBasic // feature bit 0x1
            },
