...
#define MATTER_DM_SERVICE_AREA_CLUSTER_SERVER_ENDPOINT_COUNT (1)
...
// Use this macro to check if the server side of the Service Area cluster is included
#define ZCL_USING_SERVICE_AREA_CLUSTER_SERVER
#define MATTER_DM_PLUGIN_SERVICE_AREA_SERVER
#define MATTER_DM_PLUGIN_SERVICE_AREA
...
//  ServiceArea Cluster Commands
#define SERVICE_AREA_ENABLE_SELECT_AREAS_CMD 1
#define SERVICE_AREA_ENABLE_SKIP_AREA_CMD 1
