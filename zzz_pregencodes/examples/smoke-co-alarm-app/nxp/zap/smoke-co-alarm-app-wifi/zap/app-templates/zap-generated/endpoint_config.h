...
#define GENERATED_MIN_MAX_DEFAULTS                                                                                                 \
    {                                                                                                                              \
        ...
        {                                                                                                                          \
            (uint16_t) 0x1, (uint16_t) 0x0, (uint16_t) 0x2                                                                         \
...
#define GENERATED_ATTRIBUTES                                                                                                       \
    {                                                                                                                              \
        ...
        { ZAP_SIMPLE_DEFAULT(0x0000), 0x00000000, 2, ZAP_TYPE(INT16U), ZAP_ATTRIBUTE_MASK(WRITABLE) }, /* IdentifyTime */          \
            ...
            { ZAP_SIMPLE_DEFAULT(0xA), 0x0000FFFC, 4, ZAP_TYPE(BITMAP32), 0 },                             /* FeatureMap */        \
...
#define GENERATED_ENDPOINT_TYPES                                                                                                   \
    {                                                                                                                              \
        { ZAP_CLUSTER_INDEX(0), 16, 197 }, { ZAP_CLUSTER_INDEX(16), 6, 177 },                                                      \
    }
...
#define FIXED_DEVICE_TYPES                                                                                                         \
    {                                                                                                                              \
        { 0x00000012, 1 }, { 0x00000016, 1 }, { 0x00000011, 1 },                                                                   \
        {                                                                                                                          \
            0x00000076, 1                                                                                                          \
        }                                                                                                                          \
    }
