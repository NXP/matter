...
#define GENERATED_ATTRIBUTES                                                                                                       \
    {                                                                                                                              \
        ...
        { ZAP_SIMPLE_DEFAULT(0x0000), 0x00000000, 2, ZAP_TYPE(INT16U), ZAP_ATTRIBUTE_MASK(WRITABLE) }, /* IdentifyTime */          \
            ...
            { ZAP_SIMPLE_DEFAULT(-8500), 0x00000001, 2, ZAP_TYPE(TEMPERATURE),                                                     \
              ZAP_ATTRIBUTE_MASK(NULLABLE) }, /* MinMeasuredValue */                                                               \
            { ZAP_SIMPLE_DEFAULT(9900), 0x00000002, 2, ZAP_TYPE(TEMPERATURE),                                                      \
...
#define GENERATED_ENDPOINT_TYPES                                                                                                   \
    {                                                                                                                              \
        { ZAP_CLUSTER_INDEX(0), 16, 197 }, { ZAP_CLUSTER_INDEX(16), 5, 33 },                                                       \
    }
