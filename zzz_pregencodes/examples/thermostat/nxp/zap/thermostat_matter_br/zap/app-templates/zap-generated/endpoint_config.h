...
#define GENERATED_ATTRIBUTES                                                                                                       \
    {                                                                                                                              \
        ...
        { ZAP_SIMPLE_DEFAULT(0x80), 0x00000000, 1, ZAP_TYPE(BITMAP8), ZAP_ATTRIBUTE_MASK(READABLE) }, /* NameSupport */            \
        ...
        { ZAP_EMPTY_DEFAULT(), 0x0000FFFD, 2, ZAP_TYPE(INT16U),                                                                    \
          ZAP_ATTRIBUTE_MASK(EXTERNAL_STORAGE) | ZAP_ATTRIBUTE_MASK(READABLE) }, /* ClusterRevision */                             \
                                                                                                                                   \
        /* Endpoint: 2, Cluster: Thread Border Router Management (server) */                                                       \
...
#define GENERATED_ENDPOINT_TYPES                                                                                                   \
    {                                                                                                                              \
        { ZAP_CLUSTER_INDEX(0), 14, 17 },                                                                                          \
        { ZAP_CLUSTER_INDEX(14), 5, 35 },                                                                                          \
        { ZAP_CLUSTER_INDEX(19), 4, 6 },                                                                                           \
    }
...
#define FIXED_DEVICE_TYPES { { 0x00000012, 1 }, { 0x00000016, 3 }, { 0x00000301, 4 }, { 0x00000019, 1 }, { 0x00000091, 2 } }

// Array of device type offsets
#define FIXED_DEVICE_TYPE_OFFSETS { 0, 2, 3 }

// Array of device type lengths
#define FIXED_DEVICE_TYPE_LENGTHS { 2, 1, 2 }
