...
// from /opt/matter/matter_dev/connectedhomeip/examples/thermostat/nxp/zap/thermostat_matter_thread.matter
#pragma once
...
inline constexpr AttributeId kEndpoint1EnabledAttributes[] = {
    Attributes::AbsMaxCoolSetpointLimit::Id, Attributes::AbsMaxHeatSetpointLimit::Id,    Attributes::AbsMinCoolSetpointLimit::Id,
    Attributes::AbsMinHeatSetpointLimit::Id, Attributes::AcceptedCommandList::Id,        Attributes::AttributeList::Id,
    Attributes::ClusterRevision::Id,         Attributes::ControlSequenceOfOperation::Id, Attributes::FeatureMap::Id,
    Attributes::GeneratedCommandList::Id,    Attributes::LocalTemperature::Id,           Attributes::MaxCoolSetpointLimit::Id,
    Attributes::MaxHeatSetpointLimit::Id,    Attributes::MinCoolSetpointLimit::Id,       Attributes::MinHeatSetpointLimit::Id,
    Attributes::OccupiedCoolingSetpoint::Id, Attributes::OccupiedHeatingSetpoint::Id,    Attributes::SystemMode::Id,
};
