...
// from /opt/matter/matter_dev/connectedhomeip/examples/thread-br-app/thread-br-common/thread-br-app.matter
#pragma once
...
inline constexpr AttributeId kEndpoint1EnabledAttributes[] = {
    Attributes::AcceptedCommandList::Id, Attributes::ActiveDatasetTimestamp::Id,
    Attributes::AttributeList::Id,       Attributes::BorderAgentID::Id,
    Attributes::BorderRouterName::Id,    Attributes::ClusterRevision::Id,
    Attributes::FeatureMap::Id,          Attributes::GeneratedCommandList::Id,
    Attributes::InterfaceEnabled::Id,    Attributes::PendingDatasetTimestamp::Id,
