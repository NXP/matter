                                                          ...
                                                          TLV::TLVReader & aDataTlv)
{
    ...
    bool wasHandled     = false;
    {
        ...
        case Commands::ContentAppMessage::Id: {
            Commands::ContentAppMessage::DecodableType commandData;
            TLVError = DataModel::Decode(aDataTlv, commandData);
            if (TLVError == CHIP_NO_ERROR)
            {
                wasHandled = emberAfContentAppObserverClusterContentAppMessageCallback(apCommandObj, aCommandPath, commandData);
            }
            break;
        }
        default: {
...
void DispatchSingleClusterCommand(const ConcreteCommandPath & aCommandPath, TLV::TLVReader & aReader, CommandHandler * apCommandObj)
{
    ...
    case Clusters::ContentAppObserver::Id:
        errorStatus = Clusters::ContentAppObserver::DispatchServerCommand(apCommandObj, aCommandPath, aReader);
        break;
