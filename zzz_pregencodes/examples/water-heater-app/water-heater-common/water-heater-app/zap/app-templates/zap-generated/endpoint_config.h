...
#define GENERATED_ATTRIBUTES                                                                                                       \
    {                                                                                                                              \
        ...
        { ZAP_MIN_MAX_DEFAULTS_INDEX(0), 0x0000001B, 1, ZAP_TYPE(ENUM8),                                                           \
          ZAP_ATTRIBUTE_MASK(MIN_MAX) | ZAP_ATTRIBUTE_MASK(WRITABLE) |                                                             \
              ZAP_ATTRIBUTE_MASK(READABLE) }, /* ControlSequenceOfOperation */                                                     \
        { ZAP_MIN_MAX_DEFAULTS_INDEX(1), 0x0000001C, 1, ZAP_TYPE(ENUM8),                                                           \
...
#define GENERATED_EVENTS { \
  ...
  /* Endpoint: 1, Cluster: Water Heater Management (server) */ \
  /* EventList (index=4) */ \
  0x00000000, /* BoostStarted */ \
  0x00000001, /* BoostEnded */ \
  /* Endpoint: 1, Cluster: Device Energy Management (server) */ \
  /* EventList (index=6) */ \
  0x00000002, /* Paused */ \
  0x00000003, /* Resumed */ \
...
#define FIXED_DEVICE_TYPES { { 0x00000016, 4 }, { 0x0000050D, 1 }, { 0x00000510, 1 }, { 0x0000050F, 1 } }
