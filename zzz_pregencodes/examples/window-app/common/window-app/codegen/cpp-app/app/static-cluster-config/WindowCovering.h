...
inline constexpr CommandId kEndpoint1EnabledCommands[] = {
    Commands::DownOrClose::Id,   Commands::GoToLiftPercentage::Id, Commands::GoToLiftValue::Id, Commands::GoToTiltPercentage::Id,
    Commands::GoToTiltValue::Id, Commands::StopMotion::Id,         Commands::UpOrOpen::Id,
};
...
inline constexpr std::array<Clusters::StaticApplicationConfig::ClusterConfiguration<FeatureBitmapType>, 2> kFixedClusterConfig = { {
    {
        ...
        .featureMap =
            BitFlags<FeatureBitmapType>{
                ...
                FeatureBitmapType::kAbsolutePosition,  // feature bit 0x8
