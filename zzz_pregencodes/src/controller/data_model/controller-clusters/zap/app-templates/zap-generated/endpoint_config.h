...
#define GENERATED_CLUSTERS { \
  ...
  { \
      /* Endpoint: 1, Cluster: Oven Cavity Operational State (client) */ \
  ...
  { \
      /* Endpoint: 1, Cluster: Oven Mode (client) */ \
  ...
  { \
      /* Endpoint: 1, Cluster: Laundry Dryer Controls (client) */ \
  ...
  { \
      /* Endpoint: 1, Cluster: Laundry Washer Mode (client) */ \
  ...
  { \
      /* Endpoint: 1, Cluster: Refrigerator And Temperature Controlled Cabinet Mode (client) */ \
  ...
  { \
      /* Endpoint: 1, Cluster: Laundry Washer Controls (client) */ \
  ...
  { \
      /* Endpoint: 1, Cluster: RVC Run Mode (client) */ \
  ...
  { \
      /* Endpoint: 1, Cluster: RVC Clean Mode (client) */ \
  ...
  { \
      /* Endpoint: 1, Cluster: Temperature Control (client) */ \
  ...
  { \
      /* Endpoint: 1, Cluster: Dishwasher Mode (client) */ \
  ...
  { \
      /* Endpoint: 1, Cluster: Dishwasher Alarm (client) */ \
  ...
  { \
      /* Endpoint: 1, Cluster: Microwave Oven Mode (client) */ \
  ...
  { \
      /* Endpoint: 1, Cluster: Commodity Price (client) */ \
  ...
  { \
      /* Endpoint: 1, Cluster: Electrical Grid Conditions (client) */ \
  ...
  { \
      /* Endpoint: 1, Cluster: Soil Measurement (client) */ \
  ...
  { \
      /* Endpoint: 1, Cluster: Commodity Tariff (client) */ \
  ...
  { \
      /* Endpoint: 1, Cluster: Joint Fabric Datastore (client) */ \
  ...
  { \
      /* Endpoint: 1, Cluster: Joint Fabric Administrator (client) */ \
  ...
  { \
      /* Endpoint: 1, Cluster: Meter Identification (client) */ \
  ...
  { \
      /* Endpoint: 1, Cluster: Commodity Metering (client) */ \
  ...
  { \
      /* Endpoint: 1, Cluster: Sample MEI (client) */ \
