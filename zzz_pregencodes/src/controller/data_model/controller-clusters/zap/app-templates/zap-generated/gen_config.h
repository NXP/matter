...
#define MATTER_DM_OTA_SOFTWARE_UPDATE_REQUESTOR_CLUSTER_CLIENT_ENDPOINT_COUNT (1)
...
#define MATTER_DM_BRIDGED_DEVICE_BASIC_INFORMATION_CLUSTER_CLIENT_ENDPOINT_COUNT (1)
...
#define MATTER_DM_REFRIGERATOR_AND_TEMPERATURE_CONTROLLED_CABINET_MODE_CLUSTER_CLIENT_ENDPOINT_COUNT (1)
...
#define MATTER_DM_ACTIVATED_CARBON_FILTER_MONITORING_CLUSTER_CLIENT_ENDPOINT_COUNT (1)
...
#define MATTER_DM_ELECTRICAL_ENERGY_MEASUREMENT_CLUSTER_CLIENT_ENDPOINT_COUNT (1)
#define MATTER_DM_WATER_HEATER_MANAGEMENT_CLUSTER_CLIENT_ENDPOINT_COUNT (1)
#define MATTER_DM_COMMODITY_PRICE_CLUSTER_CLIENT_ENDPOINT_COUNT (1)
...
#define MATTER_DM_WATER_HEATER_MODE_CLUSTER_CLIENT_ENDPOINT_COUNT (1)
#define MATTER_DM_DEVICE_ENERGY_MANAGEMENT_MODE_CLUSTER_CLIENT_ENDPOINT_COUNT (1)
#define MATTER_DM_ELECTRICAL_GRID_CONDITIONS_CLUSTER_CLIENT_ENDPOINT_COUNT (1)
...
#define MATTER_DM_PUMP_CONFIGURATION_AND_CONTROL_CLUSTER_CLIENT_ENDPOINT_COUNT (1)
#define MATTER_DM_THERMOSTAT_CLUSTER_CLIENT_ENDPOINT_COUNT (1)
#define MATTER_DM_FAN_CONTROL_CLUSTER_CLIENT_ENDPOINT_COUNT (1)
#define MATTER_DM_THERMOSTAT_USER_INTERFACE_CONFIGURATION_CLUSTER_CLIENT_ENDPOINT_COUNT (1)
...
#define MATTER_DM_RELATIVE_HUMIDITY_MEASUREMENT_CLUSTER_CLIENT_ENDPOINT_COUNT (1)
#define MATTER_DM_OCCUPANCY_SENSING_CLUSTER_CLIENT_ENDPOINT_COUNT (1)
#define MATTER_DM_CARBON_MONOXIDE_CONCENTRATION_MEASUREMENT_CLUSTER_CLIENT_ENDPOINT_COUNT (1)
#define MATTER_DM_CARBON_DIOXIDE_CONCENTRATION_MEASUREMENT_CLUSTER_CLIENT_ENDPOINT_COUNT (1)
#define MATTER_DM_NITROGEN_DIOXIDE_CONCENTRATION_MEASUREMENT_CLUSTER_CLIENT_ENDPOINT_COUNT (1)
#define MATTER_DM_OZONE_CONCENTRATION_MEASUREMENT_CLUSTER_CLIENT_ENDPOINT_COUNT (1)
#define MATTER_DM_PM2_5_CONCENTRATION_MEASUREMENT_CLUSTER_CLIENT_ENDPOINT_COUNT (1)
#define MATTER_DM_FORMALDEHYDE_CONCENTRATION_MEASUREMENT_CLUSTER_CLIENT_ENDPOINT_COUNT (1)
#define MATTER_DM_PM1_CONCENTRATION_MEASUREMENT_CLUSTER_CLIENT_ENDPOINT_COUNT (1)
#define MATTER_DM_PM10_CONCENTRATION_MEASUREMENT_CLUSTER_CLIENT_ENDPOINT_COUNT (1)
#define MATTER_DM_TVOC_CONCENTRATION_MEASUREMENT_CLUSTER_CLIENT_ENDPOINT_COUNT (1)
#define MATTER_DM_RADON_CONCENTRATION_MEASUREMENT_CLUSTER_CLIENT_ENDPOINT_COUNT (1)
#define MATTER_DM_SOIL_MEASUREMENT_CLUSTER_CLIENT_ENDPOINT_COUNT (1)
#define MATTER_DM_WIFI_NETWORK_MANAGEMENT_CLUSTER_CLIENT_ENDPOINT_COUNT (0)
#define MATTER_DM_THREAD_BORDER_ROUTER_MANAGEMENT_CLUSTER_CLIENT_ENDPOINT_COUNT (1)
#define MATTER_DM_THREAD_NETWORK_DIRECTORY_CLUSTER_CLIENT_ENDPOINT_COUNT (1)
...
#define MATTER_DM_CHIME_CLUSTER_CLIENT_ENDPOINT_COUNT (1)
#define MATTER_DM_COMMODITY_TARIFF_CLUSTER_CLIENT_ENDPOINT_COUNT (1)
...
#define MATTER_DM_JOINT_FABRIC_DATASTORE_CLUSTER_CLIENT_ENDPOINT_COUNT (1)
#define MATTER_DM_JOINT_FABRIC_ADMINISTRATOR_CLUSTER_CLIENT_ENDPOINT_COUNT (1)
...
#define MATTER_DM_METER_IDENTIFICATION_CLUSTER_CLIENT_ENDPOINT_COUNT (1)
#define MATTER_DM_COMMODITY_METERING_CLUSTER_CLIENT_ENDPOINT_COUNT (1)
...
// Use this macro to check if the client side of the Wi-Fi Network Diagnostics cluster is included
...
// Use this macro to check if the client side of the Time Synchronization cluster is included
...
// Use this macro to check if the client side of the Oven Cavity Operational State cluster is included
#define ZCL_USING_OPERATIONAL_STATE_OVEN_CLUSTER_CLIENT
#define MATTER_DM_PLUGIN_OVEN_CAVITY_OPERATIONAL_STATE_CLIENT

// Use this macro to check if the client side of the Oven Mode cluster is included
#define ZCL_USING_OVEN_MODE_CLUSTER_CLIENT
#define MATTER_DM_PLUGIN_OVEN_MODE_CLIENT

// Use this macro to check if the client side of the Laundry Dryer Controls cluster is included
...
// Use this macro to check if the client side of the Laundry Washer Controls cluster is included
#define ZCL_USING_LAUNDRY_WASHER_CONTROLS_CLUSTER_CLIENT
#define MATTER_DM_PLUGIN_LAUNDRY_WASHER_CONTROLS_CLIENT

// Use this macro to check if the client side of the RVC Run Mode cluster is included
#define ZCL_USING_RVC_RUN_MODE_CLUSTER_CLIENT
#define MATTER_DM_PLUGIN_RVC_RUN_MODE_CLIENT

// Use this macro to check if the client side of the RVC Clean Mode cluster is included
#define ZCL_USING_RVC_CLEAN_MODE_CLUSTER_CLIENT
#define MATTER_DM_PLUGIN_RVC_CLEAN_MODE_CLIENT

// Use this macro to check if the client side of the Temperature Control cluster is included
...
// Use this macro to check if the client side of the Dishwasher Alarm cluster is included
#define ZCL_USING_DISHWASHER_ALARM_CLUSTER_CLIENT
#define MATTER_DM_PLUGIN_DISHWASHER_ALARM_CLIENT

// Use this macro to check if the client side of the Microwave Oven Mode cluster is included
#define ZCL_USING_MICROWAVE_OVEN_MODE_CLUSTER_CLIENT
#define MATTER_DM_PLUGIN_MICROWAVE_OVEN_MODE_CLIENT

// Use this macro to check if the client side of the Microwave Oven Control cluster is included
#define ZCL_USING_MICROWAVE_OVEN_CONTROL_CLUSTER_CLIENT
#define MATTER_DM_PLUGIN_MICROWAVE_OVEN_CONTROL_CLIENT

// Use this macro to check if the client side of the Operational State cluster is included
#define ZCL_USING_OPERATIONAL_STATE_CLUSTER_CLIENT
#define MATTER_DM_PLUGIN_OPERATIONAL_STATE_CLIENT

// Use this macro to check if the client side of the RVC Operational State cluster is included
...
// Use this macro to check if the client side of the Electrical Power Measurement cluster is included
#define ZCL_USING_ELECTRICAL_POWER_MEASUREMENT_CLUSTER_CLIENT
#define MATTER_DM_PLUGIN_ELECTRICAL_POWER_MEASUREMENT_CLIENT

// Use this macro to check if the client side of the Electrical Energy Measurement cluster is included
...
// Use this macro to check if the client side of the Water Heater Management cluster is included
#define ZCL_USING_WATER_HEATER_MANAGEMENT_CLUSTER_CLIENT
#define MATTER_DM_PLUGIN_WATER_HEATER_MANAGEMENT_CLIENT

// Use this macro to check if the client side of the Commodity Price cluster is included
#define ZCL_USING_COMMODITY_PRICE_CLUSTER_CLIENT
#define MATTER_DM_PLUGIN_COMMODITY_PRICE_CLIENT

// Use this macro to check if the client side of the Device Energy Management cluster is included
#define ZCL_USING_DEVICE_ENERGY_MANAGEMENT_CLUSTER_CLIENT
#define MATTER_DM_PLUGIN_DEVICE_ENERGY_MANAGEMENT_CLIENT

// Use this macro to check if the client side of the Energy EVSE cluster is included
#define ZCL_USING_ENERGY_EVSE_CLUSTER_CLIENT
#define MATTER_DM_PLUGIN_ENERGY_EVSE_CLIENT

// Use this macro to check if the client side of the Power Topology cluster is included
#define ZCL_USING_POWER_TOPOLOGY_CLUSTER_CLIENT
#define MATTER_DM_PLUGIN_POWER_TOPOLOGY_CLIENT

// Use this macro to check if the client side of the Energy EVSE Mode cluster is included
#define ZCL_USING_ENERGY_EVSE_MODE_CLUSTER_CLIENT
#define MATTER_DM_PLUGIN_ENERGY_EVSE_MODE_CLIENT

// Use this macro to check if the client side of the Water Heater Mode cluster is included
#define ZCL_USING_WATER_HEATER_MODE_CLUSTER_CLIENT
#define MATTER_DM_PLUGIN_WATER_HEATER_MODE_CLIENT

// Use this macro to check if the client side of the Device Energy Management Mode cluster is included
...
// Use this macro to check if the client side of the Electrical Grid Conditions cluster is included
#define ZCL_USING_ELECTRICAL_GRID_CONDITIONS_CLUSTER_CLIENT
#define MATTER_DM_PLUGIN_ELECTRICAL_GRID_CONDITIONS_CLIENT
...
// Use this macro to check if the client side of the Carbon Monoxide Concentration Measurement cluster is included
...
// Use this macro to check if the client side of the Carbon Dioxide Concentration Measurement cluster is included
...
// Use this macro to check if the client side of the Nitrogen Dioxide Concentration Measurement cluster is included
...
// Use this macro to check if the client side of the Ozone Concentration Measurement cluster is included
...
// Use this macro to check if the client side of the PM2.5 Concentration Measurement cluster is included
...
// Use this macro to check if the client side of the Formaldehyde Concentration Measurement cluster is included
...
// Use this macro to check if the client side of the PM1 Concentration Measurement cluster is included
...
// Use this macro to check if the client side of the PM10 Concentration Measurement cluster is included
...
// Use this macro to check if the client side of the Total Volatile Organic Compounds Concentration Measurement cluster is included
...
// Use this macro to check if the client side of the Radon Concentration Measurement cluster is included
...
// Use this macro to check if the client side of the Soil Measurement cluster is included
#define ZCL_USING_SOIL_MEASUREMENT_CLUSTER_CLIENT
#define MATTER_DM_PLUGIN_SOIL_MEASUREMENT_CLIENT

// Use this macro to check if the client side of the Thread Border Router Management cluster is included
#define ZCL_USING_THREAD_BORDER_ROUTER_MANAGEMENT_CLUSTER_CLIENT
#define MATTER_DM_PLUGIN_THREAD_BORDER_ROUTER_MANAGEMENT_CLIENT

// Use this macro to check if the client side of the Thread Network Directory cluster is included
#define ZCL_USING_THREAD_NETWORK_DIRECTORY_CLUSTER_CLIENT
#define MATTER_DM_PLUGIN_THREAD_NETWORK_DIRECTORY_CLIENT
...
// Use this macro to check if the client side of the Chime cluster is included
#define ZCL_USING_CHIME_CLUSTER_CLIENT
#define MATTER_DM_PLUGIN_CHIME_CLIENT

// Use this macro to check if the client side of the Commodity Tariff cluster is included
#define ZCL_USING_COMMODITY_TARIFF_CLUSTER_CLIENT
#define MATTER_DM_PLUGIN_COMMODITY_TARIFF_CLIENT

// Use this macro to check if the client side of the Joint Fabric Datastore cluster is included
#define ZCL_USING_JOINT_FABRIC_DATASTORE_CLUSTER_CLIENT
#define MATTER_DM_PLUGIN_JOINT_FABRIC_DATASTORE_CLIENT

// Use this macro to check if the client side of the Joint Fabric Administrator cluster is included
#define ZCL_USING_JOINT_FABRIC_ADMINISTRATOR_CLUSTER_CLIENT
#define MATTER_DM_PLUGIN_JOINT_FABRIC_ADMINISTRATOR_CLIENT

// Use this macro to check if the client side of the Meter Identification cluster is included
#define ZCL_USING_METER_IDENTIFICATION_CLUSTER_CLIENT
#define MATTER_DM_PLUGIN_METER_IDENTIFICATION_CLIENT

// Use this macro to check if the client side of the Commodity Metering cluster is included
#define ZCL_USING_COMMODITY_METERING_CLUSTER_CLIENT
#define MATTER_DM_PLUGIN_COMMODITY_METERING_CLIENT
...
// Use this macro to check if the client side of the Sample MEI cluster is included
