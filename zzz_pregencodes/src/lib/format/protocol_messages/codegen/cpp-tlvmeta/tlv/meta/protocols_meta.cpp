...
const Entry<ItemInfo> _IMProtocol_ReadRequestMessage[] = {
  ...
  { { ContextTag(1), "event_requests", ItemType::kList }, 49 }, // IMProtocol::EventPathIB[]
...
const Entry<ItemInfo> _IMProtocol_SubscribeRequestMessage[] = {
  ...
  { { ContextTag(4), "event_requests", ItemType::kList }, 49 }, // IMProtocol::EventPathIB[]
...
const Entry<ItemInfo> _IMProtocol_WriteRequestMessage[] = {
  ...
  { { ContextTag(2), "write_requests", ItemType::kList }, 48 }, // IMProtocol::AttributeDataIB[]
...
const Entry<ItemInfo> _IMProtocol_WriteResponseMessage[] = {
  { { ContextTag(0), "write_responses", ItemType::kList }, 54 }, // IMProtocol::AttributeStatusIB[]
  { { ContextTag(255), "interaction_model_revison", ItemType::kDefault }, kInvalidNodeIndex }, // IMProtocol::int8u
};
...
const Entry<ItemInfo> _IMProtocol_InvokeResponseMessage[] = {
  { { ContextTag(0), "suppress_response", ItemType::kDefault }, kInvalidNodeIndex }, // IMProtocol::boolean
  { { ContextTag(1), "invoke_responses", ItemType::kList }, 50 }, // IMProtocol::InvokeResponseIB[]
...
const std::array<const Node<ItemInfo>, 58 + 2> protocols_meta = { {
  ...
  _ENTRY(_IMProtocol_AttributeDataIB_list_), // 48
  _ENTRY(_IMProtocol_EventPathIB_list_), // 49
  _ENTRY(_IMProtocol_InvokeResponseIB_list_), // 50
  ...
  _ENTRY(_IMProtocol_AttributeStatusIB_list_), // 54
