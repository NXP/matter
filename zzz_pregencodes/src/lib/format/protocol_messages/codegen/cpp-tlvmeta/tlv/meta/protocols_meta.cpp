...
const Entry<ItemInfo> _IMProtocol_ReadRequestMessage[] = {
  ...
  { { ContextTag(1), "event_requests", ItemType::kList }, 52 }, // IMProtocol::EventPathIB[]
...
const Entry<ItemInfo> _IMProtocol_SubscribeRequestMessage[] = {
  ...
  { { ContextTag(4), "event_requests", ItemType::kList }, 52 }, // IMProtocol::EventPathIB[]
...
const std::array<const Node<ItemInfo>, 58 + 2> protocols_meta = { {
  ...
  _ENTRY(_IMProtocol_EventPathIB_list_), // 52
