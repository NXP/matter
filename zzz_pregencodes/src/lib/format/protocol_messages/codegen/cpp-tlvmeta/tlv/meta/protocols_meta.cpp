...
const Entry<ItemInfo> _IMProtocol_ReadRequestMessage[] = {
  { { ContextTag(0), "attribute_requests", ItemType::kList }, 45 }, // IMProtocol::AttributePathIB[]
  { { ContextTag(1), "event_requests", ItemType::kList }, 46 }, // IMProtocol::EventPathIB[]
...
const Entry<ItemInfo> _IMProtocol_SubscribeRequestMessage[] = {
  ...
  { { ContextTag(3), "attribute_requests", ItemType::kList }, 45 }, // IMProtocol::AttributePathIB[]
  { { ContextTag(4), "event_requests", ItemType::kList }, 46 }, // IMProtocol::EventPathIB[]
...
const Entry<ItemInfo> _IMProtocol_ReportDataMessage[] = {
  { { ContextTag(0), "subscription_id", ItemType::kDefault }, kInvalidNodeIndex }, // IMProtocol::int32u
  { { ContextTag(1), "attribute_reports", ItemType::kList }, 47 }, // IMProtocol::AttributeReportIB[]
...
const Entry<ItemInfo> _IMProtocol_WriteRequestMessage[] = {
  ...
  { { ContextTag(2), "write_requests", ItemType::kList }, 50 }, // IMProtocol::AttributeDataIB[]
...
const std::array<const Node<ItemInfo>, 58 + 2> protocols_meta = { {
  ...
  _ENTRY(_IMProtocol_AttributePathIB_list_), // 45
  ...
  _ENTRY(_IMProtocol_AttributeDataIB_list_), // 50
