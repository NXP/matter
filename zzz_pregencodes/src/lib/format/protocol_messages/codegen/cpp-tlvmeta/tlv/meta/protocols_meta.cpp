...
const Entry<ItemInfo> _SecureChannelProtocol[] = {
    { { AttributeTag(0), "msg_counter_sync_request", ItemType::kProtocolBinaryData },
      kInvalidNodeIndex }, // SecureChannelProtocol::protocol_binary_data
    { { AttributeTag(1), "msg_counter_sync_response", ItemType::kProtocolBinaryData },
      kInvalidNodeIndex }, // SecureChannelProtocol::protocol_binary_data
    { { AttributeTag(16), "mrp_ack", ItemType::kProtocolBinaryData },
      kInvalidNodeIndex },                                                   // SecureChannelProtocol::protocol_binary_data
    ...
    { { AttributeTag(64), "status_report", ItemType::kProtocolBinaryData },
      kInvalidNodeIndex }, // SecureChannelProtocol::protocol_binary_data
    { { AttributeTag(80), "icd_checkin", ItemType::kProtocolBinaryData },
      kInvalidNodeIndex }, // SecureChannelProtocol::protocol_binary_data
};
...
const Entry<ItemInfo> _IMProtocol_ReadRequestMessage[] = {
    { { ContextTag(0), "attribute_requests", ItemType::kList }, 48 },                         // IMProtocol::AttributePathIB[]
    { { ContextTag(1), "event_requests", ItemType::kList }, 47 },                             // IMProtocol::EventPathIB[]
    { { ContextTag(2), "event_filters", ItemType::kList }, 52 },                              // IMProtocol::EventFilterIB[]
...
const Entry<ItemInfo> _IMProtocol_SubscribeRequestMessage[] = {
    ...
    { { ContextTag(3), "attribute_requests", ItemType::kList }, 48 },                      // IMProtocol::AttributePathIB[]
    { { ContextTag(4), "event_requests", ItemType::kList }, 47 },                          // IMProtocol::EventPathIB[]
    { { ContextTag(5), "event_filters", ItemType::kList }, 52 },                           // IMProtocol::EventFilterIB[]
    { { ContextTag(7), "fabric_filtered", ItemType::kDefault }, kInvalidNodeIndex },       // IMProtocol::boolean
    { { ContextTag(8), "data_version_filters", ItemType::kList }, 45 },                    // IMProtocol::DataVersionFilterIB[]
    { { ContextTag(255), "interaction_model_revison", ItemType::kDefault }, kInvalidNodeIndex }, // IMProtocol::int8u
};
...
const Entry<ItemInfo> _IMProtocol_ReportDataMessage[] = {
    ...
    { { ContextTag(2), "event_reports", ItemType::kList }, 50 },                                 // IMProtocol::EventReportIB[]
...
const Entry<ItemInfo> _IMProtocol_WriteRequestMessage[] = {
    ...
    { { ContextTag(2), "write_requests", ItemType::kList }, 46 },                                // IMProtocol::AttributeDataIB[]
...
const Entry<ItemInfo> _IMProtocol_WriteResponseMessage[] = {
    { { ContextTag(0), "write_responses", ItemType::kList }, 51 },                               // IMProtocol::AttributeStatusIB[]
    { { ContextTag(255), "interaction_model_revison", ItemType::kDefault }, kInvalidNodeIndex }, // IMProtocol::int8u
};
...
const Entry<ItemInfo> _IMProtocol_SuppliedAttribution[] = {
    { { ContextTag(0), "context_information", ItemType::kDefault },
      kInvalidNodeIndex }, // IMProtocol::SuppliedAttributeContextInformation
...
const Entry<ItemInfo> _IMProtocol_InvokeRequestMessage[] = {
    ...
    { { ContextTag(1), "timed_request", ItemType::kDefault }, kInvalidNodeIndex },               // IMProtocol::boolean
    { { ContextTag(2), "invoke_requests", ItemType::kList }, 53 },                               // IMProtocol::CommandDataIB[]
    { { ContextTag(255), "interaction_model_revison", ItemType::kDefault }, kInvalidNodeIndex }, // IMProtocol::int8u
};
...
const Entry<ItemInfo> _IMProtocol_InvokeResponseMessage[] = {
    { { ContextTag(0), "suppress_response", ItemType::kDefault }, kInvalidNodeIndex },           // IMProtocol::boolean
    { { ContextTag(1), "invoke_responses", ItemType::kList }, 54 },                              // IMProtocol::InvokeResponseIB[]
...
const Entry<ItemInfo> _IMProtocol_StatusCodeEnum[] = {
    ...
    { { ConstantValueTag(0x7D), "kInvalidSubscription", ItemType::kDefault },
      kInvalidNodeIndex }, // IMProtocol::StatusCodeEnum::kInvalidSubscription
    { { ConstantValueTag(0x7E), "kUnsupportedAccess", ItemType::kDefault },
      kInvalidNodeIndex }, // IMProtocol::StatusCodeEnum::kUnsupportedAccess
    { { ConstantValueTag(0x7F), "kUnsupportedEndpoint", ItemType::kDefault },
      kInvalidNodeIndex }, // IMProtocol::StatusCodeEnum::kUnsupportedEndpoint
    { { ConstantValueTag(0x80), "kInvalidAction", ItemType::kDefault },
      kInvalidNodeIndex }, // IMProtocol::StatusCodeEnum::kInvalidAction
    { { ConstantValueTag(0x81), "kUnsupportedCommand", ItemType::kDefault },
      kInvalidNodeIndex }, // IMProtocol::StatusCodeEnum::kUnsupportedCommand
    { { ConstantValueTag(0x85), "kInvalidCommand", ItemType::kDefault },
      kInvalidNodeIndex }, // IMProtocol::StatusCodeEnum::kInvalidCommand
    { { ConstantValueTag(0x86), "kUnsupportedAttribute", ItemType::kDefault },
      kInvalidNodeIndex }, // IMProtocol::StatusCodeEnum::kUnsupportedAttribute
    { { ConstantValueTag(0x87), "kConstraintError", ItemType::kDefault },
      kInvalidNodeIndex }, // IMProtocol::StatusCodeEnum::kConstraintError
    { { ConstantValueTag(0x88), "kUnsupportedWrite", ItemType::kDefault },
      kInvalidNodeIndex }, // IMProtocol::StatusCodeEnum::kUnsupportedWrite
    { { ConstantValueTag(0x89), "kResourceExhausted", ItemType::kDefault },
      kInvalidNodeIndex }, // IMProtocol::StatusCodeEnum::kResourceExhausted
    { { ConstantValueTag(0x8B), "kNotFound", ItemType::kDefault }, kInvalidNodeIndex }, // IMProtocol::StatusCodeEnum::kNotFound
    { { ConstantValueTag(0x8C), "kUnreportableAttribute", ItemType::kDefault },
      kInvalidNodeIndex }, // IMProtocol::StatusCodeEnum::kUnreportableAttribute
    { { ConstantValueTag(0x8D), "kInvalidDataType", ItemType::kDefault },
      kInvalidNodeIndex }, // IMProtocol::StatusCodeEnum::kInvalidDataType
    { { ConstantValueTag(0x8F), "kUnsupportedRead", ItemType::kDefault },
      kInvalidNodeIndex }, // IMProtocol::StatusCodeEnum::kUnsupportedRead
    { { ConstantValueTag(0x92), "kDataVersionMismatch", ItemType::kDefault },
      kInvalidNodeIndex }, // IMProtocol::StatusCodeEnum::kDataVersionMismatch
    ...
    { { ConstantValueTag(0xC3), "kUnsupportedCluster", ItemType::kDefault },
      kInvalidNodeIndex }, // IMProtocol::StatusCodeEnum::kUnsupportedCluster
    { { ConstantValueTag(0xC5), "kNoUpstreamSubscription", ItemType::kDefault },
      kInvalidNodeIndex }, // IMProtocol::StatusCodeEnum::kNoUpstreamSubscription
    { { ConstantValueTag(0xC6), "kNeedsTimedInteraction", ItemType::kDefault },
      kInvalidNodeIndex }, // IMProtocol::StatusCodeEnum::kNeedsTimedInteraction
    { { ConstantValueTag(0xC7), "kUnsupportedEvent", ItemType::kDefault },
      kInvalidNodeIndex }, // IMProtocol::StatusCodeEnum::kUnsupportedEvent
    { { ConstantValueTag(0xC8), "kPathsExhausted", ItemType::kDefault },
      kInvalidNodeIndex }, // IMProtocol::StatusCodeEnum::kPathsExhausted
    { { ConstantValueTag(0xC9), "kTimedRequestMismatch", ItemType::kDefault },
      kInvalidNodeIndex }, // IMProtocol::StatusCodeEnum::kTimedRequestMismatch
    { { ConstantValueTag(0xCA), "kFailsafeRequired", ItemType::kDefault },
      kInvalidNodeIndex }, // IMProtocol::StatusCodeEnum::kFailsafeRequired
    { { ConstantValueTag(0xCB), "kInvalidInState", ItemType::kDefault },
      kInvalidNodeIndex }, // IMProtocol::StatusCodeEnum::kInvalidInState
    { { ConstantValueTag(0xCC), "kNoCommandResponse", ItemType::kDefault },
      kInvalidNodeIndex }, // IMProtocol::StatusCodeEnum::kNoCommandResponse
    { { ConstantValueTag(0xF0), "kWriteIgnored", ItemType::kDefault },
      kInvalidNodeIndex }, // IMProtocol::StatusCodeEnum::kWriteIgnored
};

const Entry<ItemInfo> _IMProtocol_SuppliedAttributionContextInformation[] = {
    { { ConstantValueTag(0x0), "kDefaultClientAction", ItemType::kDefault },
      kInvalidNodeIndex }, // IMProtocol::SuppliedAttributionContextInformation::kDefaultClientAction
    { { ConstantValueTag(0x1), "kUserInteraction", ItemType::kDefault },
      kInvalidNodeIndex }, // IMProtocol::SuppliedAttributionContextInformation::kUserInteraction
    { { ConstantValueTag(0x2), "kClientAutomationRule", ItemType::kDefault },
      kInvalidNodeIndex }, // IMProtocol::SuppliedAttributionContextInformation::kClientAutomationRule
    { { ConstantValueTag(0x3), "kClientSchedule", ItemType::kDefault },
      kInvalidNodeIndex }, // IMProtocol::SuppliedAttributionContextInformation::kClientSchedule
    { { ConstantValueTag(0x4), "kClientTimer", ItemType::kDefault },
      kInvalidNodeIndex }, // IMProtocol::SuppliedAttributionContextInformation::kClientTimer
};
...
const Entry<ItemInfo> _UserDirectedCommissioningProtocol[] = {
    { { AttributeTag(0), "identification_declaration", ItemType::kDefault },
      59 }, // UserDirectedCommissioningProtocol::IdentificationDeclarationStruct
};

const Entry<ItemInfo> _UserDirectedCommissioningProtocol_IdentificationDeclarationStruct[] = {
    { { ContextTag(1), "instance_name", ItemType::kDefault },
      kInvalidNodeIndex }, // UserDirectedCommissioningProtocol::octet_string
};
...
const std::array<const Node<ItemInfo>, 58 + 2> protocols_meta = { {
    ...
    _ENTRY(_IMProtocol_AttributeDataIB_list_),                                  // 46
    _ENTRY(_IMProtocol_EventPathIB_list_),                                      // 47
    _ENTRY(_IMProtocol_AttributePathIB_list_),                                  // 48
    _ENTRY(_IMProtocol_AttributeReportIB_list_),                                // 49
    _ENTRY(_IMProtocol_EventReportIB_list_),                                    // 50
    _ENTRY(_IMProtocol_AttributeStatusIB_list_),                                // 51
    _ENTRY(_IMProtocol_EventFilterIB_list_),                                    // 52
    _ENTRY(_IMProtocol_CommandDataIB_list_),                                    // 53
    _ENTRY(_IMProtocol_InvokeResponseIB_list_),                                 // 54
